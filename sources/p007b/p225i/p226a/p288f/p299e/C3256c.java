...
public class C3256c {
    ...
    public Intent mo4017a(@Nullable Context context, int i, @Nullable String str) {
        ...
        if (context != null && C1460d.m497a1(context)) {
            Uri uri2 = C3384u0.f9570a;
            Intent intent2 = new Intent("com.google.android.clockwork.home.UPDATE_ANDROID_WEAR_ACTION");
            intent2.setPackage("com.google.android.wearable.app");
            return intent2;
        }
        StringBuilder sbM833U = C1643a.m833U("gcore_");
    ...
    /* JADX WARN: Code duplicated, block: B:84:0x0173 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:85:0x0175  */
    /* JADX WARN: Code duplicated, block: B:87:0x017b A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:88:0x017c A[RETURN] */
    /* JADX WARN: Code duplicated, block: B:89:0x0143 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX INFO: renamed from: b */
    public int mo4018b(@RecentlyNonNull Context context, int i) throws PackageManager.NameNotFoundException {
        ...
        if (C1460d.m497a1(context)) {
            ...
            if (C1460d.f2220e == null) {
                C1460d.f2220e = Boolean.valueOf(context.getPackageManager().hasSystemFeature("android.hardware.type.iot") || context.getPackageManager().hasSystemFeature("android.hardware.type.embedded"));
            }
            if (C1460d.f2220e.booleanValue()) {
                z2 = false;
            } else {
                z2 = true;
            }
