...
/* JADX INFO: renamed from: b.i.a.g.g.e */
/* JADX INFO: compiled from: DrawableWithAnimatedVisibilityChange.java */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC4419e extends Drawable implements Animatable2Compat {
    private static final boolean DEFAULT_DRAWABLE_RESTART = false;
    private static final int GROW_DURATION = 500;
    private static final Property<AbstractC4419e, Float> GROW_FRACTION = new c(Float.class, "growFraction");
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationStart(Animator animator) {
            ...
            AbstractC4419e.this.dispatchAnimationStart();
        }
    }
    ...
    public class b extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            AbstractC4419e.super.setVisible(false, false);
            AbstractC4419e.this.dispatchAnimationEnd();
        }
    }

    /* JADX INFO: renamed from: b.i.a.g.g.e$c */
    /* JADX INFO: compiled from: DrawableWithAnimatedVisibilityChange.java */
    public static class c extends Property<AbstractC4419e, Float> {
        public c(Class cls, String str) {
            super(cls, str);
        }

        @Override // android.util.Property
        public Float get(AbstractC4419e abstractC4419e) {
            return Float.valueOf(abstractC4419e.getGrowFraction());
        }

        @Override // android.util.Property
        public void set(AbstractC4419e abstractC4419e, Float f) {
            abstractC4419e.setGrowFraction(f.floatValue());
        }
    }

    public AbstractC4419e(@NonNull Context context, @NonNull BaseProgressIndicatorSpec baseProgressIndicatorSpec) {
