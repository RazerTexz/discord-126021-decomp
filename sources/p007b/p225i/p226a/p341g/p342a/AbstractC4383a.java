...
/* JADX INFO: renamed from: b.i.a.g.a.a */
/* JADX INFO: compiled from: HeaderBehavior.java */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC4383a<V extends View> extends C4385c<V> {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.f11528k == null || (overScroller = AbstractC4383a.this.scroller) == null) {
                return;
            }
            if (!overScroller.computeScrollOffset()) {
                AbstractC4383a.this.onFlingFinished(this.f11527j, this.f11528k);
                return;
            }
            AbstractC4383a abstractC4383a = AbstractC4383a.this;
            abstractC4383a.setHeaderTopBottomOffset(this.f11527j, this.f11528k, abstractC4383a.scroller.getCurrY());
            ViewCompat.postOnAnimation(this.f11528k, this);
        }
    }

    public AbstractC4383a() {
    ...
    public AbstractC4383a(Context context, AttributeSet attributeSet) {
