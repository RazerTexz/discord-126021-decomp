...
import p007b.p225i.p226a.p242c.p245b3.p254v.C2627h;
import p007b.p225i.p226a.p242c.p259f3.C2738e0;
import p007b.p225i.p226a.p242c.p259f3.C2757x;

/* JADX INFO: renamed from: b.i.a.c.b3.v.h */
...
public final class C2627h {
    ...
    public static final class d implements Comparable<d> {
        ...
        public final C2625f f6146k;

        public d(int i, C2625f c2625f) {
            this.f6145j = i;
            this.f6146k = c2625f;
        }
    ...
    public static final class e {
        ...
        public C2578b.b m2718a() {
            ...
            if (i4 == 1) {
                ...
                C1643a.m852g0(34, "Unknown textAlignment: ", i4, "WebvttCueParser");
                alignment = null;
            } else {
                alignment = Layout.Alignment.ALIGN_OPPOSITE;
            }
    ...
    /* JADX INFO: renamed from: a */
    public static void m2710a(@Nullable String str, c cVar, List<b> list, SpannableStringBuilder spannableStringBuilder, List<C2625f> list2) {
        byte b2;
        int i = cVar.f6142b;
        ...
        switch (b2) {
            ...
            case 7:
                ...
                int i3 = b.f6138a;
                Collections.sort(arrayList, new Comparator() { // from class: b.i.a.c.b3.v.a
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return Integer.compare(((C2627h.b) obj).f6139b.f6142b, ((C2627h.b) obj2).f6139b.f6142b);
                    }
                });
                int i4 = cVar.f6142b;
                int i5 = 0;
                ...
                while (i5 < arrayList.size()) {
                    if ("rt".equals(((b) arrayList.get(i5)).f6139b.f6141a)) {
                        ...
                        spannableStringBuilder.setSpan(new C2603c(charSequenceSubSequence.toString(), iM2712c2), i4, i6, 33);
        ...
        while (true) {
            ...
            C2625f c2625f = ((d) arrayList2.get(i8)).f6146k;
            if (c2625f != null) {
                if (c2625f.m2709a() != -1) {
                    C1460d.m503c(spannableStringBuilder, new StyleSpan(c2625f.m2709a()), i, length, 33);
                }
                if (c2625f.f6123j == 1) {
                ...
                if (c2625f.f6120g) {
                    ...
                    C1460d.m503c(spannableStringBuilder, new ForegroundColorSpan(c2625f.f6119f), i, length, 33);
                }
                if (c2625f.f6122i) {
                    if (!c2625f.f6122i) {
                        throw new IllegalStateException("Background color not defined.");
                    }
                    C1460d.m503c(spannableStringBuilder, new BackgroundColorSpan(c2625f.f6121h), i, length, 33);
                }
                if (c2625f.f6118e != null) {
                    C1460d.m503c(spannableStringBuilder, new TypefaceSpan(c2625f.f6118e), i, length, 33);
                }
                int i9 = c2625f.f6127n;
                if (i9 == 1) {
                    C1460d.m503c(spannableStringBuilder, new AbsoluteSizeSpan((int) c2625f.f6128o, true), i, length, 33);
                } else if (i9 == 2) {
                    C1460d.m503c(spannableStringBuilder, new RelativeSizeSpan(c2625f.f6128o), i, length, 33);
                } else if (i9 == 3) {
                    C1460d.m503c(spannableStringBuilder, new RelativeSizeSpan(c2625f.f6128o / 100.0f), i, length, 33);
                }
                if (c2625f.f6130q) {
                    spannableStringBuilder.setSpan(new C2601a(), i, length, 33);
                }
            }
            i8++;
        }
    ...
    /* JADX INFO: renamed from: b */
    public static List<d> m2711b(List<C2625f> list, @Nullable String str, c cVar) {
        ?? r4;
        int size;
        boolean zIsEmpty;
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            C2625f c2625f = list.get(i);
            String str2 = cVar.f6141a;
            Set<String> set = cVar.f6144d;
            String str3 = cVar.f6143c;
            if (c2625f.f6114a.isEmpty() && c2625f.f6115b.isEmpty() && c2625f.f6116c.isEmpty() && c2625f.f6117d.isEmpty()) {
                zIsEmpty = TextUtils.isEmpty(str2);
            } else {
                int iM2708b = C2625f.m2708b(C2625f.m2708b(C2625f.m2708b(0, c2625f.f6114a, str, BasicMeasure.EXACTLY), c2625f.f6115b, str2, 2), c2625f.f6117d, str3, 4);
                if (iM2708b == -1 || !set.containsAll(c2625f.f6116c)) {
                    r4 = 0;
                } else {
                    size = iM2708b + (c2625f.f6116c.size() * 4);
                }
            }
            if (r4 > 0) {
                r4 = size;
                r4 = zIsEmpty;
                arrayList.add(new d(r4, c2625f));
            } else {
                r4 = size;
                r4 = zIsEmpty;
            }
    ...
    /* JADX INFO: renamed from: c */
    public static int m2712c(List<C2625f> list, @Nullable String str, c cVar) {
    ...
    @Nullable
    /* JADX INFO: renamed from: d */
    public static C2626g m2713d(@Nullable String str, Matcher matcher, C2757x c2757x, List<C2625f> list) {
        e eVar = new e();
        try {
            String strGroup = matcher.group(1);
            Objects.requireNonNull(strGroup);
            eVar.f6147a = C2629j.m2720b(strGroup);
            String strGroup2 = matcher.group(2);
            Objects.requireNonNull(strGroup2);
            eVar.f6148b = C2629j.m2720b(strGroup2);
            ...
            while (!TextUtils.isEmpty(strM3087g)) {
                ...
                strM3087g = c2757x.m3087g();
            }
            eVar.f6149c = m2715f(str, sb.toString(), list);
            return new C2626g(eVar.m2718a().m2606a(), eVar.f6147a, eVar.f6148b);
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(strGroup)) {
                    ...
                    eVar.f6156j = C2629j.m2719a(strGroup2);
    ...
    /* JADX INFO: renamed from: f */
    public static SpannedString m2715f(@Nullable String str, String str2, List<C2625f> list) {
        boolean z2;
                ...
                if (iIndexOf != -1) {
                    ...
                    switch (strSubstring) {
                        ...
                        case "nbsp":
                            ...
                            break;
                        default:
                            C1643a.m856i0(strSubstring.length() + 33, "ignoring unsupported entity: '&", strSubstring, ";'", "WebvttCueParser");
                            break;
                    }
