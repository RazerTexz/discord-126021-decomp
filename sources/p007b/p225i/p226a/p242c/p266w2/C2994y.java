...
@RequiresApi(18)
public final class C2994y implements InterfaceC2966a0 {
    ...
    public InterfaceC2954b mo3571c(byte[] bArr) {
        throw new IllegalStateException();
    }
    ...
    public void mo3576h(@Nullable InterfaceC2966a0.b bVar) {
    }
    ...
    public InterfaceC2966a0.a mo3579k(byte[] bArr, @Nullable List<DrmInitData.SchemeData> list, int i, @Nullable HashMap<String, String> map) {
        throw new IllegalStateException();
    }
