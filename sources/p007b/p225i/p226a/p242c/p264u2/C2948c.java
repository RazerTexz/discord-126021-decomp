...
/* JADX INFO: renamed from: b.i.a.c.u2.c */
/* JADX INFO: compiled from: StandaloneDatabaseProvider.java */
/* JADX INFO: loaded from: classes3.dex */
public class C2948c extends SQLiteOpenHelper implements InterfaceC2946a {
            ...
            try {
                ...
                if (!"sqlite_sequence".equals(string2)) {
                    ...
                    try {
                        ...
                        C2750q.m3039b("SADatabaseProvider", strValueOf.length() != 0 ? "Error executing ".concat(strValueOf) : new String("Error executing "), e);
                    }
                }
            } catch (Throwable th) {
                if (cursorQuery != null) {
