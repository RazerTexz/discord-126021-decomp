...
/* JADX INFO: renamed from: b.a.t.a.p */
/* JADX INFO: compiled from: Kotlin.kt */
/* JADX INFO: loaded from: classes.dex */
public final class C1290p<RC, S> extends Rule<RC, Node<RC>, S> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ C1280f f1953a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1290p(C1289o.b.a aVar, C1280f c1280f, Pattern pattern) {
        super(pattern);
        this.f1953a = c1280f;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        C1289o.b bVar = new C1289o.b(strGroup, strGroup2, strGroup3, strGroup4, this.f1953a);
