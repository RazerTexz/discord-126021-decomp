...
/* JADX INFO: renamed from: b.a.t.a.s */
/* JADX INFO: compiled from: TypeScript.kt */
/* JADX INFO: loaded from: classes.dex */
public final class C1293s<RC, S> extends Rule<RC, Node<RC>, S> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ C1280f f1970a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1293s(C1292r.b.a aVar, C1280f c1280f, Pattern pattern) {
        super(pattern);
        this.f1970a = c1280f;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        C1292r.b bVar = new C1292r.b(strGroup, strGroup2, this.f1970a);
