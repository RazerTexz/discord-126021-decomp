...
/* JADX INFO: renamed from: b.a.t.a.q */
/* JADX INFO: compiled from: TypeScript.kt */
/* JADX INFO: loaded from: classes.dex */
public final class C1291q<RC, S> extends Rule<RC, Node<RC>, S> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ C1280f f1954a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1291q(C1292r.a.C13216a c13216a, C1280f c1280f, Pattern pattern) {
        super(pattern);
        this.f1954a = c1280f;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        C1292r.a aVar = new C1292r.a(strGroup, strGroup2, strGroup3, this.f1954a);
