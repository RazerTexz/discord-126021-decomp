...
/* JADX INFO: renamed from: b.a.k.h.d */
/* JADX INFO: compiled from: ClickListenerRule.kt */
/* JADX INFO: loaded from: classes.dex */
public final class C1122d<S> extends Rule<RenderContext, C1113c, S> {
    public C1122d(Pattern pattern) {
        super(pattern);
    }
    ...
    public ParseSpec<RenderContext, S> parse(Matcher matcher, Parser<RenderContext, ? super C1113c, S> parser, S s2) {
        ...
        return new ParseSpec<>(c1113c, s2, iStart, iEnd);
    }
}
