...
/* JADX INFO: renamed from: d0.z.d.g */
/* JADX INFO: compiled from: CollectionToArray.kt */
/* JADX INFO: loaded from: classes3.dex */
public final class C12227g {
    ...
    public static final Object[] toArray(Collection<?> collection, Object[] objArr) {
        Object[] objArrCopyOf;
        C12238m.checkNotNullParameter(collection, "collection");
        ...
        while (true) {
            ...
            if (i2 >= objArrCopyOf.length) {
                ...
                C12238m.checkNotNullExpressionValue(objArrCopyOf, "Arrays.copyOf(result, newSize)");
            } else if (!it.hasNext()) {
                ...
                C12238m.checkNotNullExpressionValue(objArrCopyOf2, "Arrays.copyOf(result, size)");
