...
/* JADX INFO: renamed from: d0.g0.s */
/* JADX INFO: compiled from: StringNumberConversions.kt */
/* JADX INFO: loaded from: classes3.dex */
public class C12102s extends C12101r {
    public static final Byte toByteOrNull(String str, int i) {
        int iIntValue;
        C12238m.checkNotNullParameter(str, "$this$toByteOrNull");
    ...
    public static final Integer toIntOrNull(String str) {
        C12238m.checkNotNullParameter(str, "$this$toIntOrNull");
        return toIntOrNull(str, 10);
    }

    public static final Long toLongOrNull(String str) {
        C12238m.checkNotNullParameter(str, "$this$toLongOrNull");
        return toLongOrNull(str, 10);
    }

    public static final Short toShortOrNull(String str, int i) {
        int iIntValue;
        C12238m.checkNotNullParameter(str, "$this$toShortOrNull");
        Integer intOrNull = toIntOrNull(str, i);
    ...
    public static final Integer toIntOrNull(String str, int i) {
        ...
        int i4 = -2147483647;
        int i5 = 1;
        if (C12238m.compare(cCharAt, 48) >= 0) {
            z2 = false;
            i5 = 0;
        } else {
            if (length == 1) {
        ...
        int i6 = -59652323;
        while (i5 < length) {
            int iDigitOf = C12084a.digitOf(str.charAt(i5), i);
            if (iDigitOf < 0) {
                return null;
            }
    ...
    public static final Long toLongOrNull(String str, int i) {
        ...
        while (i2 < length) {
            int iDigitOf = C12084a.digitOf(str.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (j3 < j4) {
