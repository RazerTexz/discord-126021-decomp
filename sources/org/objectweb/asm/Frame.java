    ...
    void execute(int opcode, int arg, Symbol argSymbol, SymbolTable symbolTable) {
        switch (opcode) {
            ...
            case 89:
                ...
                return;
            case 90:
                int abstractType5 = pop();
                int abstractType6 = pop();
                push(abstractType5);
                push(abstractType6);
                push(abstractType5);
                return;
            case 91:
                int abstractType7 = pop();
                int abstractType8 = pop();
                int abstractType9 = pop();
                push(abstractType7);
                push(abstractType9);
                push(abstractType8);
                push(abstractType7);
                return;
            case 92:
                int abstractType10 = pop();
                int abstractType11 = pop();
                push(abstractType11);
                push(abstractType10);
                push(abstractType11);
                push(abstractType10);
            ...
            case Opcodes.INVOKEINTERFACE /* 185 */:
                pop(argSymbol.value);
                if (opcode != 184) {
                    int abstractType21 = pop();
                    if (opcode == 183 && argSymbol.name.charAt(0) == '<') {
                        addInitializedType(abstractType21);
                    }
                }
                push(symbolTable, argSymbol.value);
                return;
