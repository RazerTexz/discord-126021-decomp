...
public class MediaCodecUtils {
    ...
    @Nullable
    public static Integer selectColorFormat(int[] iArr, MediaCodecInfo$CodecCapabilities mediaCodecInfo$CodecCapabilities) {
        for (int i : iArr) {
            for (int i2 : mediaCodecInfo$CodecCapabilities.colorFormats) {
                if (i2 == i) {
