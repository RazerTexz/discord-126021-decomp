...
/* JADX INFO: renamed from: j0.l.e.n.d */
/* JADX INFO: compiled from: SpscExactAtomicArrayQueue.java */
/* JADX INFO: loaded from: classes3.dex */
public final class C12727d<T> extends AtomicReferenceArray<T> implements Queue<T> {
    ...
    public C12727d(int i) {
        super(C12723m.m10823b(i));
        int length = length();
        this.mask = length - 1;
