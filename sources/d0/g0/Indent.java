...
public class Indent extends Appendable {
    ...
    public static final String replaceIndent(String str, String str2) {
        ...
        String string = ((StringBuilder) _Collections.joinTo(arrayList3, new StringBuilder(size), (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : null)).toString();
    ...
    public static final String replaceIndentByMargin(String str, String str2, String str3) {
        ...
        String string = ((StringBuilder) _Collections.joinTo(arrayList, new StringBuilder(size), (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : null)).toString();
        Intrinsics3.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
