...
public final class h$b$f extends o implements Function0<Set<? extends d0.e0.p.d.m0.g.e>> {
    public final /* synthetic */ h$b this$0;
    public final /* synthetic */ h this$1;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h$b$f(h$b h_b, h hVar) {
        super(0);
        this.this$0 = h_b;
        this.this$1 = hVar;
    }
    ...
    public final Set<? extends d0.e0.p.d.m0.g.e> invoke2() {
        h$b h_b = this.this$0;
        List listAccess$getFunctionList$p = h$b.access$getFunctionList$p(h_b);
