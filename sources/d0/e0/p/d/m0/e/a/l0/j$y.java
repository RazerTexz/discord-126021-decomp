...
public final class j$y extends d0.z.d.o implements Function1<q$a$a, Unit> {
    ...
    public final void invoke2(q$a$a q_a_a) {
        ...
        q_a_a.parameter(this.$JFConsumer, j.access$getNOT_PLATFORM$p$s1730278749(), j.access$getNOT_NULLABLE$p$s1730278749());
    }
}
