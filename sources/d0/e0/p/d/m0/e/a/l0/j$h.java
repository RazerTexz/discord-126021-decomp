...
public final class j$h extends d0.z.d.o implements Function1<q$a$a, Unit> {
    ...
    public final void invoke2(q$a$a q_a_a) {
        ...
        q_a_a.parameter(this.$JFPredicate, j.access$getNOT_PLATFORM$p$s1730278749(), j.access$getNOT_PLATFORM$p$s1730278749());
        q_a_a.returns(d0.e0.p.d.m0.k.y.d.BOOLEAN);
    }
}
