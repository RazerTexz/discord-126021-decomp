...
public class m {
    ...
    public static int c(v vVar, Object obj) {
        ...
        return obj instanceof String ? d(vVar, w.h((String) obj).d(), 0) : vVar.p("", ((p) obj).e) | 50331648;
    }
        ...
        if (i6 != 0 || (i5 & 251658240) == 33554432) {
            ...
            if ((i4 & ViewCompat.MEASURED_STATE_MASK) != ((-16777216) & i5)) {
                ...
                while (true) {
                    if (v_aQ == null) {
                        v$a[] v_aArr = vVar.l;
                        String str = v_aArr[i10].e;
                        String str2 = v_aArr[i11].e;
                        ...
                        try {
                            ...
                            try {
                                ...
                                v$a v_a = new v$a(vVar.k, 130, j, iR);
                                vVar.v(v_a);
                                v_a.g = iN2;
                                i3 = iN2;
                                break;
                    ...
                    if (v_aQ.f3724b == 130 && v_aQ.h == iR && v_aQ.f == j) {
                        i3 = v_aQ.g;
                        break;
                    }
                    v_aQ = v_aQ.i;
