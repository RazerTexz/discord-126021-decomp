...
public class MaterialTextView extends AppCompatTextView {
    ...
    private void applyLineHeightFromViewAppearance(@NonNull Resources$Theme resources$Theme, int i) {
        TypedArray typedArrayObtainStyledAttributes = resources$Theme.obtainStyledAttributes(i, R$styleable.MaterialTextAppearance);
    ...
    private static int findViewAppearanceResourceId(@NonNull Resources$Theme resources$Theme, @Nullable AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = resources$Theme.obtainStyledAttributes(attributeSet, R$styleable.MaterialTextView, i, i2);
    ...
    private static boolean viewAttrsHasLineHeight(@NonNull Context context, @NonNull Resources$Theme resources$Theme, @Nullable AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = resources$Theme.obtainStyledAttributes(attributeSet, R$styleable.MaterialTextView, i, i2);
