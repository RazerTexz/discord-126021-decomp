...
public class RangeSlider extends BaseSlider<RangeSlider, RangeSlider$OnChangeListener, RangeSlider$OnSliderTouchListener> {
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        RangeSlider$RangeSliderState rangeSlider$RangeSliderState = (RangeSlider$RangeSliderState) parcelable;
        super.onRestoreInstanceState(rangeSlider$RangeSliderState.getSuperState());
        this.minSeparation = rangeSlider$RangeSliderState.j;
        int i = rangeSlider$RangeSliderState.k;
    ...
    public Parcelable onSaveInstanceState() {
        RangeSlider$RangeSliderState rangeSlider$RangeSliderState = new RangeSlider$RangeSliderState(super.onSaveInstanceState());
        rangeSlider$RangeSliderState.j = this.minSeparation;
        rangeSlider$RangeSliderState.k = this.separationUnit;
