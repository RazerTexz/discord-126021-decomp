...
import p007b.p225i.p226a.p341g.p347f.C4413a;
...
public final class CollapsingTextHelper {
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z2) {
        ...
        try {
            C4413a c4413a = new C4413a(this.text, this.textPaint, (int) f);
            c4413a.f11711l = TextUtils.TruncateAt.END;
            c4413a.f11710k = z2;
            c4413a.f11707h = Layout.Alignment.ALIGN_NORMAL;
            c4413a.f11709j = false;
            c4413a.f11708i = i;
            staticLayoutM6116a = c4413a.m6116a();
        } catch (C4413a.a e) {
