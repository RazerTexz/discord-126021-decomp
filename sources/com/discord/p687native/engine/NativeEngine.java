...
public final class NativeEngine {
    ...
    public NativeEngine(Context context, int i) {
        ...
        C12238m.checkNotNullExpressionValue(applicationContext, "context.applicationContext");
        CameraEnumeratorProvider.maybeInit(applicationContext);
        Context applicationContext2 = context.getApplicationContext();
        C12238m.checkNotNullExpressionValue(applicationContext2, "context.applicationContext");
        EglBase.Context eglContext = SharedEglBaseContext.getEglContext();
        C12238m.checkNotNullExpressionValue(eglContext, "SharedEglBaseContext.getEglContext()");
