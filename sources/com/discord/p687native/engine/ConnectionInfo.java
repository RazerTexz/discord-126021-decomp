...
public final /* data */ class ConnectionInfo {
    ...
    public ConnectionInfo(boolean z2, String str, String str2, int i) {
        ...
        C12238m.checkNotNullParameter(str2, "localAddress");
        this.isConnected = z2;
        this.protocol = str;
    ...
    public boolean equals(Object other) {
        ...
        return this.isConnected == connectionInfo.isConnected && C12238m.areEqual(this.protocol, connectionInfo.protocol) && C12238m.areEqual(this.localAddress, connectionInfo.localAddress) && this.localPort == connectionInfo.localPort;
    }
    ...
    public String toString() {
        StringBuilder sbM833U = C1643a.m833U("ConnectionInfo(isConnected=");
        ...
        return C1643a.m814B(sbM833U, this.localPort, ")");
    }
}
