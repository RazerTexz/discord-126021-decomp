...
public final class TimedMuteWorker extends Worker {
    ...
    public ListenableWorker.Result doWork() {
        ...
        try {
            ...
            ModelNotificationSettings modelNotificationSettings = (ModelNotificationSettings) new C12756a(observableUpdateUserGuildSettings).m10860b();
            ...
            try {
                ...
                try {
                    ...
                    C12238m.checkNotNullExpressionValue(modelNotificationSettings, "notifSettings");
                    ...
                    C12238m.checkNotNullExpressionValue(resultFailure, "if (runAttemptCount < MA…y() else Result.failure()");
                ...
                C12238m.checkNotNullExpressionValue(simpleName5, "javaClass.simpleName");
                appLog3.mo8369w(simpleName5, "Mute failure: " + j2 + '-' + j + " until " + str, th);
                if (getRunAttemptCount() < 3) {
                    resultFailure = ListenableWorker.Result.retry();
                } else {
                    resultFailure = ListenableWorker.Result.failure();
