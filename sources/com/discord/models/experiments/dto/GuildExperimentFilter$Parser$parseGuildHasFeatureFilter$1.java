...
public final class GuildExperimentFilter$Parser$parseGuildHasFeatureFilter$1 implements Runnable {
    ...
    public GuildExperimentFilter$Parser$parseGuildHasFeatureFilter$1(Model$JsonReader model$JsonReader, Ref$ObjectRef ref$ObjectRef) {
    ...
    public final void run() throws IOException {
        this.$reader.nextListIndexed(new GuildExperimentFilter$Parser$parseGuildHasFeatureFilter$1$1(this), new GuildExperimentFilter$Parser$parseGuildHasFeatureFilter$1$2(this));
    }
}
