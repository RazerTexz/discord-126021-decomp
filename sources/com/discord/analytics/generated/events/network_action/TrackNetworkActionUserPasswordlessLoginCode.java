...
public final /* data */ class TrackNetworkActionUserPasswordlessLoginCode implements AnalyticsSchema, TrackBaseReceiver, TrackLocationMetadataReceiver, TrackNetworkMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackNetworkActionUserPasswordlessLoginCode) && C12238m.areEqual(this.retry, ((TrackNetworkActionUserPasswordlessLoginCode) other).retry);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackNetworkActionUserPasswordlessLoginCode(retry="), this.retry, ")");
    }
}
