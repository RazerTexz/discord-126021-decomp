...
public final /* data */ class TrackGuildInviteReminderUnscheduled implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildInviteReminderUnscheduled) && C12238m.areEqual(this.guildId, ((TrackGuildInviteReminderUnscheduled) other).guildId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackGuildInviteReminderUnscheduled(guildId="), this.guildId, ")");
    }
}
