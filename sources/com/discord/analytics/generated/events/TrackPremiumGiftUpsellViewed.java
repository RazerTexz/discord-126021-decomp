...
public final /* data */ class TrackPremiumGiftUpsellViewed implements AnalyticsSchema, TrackBaseReceiver, TrackLocationMetadataReceiver, TrackSourceMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackPremiumGiftUpsellViewed) && C12238m.areEqual(this.type, ((TrackPremiumGiftUpsellViewed) other).type);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackPremiumGiftUpsellViewed(type="), this.type, ")");
    }
}
