...
public final /* data */ class TrackDataRequestCanceled implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackDataRequestCanceled) && C12238m.areEqual(this.harvestId, ((TrackDataRequestCanceled) other).harvestId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackDataRequestCanceled(harvestId="), this.harvestId, ")");
    }
}
