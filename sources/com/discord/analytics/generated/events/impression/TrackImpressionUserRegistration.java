...
public final /* data */ class TrackImpressionUserRegistration implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackChannelReceiver, TrackLocationMetadataReceiver, TrackImpressionMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackImpressionUserRegistration) && C12238m.areEqual(this.step, ((TrackImpressionUserRegistration) other).step);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackImpressionUserRegistration(step="), this.step, ")");
    }
