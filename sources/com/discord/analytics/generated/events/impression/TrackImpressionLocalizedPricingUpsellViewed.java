...
public final /* data */ class TrackImpressionLocalizedPricingUpsellViewed implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackChannelReceiver, TrackLocationMetadataReceiver, TrackImpressionMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackImpressionLocalizedPricingUpsellViewed) && C12238m.areEqual(this.actionLocation, ((TrackImpressionLocalizedPricingUpsellViewed) other).actionLocation);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackImpressionLocalizedPricingUpsellViewed(actionLocation="), this.actionLocation, ")");
    }
}
