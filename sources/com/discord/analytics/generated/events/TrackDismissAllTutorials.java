...
public final /* data */ class TrackDismissAllTutorials implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackDismissAllTutorials) && C12238m.areEqual(this.tutorial, ((TrackDismissAllTutorials) other).tutorial);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackDismissAllTutorials(tutorial="), this.tutorial, ")");
    }
}
