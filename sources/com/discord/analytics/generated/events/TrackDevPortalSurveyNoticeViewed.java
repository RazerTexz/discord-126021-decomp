...
public final /* data */ class TrackDevPortalSurveyNoticeViewed implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackDevPortalSurveyNoticeViewed) && C12238m.areEqual(this.noticeName, ((TrackDevPortalSurveyNoticeViewed) other).noticeName);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackDevPortalSurveyNoticeViewed(noticeName="), this.noticeName, ")");
    }
}
