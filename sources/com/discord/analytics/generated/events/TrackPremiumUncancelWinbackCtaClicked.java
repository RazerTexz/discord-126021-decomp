...
public final /* data */ class TrackPremiumUncancelWinbackCtaClicked implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackPremiumUncancelWinbackCtaClicked) && C12238m.areEqual(this.action, ((TrackPremiumUncancelWinbackCtaClicked) other).action);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackPremiumUncancelWinbackCtaClicked(action="), this.action, ")");
    }
}
