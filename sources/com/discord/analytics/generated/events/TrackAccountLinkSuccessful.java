...
public final /* data */ class TrackAccountLinkSuccessful implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackAccountLinkSuccessful) && C12238m.areEqual(this.platformType, ((TrackAccountLinkSuccessful) other).platformType);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackAccountLinkSuccessful(platformType="), this.platformType, ")");
    }
}
