...
public final /* data */ class TrackGuildLurkStarted implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildLurkStarted) && C12238m.areEqual(this.hasVerificationGate, ((TrackGuildLurkStarted) other).hasVerificationGate);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackGuildLurkStarted(hasVerificationGate="), this.hasVerificationGate, ")");
    }
}
