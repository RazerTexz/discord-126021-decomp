...
public final /* data */ class TrackStarterChannelsCtaClicked implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackStarterChannelsCtaClicked) && C12238m.areEqual(this.starterChannelType, ((TrackStarterChannelsCtaClicked) other).starterChannelType);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackStarterChannelsCtaClicked(starterChannelType="), this.starterChannelType, ")");
    }
}
