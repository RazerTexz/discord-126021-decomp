...
public final /* data */ class TrackGuildScheduledEventPurchaseInitiated implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildScheduledEventPurchaseInitiated) && C12238m.areEqual(this.guildScheduledEventId, ((TrackGuildScheduledEventPurchaseInitiated) other).guildScheduledEventId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackGuildScheduledEventPurchaseInitiated(guildScheduledEventId="), this.guildScheduledEventId, ")");
    }
}
