...
public final /* data */ class TrackConnectedAccountViewed implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackConnectedAccountViewed) && C12238m.areEqual(this.platformType, ((TrackConnectedAccountViewed) other).platformType);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackConnectedAccountViewed(platformType="), this.platformType, ")");
    }
}
