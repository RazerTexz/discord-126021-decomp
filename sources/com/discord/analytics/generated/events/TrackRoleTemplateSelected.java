...
public final /* data */ class TrackRoleTemplateSelected implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackLocationMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackRoleTemplateSelected) && C12238m.areEqual(this.templateName, ((TrackRoleTemplateSelected) other).templateName);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackRoleTemplateSelected(templateName="), this.templateName, ")");
    }
}
