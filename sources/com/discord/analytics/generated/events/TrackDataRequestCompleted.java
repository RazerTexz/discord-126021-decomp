...
public final /* data */ class TrackDataRequestCompleted implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackDataRequestCompleted) && C12238m.areEqual(this.harvestId, ((TrackDataRequestCompleted) other).harvestId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackDataRequestCompleted(harvestId="), this.harvestId, ")");
    }
}
