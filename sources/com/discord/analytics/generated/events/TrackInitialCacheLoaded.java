...
public final /* data */ class TrackInitialCacheLoaded implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackInitialCacheLoaded) && C12238m.areEqual(this.loadId, ((TrackInitialCacheLoaded) other).loadId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackInitialCacheLoaded(loadId="), this.loadId, ")");
    }
}
