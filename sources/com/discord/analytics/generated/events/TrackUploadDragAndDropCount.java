...
public final /* data */ class TrackUploadDragAndDropCount implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackUploadDragAndDropCount) && C12238m.areEqual(this.count, ((TrackUploadDragAndDropCount) other).count);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackUploadDragAndDropCount(count="), this.count, ")");
    }
}
