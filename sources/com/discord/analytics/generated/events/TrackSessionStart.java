...
public final /* data */ class TrackSessionStart implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackSessionStart) && C12238m.areEqual(this.session, ((TrackSessionStart) other).session);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackSessionStart(session="), this.session, ")");
    }
}
