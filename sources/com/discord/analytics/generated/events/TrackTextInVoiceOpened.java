...
public final /* data */ class TrackTextInVoiceOpened implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackChannelReceiver, TrackOverlayClientMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackTextInVoiceOpened) && C12238m.areEqual(this.channelIsNsfw, ((TrackTextInVoiceOpened) other).channelIsNsfw);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackTextInVoiceOpened(channelIsNsfw="), this.channelIsNsfw, ")");
    }
}
