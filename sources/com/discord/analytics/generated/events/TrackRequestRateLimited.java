...
public final /* data */ class TrackRequestRateLimited implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackRequestRateLimited) && C12238m.areEqual(this.bucket, ((TrackRequestRateLimited) other).bucket);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackRequestRateLimited(bucket="), this.bucket, ")");
    }
}
