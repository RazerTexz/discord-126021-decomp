...
public final /* data */ class TrackContactSelected implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackContactSelected) && C12238m.areEqual(this.selected, ((TrackContactSelected) other).selected);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackContactSelected(selected="), this.selected, ")");
    }
}
