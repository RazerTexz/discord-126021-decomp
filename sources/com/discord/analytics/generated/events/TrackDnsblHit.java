...
public final /* data */ class TrackDnsblHit implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackDnsblHit) && C12238m.areEqual(this.provider, ((TrackDnsblHit) other).provider);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackDnsblHit(provider="), this.provider, ")");
    }
}
