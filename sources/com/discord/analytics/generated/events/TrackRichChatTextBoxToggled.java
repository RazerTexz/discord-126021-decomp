...
public final /* data */ class TrackRichChatTextBoxToggled implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackRichChatTextBoxToggled) && C12238m.areEqual(this.isEnabled, ((TrackRichChatTextBoxToggled) other).isEnabled);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackRichChatTextBoxToggled(isEnabled="), this.isEnabled, ")");
    }
}
