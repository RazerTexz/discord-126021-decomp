...
public final /* data */ class TrackEmojiUploadCompleted implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackEmojiUploadCompleted) && C12238m.areEqual(this.uploadId, ((TrackEmojiUploadCompleted) other).uploadId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackEmojiUploadCompleted(uploadId="), this.uploadId, ")");
    }
}
