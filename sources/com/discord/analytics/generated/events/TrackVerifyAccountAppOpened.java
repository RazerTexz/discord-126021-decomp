...
public final /* data */ class TrackVerifyAccountAppOpened implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackVerifyAccountAppOpened) && C12238m.areEqual(this.verifyingUserId, ((TrackVerifyAccountAppOpened) other).verifyingUserId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackVerifyAccountAppOpened(verifyingUserId="), this.verifyingUserId, ")");
    }
}
