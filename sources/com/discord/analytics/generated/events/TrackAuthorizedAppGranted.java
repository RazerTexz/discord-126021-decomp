...
public final /* data */ class TrackAuthorizedAppGranted implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackAuthorizedAppGranted) && C12238m.areEqual(this.applicationId, ((TrackAuthorizedAppGranted) other).applicationId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackAuthorizedAppGranted(applicationId="), this.applicationId, ")");
    }
}
