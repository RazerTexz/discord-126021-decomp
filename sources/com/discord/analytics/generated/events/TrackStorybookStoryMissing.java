...
public final /* data */ class TrackStorybookStoryMissing implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackStorybookStoryMissing) && C12238m.areEqual(this.storyId, ((TrackStorybookStoryMissing) other).storyId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackStorybookStoryMissing(storyId="), this.storyId, ")");
    }
}
