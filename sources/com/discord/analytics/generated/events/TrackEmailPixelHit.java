...
public final /* data */ class TrackEmailPixelHit implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackEmailPixelHit) && C12238m.areEqual(this.trackingPixelUuid, ((TrackEmailPixelHit) other).trackingPixelUuid);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackEmailPixelHit(trackingPixelUuid="), this.trackingPixelUuid, ")");
    }
}
