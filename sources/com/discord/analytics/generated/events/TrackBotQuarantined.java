...
public final /* data */ class TrackBotQuarantined implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackBotQuarantined) && C12238m.areEqual(this.botId, ((TrackBotQuarantined) other).botId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackBotQuarantined(botId="), this.botId, ")");
    }
}
