...
public final /* data */ class TrackGuildWelcomeScreenOptionSelected implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackGuildWelcomeScreenReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildWelcomeScreenOptionSelected) && C12238m.areEqual(this.index, ((TrackGuildWelcomeScreenOptionSelected) other).index);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackGuildWelcomeScreenOptionSelected(index="), this.index, ")");
    }
}
