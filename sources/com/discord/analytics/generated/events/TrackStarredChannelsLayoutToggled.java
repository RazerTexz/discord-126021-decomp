...
public final /* data */ class TrackStarredChannelsLayoutToggled implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackStarredChannelsLayoutToggled) && C12238m.areEqual(this.selectedLayout, ((TrackStarredChannelsLayoutToggled) other).selectedLayout);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m817E(C1643a.m833U("TrackStarredChannelsLayoutToggled(selectedLayout="), this.selectedLayout, ")");
    }
}
