...
public final /* data */ class TrackGuildInsightsSettingsCtaClicked implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildInsightsSettingsCtaClicked) && C12238m.areEqual(this.guildId, ((TrackGuildInsightsSettingsCtaClicked) other).guildId);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackGuildInsightsSettingsCtaClicked(guildId="), this.guildId, ")");
    }
}
