...
public final /* data */ class TrackMktgNitroOpened implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackMktgNitroOpened) && C12238m.areEqual(this.desktopProbablyOpen, ((TrackMktgNitroOpened) other).desktopProbablyOpen);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m816D(C1643a.m833U("TrackMktgNitroOpened(desktopProbablyOpen="), this.desktopProbablyOpen, ")");
    }
}
