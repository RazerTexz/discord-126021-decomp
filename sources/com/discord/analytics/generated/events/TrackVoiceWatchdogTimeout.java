...
public final /* data */ class TrackVoiceWatchdogTimeout implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackVoiceWatchdogTimeout) && C12238m.areEqual(this.minidumpSubmissionError, ((TrackVoiceWatchdogTimeout) other).minidumpSubmissionError);
        }
        return true;
    }
    ...
    public String toString() {
        return C1643a.m819G(C1643a.m833U("TrackVoiceWatchdogTimeout(minidumpSubmissionError="), this.minidumpSubmissionError, ")");
    }
}
