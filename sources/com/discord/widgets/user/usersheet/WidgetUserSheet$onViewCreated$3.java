...
public final class WidgetUserSheet$onViewCreated$3 extends o implements Function0<Unit> {
    ...
    public final void invoke2() {
        WidgetUserSheet.access$getViewModel$p(this.this$0).setUserSuppressedInChannel(true);
    }
}
