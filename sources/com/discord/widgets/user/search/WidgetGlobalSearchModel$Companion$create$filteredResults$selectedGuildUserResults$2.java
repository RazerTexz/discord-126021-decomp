...
public final class WidgetGlobalSearchModel$Companion$create$filteredResults$selectedGuildUserResults$2 extends o implements Function1<Long, WidgetGlobalSearchModel$ItemUser> {
    ...
    public WidgetGlobalSearchModel$Companion$create$filteredResults$selectedGuildUserResults$2(WidgetGlobalSearchModel$Companion$create$2 widgetGlobalSearchModel$Companion$create$2, WidgetGlobalSearchModel$UsersContext widgetGlobalSearchModel$UsersContext, String str) {
        super(1);
