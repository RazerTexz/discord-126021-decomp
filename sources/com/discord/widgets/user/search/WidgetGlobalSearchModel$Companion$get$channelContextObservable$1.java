...
public final /* synthetic */ class WidgetGlobalSearchModel$Companion$get$channelContextObservable$1 extends C12236k implements Function8<Map<Long, ? extends Guild>, Map<Long, ? extends Channel>, Map<Long, ? extends Channel>, Map<Long, ? extends Long>, Map<Long, ? extends Channel>, Map<Long, ? extends List<? extends Long>>, Set<? extends Long>, Set<? extends Long>, WidgetGlobalSearchModel.ChannelContext> {
    ...
    public final WidgetGlobalSearchModel.ChannelContext invoke2(Map<Long, Guild> map, Map<Long, Channel> map2, Map<Long, Channel> map3, Map<Long, Long> map4, Map<Long, Channel> map5, Map<Long, ? extends List<Long>> map6, Set<Long> set, Set<Long> set2) {
        ...
        C12238m.checkNotNullParameter(set, "p7");
        C12238m.checkNotNullParameter(set2, "p8");
