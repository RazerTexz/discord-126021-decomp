...
public final class WidgetUserMentions$WidgetUserMentionFilter$onResume$1<T> implements Action1<Boolean> {
    ...
    public WidgetUserMentions$WidgetUserMentionFilter$onResume$1(WidgetUserMentions$WidgetUserMentionFilter widgetUserMentions$WidgetUserMentionFilter) {
    ...
    public final void call2(Boolean bool) {
        ...
        CheckedSetting checkedSetting = WidgetUserMentions$WidgetUserMentionFilter.access$getBinding$p(this.this$0).d;
        m.checkNotNullExpressionValue(checkedSetting, "binding.userMentionsFilterThisServer");
        WidgetUserMentions$WidgetUserMentionFilter.access$updateFilters(widgetUserMentions$WidgetUserMentionFilter, WidgetUserMentions$Model$MessageLoader$Filters.copy$default(widgetUserMentions$Model$MessageLoader$FiltersAccess$getFilters$p, 0L, !checkedSetting.isChecked(), false, false, 13, null));
