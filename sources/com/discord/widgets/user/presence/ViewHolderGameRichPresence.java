    ...
    public void configureTextUi(Activity model, StreamContext streamContext) {
        ...
        if (state != null) {
            ...
            if (party != null) {
                ...
                charSequenceM210b = (presenceUtils.getMaxSize(party) == 0 || (context = getRoot().getContext()) == null) ? null : C1107b.m210b(context, C5419R.string.user_activity_state_size, new Object[]{String.valueOf(presenceUtils.getCurrentSize(party)), String.valueOf(presenceUtils.getMaxSize(party))}, (4 & 4) != 0 ? C1107b.b.f1491j : null);
