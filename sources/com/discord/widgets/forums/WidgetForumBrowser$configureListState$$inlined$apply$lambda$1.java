...
public final class WidgetForumBrowser$configureListState$$inlined$apply$lambda$1 extends AbstractC12240o implements Function0<Unit> {
    ...
    public final void invoke2() {
        this.this$0.onLayoutCompleted(this.$viewState$inlined.getChannelId(), this.$viewState$inlined.getGuildId());
    }
}
