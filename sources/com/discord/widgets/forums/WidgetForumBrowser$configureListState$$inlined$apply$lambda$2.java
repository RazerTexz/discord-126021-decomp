...
public final class WidgetForumBrowser$configureListState$$inlined$apply$lambda$2 extends o implements Function0<Unit> {
    ...
    public WidgetForumBrowser$configureListState$$inlined$apply$lambda$2(WidgetForumBrowser widgetForumBrowser, WidgetForumBrowserViewModel$ViewState$Loaded widgetForumBrowserViewModel$ViewState$Loaded) {
        super(0);
