...
public final class C8719xce82ae71 extends AbstractC12240o implements Function1<FragmentActivity, Boolean> {
    ...
    public final boolean invoke2(FragmentActivity fragmentActivity) {
        ...
        do {
            ...
            next = it.next();
        } while (!C12238m.areEqual(C12216a0.getOrCreateKotlinClass(((Fragment) next).getClass()), C12216a0.getOrCreateKotlinClass(WidgetTabsHost.class)));
