...
public final class WidgetGuildContextMenu$configureValidUI$3 implements View$OnClickListener {
    ...
    public WidgetGuildContextMenu$configureValidUI$3(WidgetGuildContextMenu widgetGuildContextMenu, GuildContextMenuViewModel$ViewState$Valid guildContextMenuViewModel$ViewState$Valid) {
    ...
    public final void onClick(View view) {
        ...
        widgetLeaveGuildDialog$Companion.show(parentFragmentManager, this.$viewState.getGuild().getId());
    }
}
