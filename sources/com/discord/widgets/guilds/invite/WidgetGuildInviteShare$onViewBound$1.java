...
public final class WidgetGuildInviteShare$onViewBound$1<R> implements Func0<Boolean> {
    public final /* synthetic */ boolean $isNuxFlow;
    public final /* synthetic */ WidgetGuildInviteShare this$0;

    public WidgetGuildInviteShare$onViewBound$1(WidgetGuildInviteShare widgetGuildInviteShare, boolean z2) {
    ...
    public final Boolean call() {
        if (WidgetGuildInviteShare.access$getBottomSheetBehavior$p(this.this$0).getState() != 5) {
