...
public final class WidgetGuildInviteShareCompact$PrivateChannelAdapter$Item extends MGRecyclerViewHolder<WidgetGuildInviteShareCompact$PrivateChannelAdapter, InviteSuggestionItem> {
    private final WidgetGuildInviteShareItemBinding binding;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetGuildInviteShareCompact$PrivateChannelAdapter$Item(WidgetGuildInviteShareCompact$PrivateChannelAdapter widgetGuildInviteShareCompact$PrivateChannelAdapter) {
        super(R$layout.widget_guild_invite_share_item, widgetGuildInviteShareCompact$PrivateChannelAdapter);
        m.checkNotNullParameter(widgetGuildInviteShareCompact$PrivateChannelAdapter, "adapter");
    ...
    public static final /* synthetic */ WidgetGuildInviteShareCompact$PrivateChannelAdapter access$getAdapter$p(WidgetGuildInviteShareCompact$PrivateChannelAdapter$Item widgetGuildInviteShareCompact$PrivateChannelAdapter$Item) {
        return (WidgetGuildInviteShareCompact$PrivateChannelAdapter) widgetGuildInviteShareCompact$PrivateChannelAdapter$Item.adapter;
    }
