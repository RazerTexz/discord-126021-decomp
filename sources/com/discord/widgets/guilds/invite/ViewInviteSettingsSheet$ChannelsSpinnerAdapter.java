...
public final class ViewInviteSettingsSheet$ChannelsSpinnerAdapter extends ArrayAdapter<Channel> {
    private Channel[] channels;

    public /* synthetic */ ViewInviteSettingsSheet$ChannelsSpinnerAdapter(Context context, int i, Channel[] channelArr, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ViewInviteSettingsSheet$ChannelsSpinnerAdapter(Context context, int i, Channel[] channelArr) {
