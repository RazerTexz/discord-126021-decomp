...
public final class WidgetGuildListAdapter$onCreateViewHolder$6 extends o implements Function1<GuildListItem$PrivateChannelItem, Unit> {
    public final /* synthetic */ View $itemView;
    public final /* synthetic */ WidgetGuildListAdapter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetGuildListAdapter$onCreateViewHolder$6(WidgetGuildListAdapter widgetGuildListAdapter, View view) {
        super(1);
    ...
    public final void invoke2(GuildListItem$PrivateChannelItem guildListItem$PrivateChannelItem) {
        ...
        widgetGuildListAdapter$InteractionListenerAccess$getInteractionListener$p.onItemClicked(view, guildListItem$PrivateChannelItem);
    }
}
