...
public final class WidgetGuildListAdapter$onCreateViewHolder$5 extends o implements Function1<GuildListItem$FolderItem, Unit> {
    public final /* synthetic */ View $itemView;
    public final /* synthetic */ WidgetGuildListAdapter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetGuildListAdapter$onCreateViewHolder$5(WidgetGuildListAdapter widgetGuildListAdapter, View view) {
        super(1);
    ...
    public final void invoke2(GuildListItem$FolderItem guildListItem$FolderItem) {
        ...
        widgetGuildListAdapter$InteractionListenerAccess$getInteractionListener$p.onItemLongPressed(view, guildListItem$FolderItem);
    }
}
