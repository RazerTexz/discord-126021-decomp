...
public final class WidgetGuildsListViewModel$handleStoreState$lurkerGuildItems$2 extends AbstractC12240o implements Function1<StoreGuildsSorted.Entry.SingletonGuild, GuildListItem.GuildItem> {
    ...
    public final GuildListItem.GuildItem invoke(StoreGuildsSorted.Entry.SingletonGuild singletonGuild) {
        C12238m.checkNotNullParameter(singletonGuild, "folder");
        ...
        C12238m.checkNotNullExpressionValue(num, "mentionCountsByGuild[folder.guild.id] ?: 0");
