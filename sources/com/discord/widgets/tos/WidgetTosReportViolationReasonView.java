...
public final class WidgetTosReportViolationReasonView extends RelativeLayout {
    ...
    public final boolean isChecked() {
        ...
        C12238m.checkNotNullExpressionValue(materialRadioButton, "binding.reportReasonRadio");
    ...
    public void setOnClickListener(final View.OnClickListener onClickListener) {
        ...
        this.binding.f18308a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.tos.WidgetTosReportViolationReasonView.setOnClickListener.1
        ...
        this.binding.f18311d.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.discord.widgets.tos.WidgetTosReportViolationReasonView.setOnClickListener.2
    ...
    public final void setReason(ReportReason reportReason) {
        ...
        C12238m.checkNotNullExpressionValue(textView, "binding.reportReasonHeader");
        textView.setText(reportReason != null ? reportReason.getLabel() : null);
        TextView textView2 = this.binding.f18309b;
        C12238m.checkNotNullExpressionValue(textView2, "binding.reportReasonDescriptipn");
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                ...
                if (materialRadioButton != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetTosReportViolationReasonBinding, "WidgetTosReportViolation…rom(context), this, true)");
