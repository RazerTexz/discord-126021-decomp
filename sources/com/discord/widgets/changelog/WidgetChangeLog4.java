...
public final class WidgetChangeLog4 extends BaseControllerListener<Object> {
    ...
    public void onFinalImageSet(String id2, Object imageInfo, Animatable animatable) {
        ...
        try {
            SimpleDraweeView simpleDraweeView = this.this$0.getBinding().i;
            ...
            this.this$0.getBinding().i.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.changelog.WidgetChangeLog$thumbnailControllerListener$1$onFinalImageSet$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Animatable animatableC;
                    this.this$0.this$0.hideVideoOverlay();
                    SimpleDraweeView simpleDraweeView2 = this.this$0.this$0.getBinding().f;
