...
public final class ChangeLogParser {
    ...
    private final <RC, S> List<Rule<RC, Node<RC>, S>> createChangelogSpecialMarkdownRules(Context context) {
        ...
        return C12147n.listOf((Object[]) new Rule.BlockRule[]{new Rules.HeaderLineClassedRule(changelogSpans.createChangelogSpecialHeaderPaddingSpansProvider(context), changelogSpans.createHeaderStyleSpanProvider(context), changelogSpans.createHeaderClassSpanProvider(context)), new Rules.HeaderLineClassedRule(changelogSpans.createHeaderPaddingSpansProvider(context), changelogSpans.createSpecialHeaderStyleSpanProvider(context), changelogSpans.createHeaderClassSpanProvider(context)), new Rules.MarkdownListItemRule(changelogSpans.createMarkdownBulletSpansProvider(context))});
    }

    private final <RC, S> List<Rule<RC, Node<RC>, S>> createMarkdownRules(Context context) {
        ChangelogSpans changelogSpans = ChangelogSpans.INSTANCE;
        return C12147n.listOf((Object[]) new Rule.BlockRule[]{new C1308a.c(changelogSpans.createHeaderStyleSpanProvider(context)), new Rules.HeaderLineClassedRule(changelogSpans.createHeaderPaddingSpansProvider(context), changelogSpans.createHeaderStyleSpanProvider(context), changelogSpans.createHeaderClassSpanProvider(context)), new Rules.MarkdownListItemRule(changelogSpans.createMarkdownBulletSpansProvider(context))});
    }
    ...
    public final DraweeSpanStringBuilder parse(Context context, CharSequence input, boolean changeLogRules, Function3<? super Context, ? super String, ? super String, Unit> onClickListener) {
        ...
        List listM372b = C1303e.m372b(false, false, 3);
