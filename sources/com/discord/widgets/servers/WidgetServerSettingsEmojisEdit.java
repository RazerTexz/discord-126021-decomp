...
public final class WidgetServerSettingsEmojisEdit extends AppFragment {
    public static final /* synthetic */ KProperty[] $$delegatedProperties = {C1643a.m846d0(WidgetServerSettingsEmojisEdit.class, "binding", "getBinding()Lcom/discord/databinding/WidgetServerSettingsEmojisEditBinding;", 0)};
    ...
    public static final class Companion {
        ...
        public final void create(Context context, long guildId, long emojiId, String alias) {
            ...
            C12238m.checkNotNullParameter(alias, "alias");
            ...
            C0870j.m156d(context, WidgetServerSettingsEmojisEdit.class, intentPutExtra);
        }
    ...
    private final void configureMenu() {
        AppFragment.setActionBarOptionsMenu$default(this, C5419R.menu.menu_server_settings_emojis_edit, new Action2<MenuItem, Context>() { // from class: com.discord.widgets.servers.WidgetServerSettingsEmojisEdit.configureMenu.1
    ...
    private final void deleteEmoji() {
        ...
        ObservableExtensionsKt.ui$default(ObservableExtensionsKt.restSubscribeOn$default(RestAPI.INSTANCE.getApi().deleteGuildEmoji(this.guildId, this.emojiId), false, 1, null), this, null, 2, null).m11108k(C0879o.m182i(new Action1<Void>() { // from class: com.discord.widgets.servers.WidgetServerSettingsEmojisEdit.deleteEmoji.1
    ...
    private final void handleSaveAlias() {
        ...
        C12238m.checkNotNullExpressionValue(textInputLayout, "binding.serverSettingsEmojisEditAlias");
    ...
    private final void onSaveSuccess(String sanitizedName) {
        ...
        C12238m.checkNotNullExpressionValue(textInputLayout2, "binding.serverSettingsEmojisEditAlias");
        StatefulViews statefulViews2 = this.state;
        TextInputLayout textInputLayout3 = getBinding().f17641b;
        C12238m.checkNotNullExpressionValue(textInputLayout3, "binding.serverSettingsEmojisEditAlias");
        ViewExtensions.setText(textInputLayout2, (CharSequence) statefulViews2.get(textInputLayout3.getId(), sanitizedName));
        C0876m.m172j(this, getString(C5419R.string.save_media_success_mobile), 0, 4);
    }
    ...
    public void onViewBound(View view) {
        ...
        getBinding().f17642c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerSettingsEmojisEdit.onViewBound.1
        ...
        C12238m.checkNotNullExpressionValue(textInputLayout4, "binding.serverSettingsEmojisEditAlias");
