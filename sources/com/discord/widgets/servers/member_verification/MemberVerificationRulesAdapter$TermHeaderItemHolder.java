...
public final class MemberVerificationRulesAdapter$TermHeaderItemHolder extends MGRecyclerViewHolder<MemberVerificationRulesAdapter, MGRecyclerDataPayload> {
    private final WidgetMemberVerificationHeaderItemBinding binding;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MemberVerificationRulesAdapter$TermHeaderItemHolder(MemberVerificationRulesAdapter memberVerificationRulesAdapter) {
    ...
    public void onConfigure2(int position, MGRecyclerDataPayload data) {
        ...
        textView.setText(view.getResources().getString(2131892855));
    }
}
