...
public final class WidgetServerSettingsCommunitySecondStep$onViewBound$2 extends o implements Function2<Long, String, Unit> {
    ...
    public final void invoke(long j, String str) {
        ...
        WidgetServerSettingsCommunitySecondStep.access$getViewModel$p(this.this$0).modifyGuildConfig(new WidgetServerSettingsCommunitySecondStep$onViewBound$2$1(j, StoreStream.Companion.getChannels().getChannel(j)));
    }
}
