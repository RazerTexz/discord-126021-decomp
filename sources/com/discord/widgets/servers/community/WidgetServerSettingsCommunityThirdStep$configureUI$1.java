...
public final class WidgetServerSettingsCommunityThirdStep$configureUI$1 implements View$OnClickListener {
    ...
    public WidgetServerSettingsCommunityThirdStep$configureUI$1(WidgetServerSettingsCommunityThirdStep widgetServerSettingsCommunityThirdStep, WidgetServerSettingsEnableCommunityViewModel$ViewState$Loaded widgetServerSettingsEnableCommunityViewModel$ViewState$Loaded, boolean z2) {
    ...
    public final void onClick(View view) {
        if (this.$viewState.getCommunityGuildConfig().getDefaultMessageNotifications() && this.$guildDefaultMessageNotifications) {
            ...
            WidgetServerSettingsCommunityThirdStep.access$getViewModel$p(this.this$0).modifyGuildConfig(new WidgetServerSettingsCommunityThirdStep$configureUI$1$1(this));
        }
    }
}
