...
public final class WidgetServerSettingsCommunitySecondStep$onViewBound$2$1 extends o implements Function1<WidgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig, WidgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig> {
    public final /* synthetic */ Channel $channel;
    public final /* synthetic */ long $channelId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetServerSettingsCommunitySecondStep$onViewBound$2$1(long j, Channel channel) {
        super(1);
        this.$channelId = j;
    ...
    public final WidgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig invoke2(WidgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig widgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig) {
        ...
        return WidgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig.copy$default(widgetServerSettingsEnableCommunityViewModel$CommunityGuildConfig, null, this.$channel, null, Long.valueOf(this.$channelId), false, false, false, false, null, false, null, null, 4085, null);
    }
}
