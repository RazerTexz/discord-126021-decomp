...
public final class CommunitySelectorView extends LinearLayout {
    ...
    private final void initAttrs(AttributeSet attrs) {
        ...
        C12238m.checkNotNullExpressionValue(typedArrayObtainStyledAttributes, "context.obtainStyledAttr…munitySelectorView, 0, 0)");
        ...
        C12238m.checkNotNullExpressionValue(textView, "binding.serverSettingsCo…unitySettingSelectorTitle");
        textView.setText(text);
        TextView textView2 = this.binding.f15554b;
        C12238m.checkNotNullExpressionValue(textView2, "binding.serverSettingsCo…ettingSelectorDescription");
        textView2.setText(text3);
        TextView textView3 = this.binding.f15556d;
        C12238m.checkNotNullExpressionValue(textView3, "binding.serverSettingsCo…tySettingSelectorSubtitle");
        textView3.setText(text2);
        TextView textView4 = this.binding.f15556d;
        C12238m.checkNotNullExpressionValue(textView4, "binding.serverSettingsCo…tySettingSelectorSubtitle");
        textView4.setVisibility(z2 ? 0 : 8);
        ImageView imageView = this.binding.f15555c;
        C12238m.checkNotNullExpressionValue(imageView, "binding.serverSettingsCo…ttingSelectorDropdownIcon");
    ...
    public final void setSubtitle(CharSequence subtitle) {
        ...
        C12238m.checkNotNullExpressionValue(textView, "binding.serverSettingsCo…tySettingSelectorSubtitle");
            ...
            if (imageView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(viewServerSettingsCommunitySettingSelectorBinding, "ViewServerSettingsCommun…ater.from(context), this)");
