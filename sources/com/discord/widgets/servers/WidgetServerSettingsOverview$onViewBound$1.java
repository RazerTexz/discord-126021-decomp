...
public final class WidgetServerSettingsOverview$onViewBound$1 extends o implements Function2<Long, String, Unit> {
    public final /* synthetic */ WidgetServerSettingsOverview this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetServerSettingsOverview$onViewBound$1(WidgetServerSettingsOverview widgetServerSettingsOverview) {
        super(2);
    ...
    public final void invoke(long j, String str) {
        ...
        WidgetServerSettingsOverview.access$getState$p(this.this$0).put(R$id.afk_channel, channel);
        ...
        WidgetServerSettingsOverview.access$configureAfkChannel(this.this$0, channel);
    }
}
