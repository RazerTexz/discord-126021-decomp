...
public final class WidgetServerSettingsEditIntegration$expiryBehaviorRadios$2 extends AbstractC12240o implements Function0<List<? extends CheckedSetting>> {
    ...
    public final List<? extends CheckedSetting> invoke() {
        return C12147n.listOf((Object[]) new CheckedSetting[]{this.this$0.getBinding().f17616f, this.this$0.getBinding().f17615e});
    }
}
