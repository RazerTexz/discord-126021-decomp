...
public final class WidgetServerSettingsIntegrationsListItem extends MGRecyclerViewHolder<WidgetServerSettingsIntegrations.Adapter, WidgetServerSettingsIntegrations.Model.IntegrationItem> {
                                ...
                                if (imageView2 != null) {
                                    ...
                                    if (checkedSetting != null) {
                                        ...
                                        if (progressBar != null) {
                                            ...
                                            C12238m.checkNotNullExpressionValue(widgetServerSettingsIntegrationListItemBinding, "WidgetServerSettingsInte…temBinding.bind(itemView)");
            ...
            if (materialButton != null) {
                ...
                if (materialButton2 != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(new C1092y5(linearLayout, textView, materialButton, materialButton2, textView2), "WidgetServerSettingsConf…om(context), null, false)");
                        final AlertDialog alertDialogCreate = new AlertDialog.Builder(context).setView(linearLayout).create();
                        C12238m.checkNotNullExpressionValue(alertDialogCreate, "AlertDialog.Builder(cont…ew(binding.root).create()");
                        ...
                        materialButton2.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerSettingsIntegrationsListItem.showDisableSyncDialog.2
                            @Override // android.view.View.OnClickListener
                            public final void onClick(View view) {
                                ObservableExtensionsKt.m8518ui(ObservableExtensionsKt.restSubscribeOn$default(RestAPI.INSTANCE.getApi().deleteGuildIntegration(guildId, integrationId), false, 1, null)).m11108k(C0879o.m183j(new Action1<Void>() { // from class: com.discord.widgets.servers.WidgetServerSettingsIntegrationsListItem.showDisableSyncDialog.2.1
    ...
    private final void showSyncingUI(boolean isSyncing) {
        ...
        C12238m.checkNotNullExpressionValue(imageView, "binding.integrationSettingsIcon");
        imageView.setVisibility(isSyncing ^ true ? 0 : 8);
        ProgressBar progressBar = this.binding.f17698i;
        C12238m.checkNotNullExpressionValue(progressBar, "binding.integrationSyncingProgressBar");
        progressBar.setVisibility(isSyncing ? 0 : 8);
        View view = this.binding.f17692c;
        C12238m.checkNotNullExpressionValue(view, "binding.integrationHeaderDisabledOverlay");
    ...
    public void onConfigure(int position, final WidgetServerSettingsIntegrations.Model.IntegrationItem data) {
        ...
        final boolean zAreEqual = C12238m.areEqual(data.getIntegration().getType(), "twitch");
        ...
        if (zIsSyncing) {
            ...
            this.binding.f17691b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerSettingsIntegrationsListItem.onConfigure.1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        C12238m.checkNotNullExpressionValue(textView, "binding.integrationName");
        textView.setText(data.getIntegration().getDisplayName());
        TextView textView2 = this.binding.f17695f;
        C12238m.checkNotNullExpressionValue(textView2, "binding.integrationOwnerName");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting, "binding.integrationSyncSwitch");
        checkedSetting.setChecked(zIsEnabled);
        CheckedSetting checkedSetting2 = this.binding.f17697h;
        C12238m.checkNotNullExpressionValue(checkedSetting2, "binding.integrationSyncSwitch");
        checkedSetting2.setEnabled(!zIsSyncing);
        if (zIsSyncing) {
            this.binding.f17697h.setOnCheckedListener(null);
        } else {
            this.binding.f17697h.setOnCheckedListener(new Action1<Boolean>() { // from class: com.discord.widgets.servers.WidgetServerSettingsIntegrationsListItem.onConfigure.2
                @Override // p658rx.functions.Action1
                public final void call(Boolean bool) {
                    C12238m.checkNotNullExpressionValue(bool, "checked");
                    if (!bool.booleanValue()) {
                        Observable observableM8518ui = ObservableExtensionsKt.m8518ui(ObservableExtensionsKt.restSubscribeOn$default(RestAPI.INSTANCE.getApi().enableIntegration(data.getGuildId(), new RestAPIParams.EnableIntegration(data.getIntegration().getType(), String.valueOf(id2))), false, 1, null));
                        Action1<Void> action1 = new Action1<Void>() { // from class: com.discord.widgets.servers.WidgetServerSettingsIntegrationsListItem.onConfigure.2.1
                            ...
                            public final void call(Void r3) {
                                CheckedSetting checkedSetting3 = WidgetServerSettingsIntegrationsListItem.this.binding.f17697h;
                                C12238m.checkNotNullExpressionValue(checkedSetting3, "binding.integrationSyncSwitch");
                                checkedSetting3.setChecked(true);
                                CheckedSetting checkedSetting4 = WidgetServerSettingsIntegrationsListItem.this.binding.f17697h;
                                C12238m.checkNotNullExpressionValue(checkedSetting4, "binding.integrationSyncSwitch");
                        ...
                        CheckedSetting checkedSetting3 = WidgetServerSettingsIntegrationsListItem.this.binding.f17697h;
                        C12238m.checkNotNullExpressionValue(checkedSetting3, "binding.integrationSyncSwitch");
                        observableM8518ui.m11108k(C0879o.m183j(action1, checkedSetting3.getContext(), null, 4));
                        return;
                    }
                    ...
                    C12238m.checkNotNullExpressionValue(context, "binding.integrationSyncSwitch.context");
