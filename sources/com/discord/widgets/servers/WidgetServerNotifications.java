...
public final class WidgetServerNotifications extends AppFragment {
    public static final /* synthetic */ KProperty[] $$delegatedProperties = {C1643a.m846d0(WidgetServerNotifications.class, "binding", "getBinding()Lcom/discord/databinding/WidgetServerNotificationsBinding;", 0)};
    ...
    public static final class Companion {
        ...
        private final Observable<List<NotificationsOverridesAdapter.Item>> getNotificationOverrides(long guildId) {
            ...
            return Observable.m11075i(companion.getUserGuildSettings().observeGuildSettings(guildId).m11083G(new InterfaceC12589b<ModelNotificationSettings, List<ModelNotificationSettings.ChannelOverride>>() { // from class: com.discord.widgets.servers.WidgetServerNotifications$Companion$getNotificationOverrides$1
                ...
                public final List<ModelNotificationSettings.ChannelOverride> call(ModelNotificationSettings modelNotificationSettings) {
                    C12238m.checkNotNullExpressionValue(modelNotificationSettings, "it");
                ...
                public final List<NotificationsOverridesAdapter.Item> call2(List<ModelNotificationSettings.ChannelOverride> list, Map<Long, Channel> map, GuildChannelsInfo guildChannelsInfo) {
                    ...
                    C12238m.checkNotNullExpressionValue(list, "channelOverrides");
                    ...
                    for (Object obj : arrayList) {
                        ...
                        C12238m.checkNotNullExpressionValue(channelOverride2, "override");
        ...
        public final void launch(long guildId, Context context) {
            ...
            C0870j.m156d(context, WidgetServerNotifications.class, intentPutExtra);
        }
    ...
    public static final /* data */ class Model {
        ...
        public static final class Companion {
            ...
            public final Observable<Model> get(long guildId) {
                StoreStream.Companion companion = StoreStream.INSTANCE;
                Observable observableM11075i = Observable.m11075i(companion.getGuilds().observeGuild(guildId), companion.getUserGuildSettings().observeGuildSettings(guildId), companion.getGuildProfiles().observeGuildProfile(guildId), new Func3<Guild, ModelNotificationSettings, StoreGuildProfiles.GuildProfileData, Model>() { // from class: com.discord.widgets.servers.WidgetServerNotifications$Model$Companion$get$1
                    @Override // p658rx.functions.Func3
        ...
        public Model(Guild guild, ModelNotificationSettings modelNotificationSettings, StoreGuildProfiles.GuildProfileData guildProfileData) {
            ...
            C12238m.checkNotNullParameter(modelNotificationSettings, "guildSettings");
            this.guild = guild;
        ...
        public boolean equals(Object other) {
            ...
            return C12238m.areEqual(this.guild, model.guild) && C12238m.areEqual(this.guildSettings, model.guildSettings) && C12238m.areEqual(this.guildProfile, model.guildProfile);
        }
    ...
    /* JADX INFO: compiled from: WidgetServerNotifications.kt */
    public static final class C91581 extends AbstractC12240o implements Function1<Integer, Unit> {
        ...
        public final void invoke(int i) {
            ...
            NotificationHighlightsSettingsView notificationHighlightsSettingsView = WidgetServerNotifications.this.getBinding().f17498j;
            C12238m.checkNotNullExpressionValue(notificationHighlightsSettingsView, "binding.serverNotificationsHighlights");
            Context context = notificationHighlightsSettingsView.getContext();
            C12238m.checkNotNullExpressionValue(context, "binding.serverNotificationsHighlights.context");
    ...
    /* JADX INFO: compiled from: WidgetServerNotifications.kt */
    public static final class C91631 extends AbstractC12240o implements Function2<View, NotificationsOverridesAdapter.Item, Unit> {
    ...
    /* JADX INFO: compiled from: WidgetServerNotifications.kt */
    public static final class C91651 extends AbstractC12240o implements Function1<Model, Unit> {
        public C91651() {
            super(1);
        }
    ...
    /* JADX INFO: compiled from: WidgetServerNotifications.kt */
    public static final class C91662 extends AbstractC12240o implements Function1<List<? extends NotificationsOverridesAdapter.Item>, Unit> {
        public C91662() {
            super(1);
        }
    ...
    public static final /* synthetic */ NotificationsOverridesAdapter access$getOverrideAdapter$p(WidgetServerNotifications widgetServerNotifications) {
        ...
        if (notificationsOverridesAdapter == null) {
            C12238m.throwUninitializedPropertyAccessException("overrideAdapter");
        }
    ...
    private final void configureForHub() {
        ...
        C12238m.checkNotNullExpressionValue(view, "binding.serverNotificationsFrequencyDivider");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting, "binding.serverNotificationsEveryoneSwitch");
        checkedSetting.setVisibility(8);
        View view2 = getBinding().f17504p;
        C12238m.checkNotNullExpressionValue(view2, "binding.serverNotificationsRolesDivider");
        view2.setVisibility(8);
        CheckedSetting checkedSetting2 = getBinding().f17505q;
        C12238m.checkNotNullExpressionValue(checkedSetting2, "binding.serverNotificationsRolesSwitch");
        checkedSetting2.setVisibility(8);
        CheckedSetting checkedSetting3 = getBinding().f17503o;
        C12238m.checkNotNullExpressionValue(checkedSetting3, "binding.serverNotificationsPushSwitch");
        checkedSetting3.setVisibility(8);
        TextView textView = getBinding().f17502n;
        C12238m.checkNotNullExpressionValue(textView, "binding.serverNotificationsOverrideTitle");
        textView.setVisibility(8);
        C1095z1 c1095z1 = getBinding().f17490b;
        C12238m.checkNotNullExpressionValue(c1095z1, "binding.addOverride");
        ConstraintLayout constraintLayout = c1095z1.f1434a;
        C12238m.checkNotNullExpressionValue(constraintLayout, "binding.addOverride.root");
        constraintLayout.setVisibility(8);
        View view3 = getBinding().f17501m;
        C12238m.checkNotNullExpressionValue(view3, "binding.serverNotificationsOverrideDivider");
        view3.setVisibility(8);
        RecyclerView recyclerView = getBinding().f17491c;
        C12238m.checkNotNullExpressionValue(recyclerView, "binding.guildNotificationsOverrideList");
        ...
        C12238m.checkNotNullExpressionValue(view4, "binding.serverNotificationsHighlightsDivider");
    ...
    private final void configureRadio(CheckedSetting radio, final int type, final Model model) {
        ...
        if (model.getIsAboveNotifyAllSize() && type == ModelNotificationSettings.FREQUENCY_ALL) {
            CharSequence charSequenceM213e = C1107b.m213e(this, C5419R.string.large_guild_notify_all_messages_description, new Object[0], (4 & 4) != 0 ? C1107b.a.f1490j : null);
            int i = CheckedSetting.f19010j;
            radio.m8530h(charSequenceM213e, false);
        } else {
            int i2 = CheckedSetting.f19010j;
            radio.m8530h(null, false);
        }
        radio.m8527e(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerNotifications.configureRadio.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StoreStream.INSTANCE.getUserGuildSettings().setGuildFrequency(C1643a.m885x(view, "view", "view.context"), model.getGuild(), type);
            }
        });
    }
    ...
    private final void configureUI(final Model model) throws Exception {
        ...
        C12238m.checkNotNullExpressionValue(view2, "binding.serverNotificationsHighlightsDivider");
        ...
        getBinding().f17492d.setOnCheckedListener(new Action1<Boolean>() { // from class: com.discord.widgets.servers.WidgetServerNotifications.configureUI.2
            @Override // p658rx.functions.Action1
            public final void call(Boolean bool) {
                StoreUserGuildSettings userGuildSettings = StoreStream.INSTANCE.getUserGuildSettings();
                CheckedSetting checkedSetting = WidgetServerNotifications.this.getBinding().f17492d;
                C12238m.checkNotNullExpressionValue(checkedSetting, "binding.serverNotificationsEveryoneSwitch");
                Context context = checkedSetting.getContext();
                C12238m.checkNotNullExpressionValue(context, "binding.serverNotificationsEveryoneSwitch.context");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting3, "binding.serverNotificationsEveryoneSwitch");
        checkedSetting2.setText(C1107b.m212d(checkedSetting3, C5419R.string.form_label_suppress_everyone, new Object[0], (4 & 4) != 0 ? C1107b.c.f1492j : null));
        getBinding().f17505q.setOnCheckedListener(new Action1<Boolean>() { // from class: com.discord.widgets.servers.WidgetServerNotifications.configureUI.3
            @Override // p658rx.functions.Action1
            public final void call(Boolean bool) {
                StoreUserGuildSettings userGuildSettings = StoreStream.INSTANCE.getUserGuildSettings();
                CheckedSetting checkedSetting4 = WidgetServerNotifications.this.getBinding().f17505q;
                C12238m.checkNotNullExpressionValue(checkedSetting4, "binding.serverNotificationsRolesSwitch");
                Context context = checkedSetting4.getContext();
                C12238m.checkNotNullExpressionValue(context, "binding.serverNotificationsRolesSwitch.context");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting6, "binding.serverNotificationsRolesSwitch");
        checkedSetting5.setText(C1107b.m212d(checkedSetting6, C5419R.string.form_label_suppress_roles, new Object[0], (4 & 4) != 0 ? C1107b.c.f1492j : null));
        CheckedSetting checkedSetting7 = getBinding().f17503o;
        C12238m.checkNotNullExpressionValue(checkedSetting7, "binding.serverNotificationsPushSwitch");
        ...
        if (model.getGuildSettings().isMuted()) {
            ...
            getBinding().f17503o.m8527e(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerNotifications.configureUI.4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view3) {
                    WidgetServerNotifications.this.getBinding().f17503o.toggle();
                    StoreUserGuildSettings userGuildSettings = StoreStream.INSTANCE.getUserGuildSettings();
                    CheckedSetting checkedSetting8 = WidgetServerNotifications.this.getBinding().f17503o;
                    C12238m.checkNotNullExpressionValue(checkedSetting8, "binding.serverNotificationsPushSwitch");
                    Context context = checkedSetting8.getContext();
                    C12238m.checkNotNullExpressionValue(context, "binding.serverNotificationsPushSwitch.context");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting9, "binding.serverNotificationsFrequency1Radio");
        checkedSetting8.setText(C1107b.m212d(checkedSetting9, C5419R.string.form_label_only_mentions, new Object[0], (4 & 4) != 0 ? C1107b.c.f1492j : null));
        CheckedSetting checkedSetting10 = getBinding().f17493e;
        C12238m.checkNotNullExpressionValue(checkedSetting10, "binding.serverNotificationsFrequency0Radio");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting11, "binding.serverNotificationsFrequency1Radio");
        ...
        C12238m.checkNotNullExpressionValue(checkedSetting12, "binding.serverNotificationsFrequency2Radio");
    ...
    private final ItemTouchHelper createSwipeableItemTouchHelper() {
        final SwipeableItemTouchHelper.SwipeRevealConfiguration swipeRevealConfiguration = new SwipeableItemTouchHelper.SwipeRevealConfiguration(ColorCompat.getColor(this, C5419R.color.status_red_500), ContextCompat.getDrawable(requireContext(), C5419R.drawable.ic_delete_white_24dp), DimenUtils.dpToPixels(8));
        return new ItemTouchHelper(new SwipeableItemTouchHelper(swipeRevealConfiguration, swipeRevealConfiguration) { // from class: com.discord.widgets.servers.WidgetServerNotifications.createSwipeableItemTouchHelper.1
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                NotificationsOverridesAdapter.Item item = (NotificationsOverridesAdapter.Item) C12163u.getOrNull(WidgetServerNotifications.access$getOverrideAdapter$p(WidgetServerNotifications.this).getData(), viewHolder.getAdapterPosition());
                if (item != null) {
    ...
    public void onViewBound(View view) {
        ...
        this.notificationSettingsRadioManager = new RadioManager(C12147n.listOf((Object[]) new CheckedSetting[]{getBinding().f17493e, getBinding().f17494f, getBinding().f17495g}));
        ...
        C12238m.checkNotNullExpressionValue(recyclerView2, "binding.guildNotificationsOverrideList");
        ...
        C1095z1 c1095z1 = getBinding().f17490b;
        C12238m.checkNotNullExpressionValue(c1095z1, "binding.addOverride");
        c1095z1.f1434a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.servers.WidgetServerNotifications.onViewBound.2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                WidgetServerNotificationsOverrideSelector.INSTANCE.launch(C1643a.m885x(view2, "it", "it.context"), longExtra);
            }
        });
    }
    ...
    public void onViewBoundOrOnResume() {
        ...
        ObservableExtensionsKt.appSubscribe(ObservableExtensionsKt.ui$default(Model.INSTANCE.get(longExtra), this, null, 2, null), (Class<?>) WidgetServerNotifications.class, (58 & 2) != 0 ? null : null, (Function1<? super Subscription, Unit>) ((58 & 4) != 0 ? null : null), (Function1<? super Error, Unit>) ((58 & 8) != 0 ? null : null), (Function0<Unit>) ((58 & 16) != 0 ? ObservableExtensionsKt.C68791.INSTANCE : null), (Function0<Unit>) ((58 & 32) != 0 ? ObservableExtensionsKt.C68802.INSTANCE : null), new C91651());
        Observable notificationOverrides = INSTANCE.getNotificationOverrides(longExtra);
        C12238m.checkNotNullExpressionValue(notificationOverrides, "getNotificationOverrides(guildId)");
        ObservableExtensionsKt.appSubscribe(ObservableExtensionsKt.ui$default(ObservableExtensionsKt.computationBuffered(notificationOverrides), this, null, 2, null), (Class<?>) WidgetServerNotifications.class, (58 & 2) != 0 ? null : null, (Function1<? super Subscription, Unit>) ((58 & 4) != 0 ? null : null), (Function1<? super Error, Unit>) ((58 & 8) != 0 ? null : null), (Function0<Unit>) ((58 & 16) != 0 ? ObservableExtensionsKt.C68791.INSTANCE : null), (Function0<Unit>) ((58 & 32) != 0 ? ObservableExtensionsKt.C68802.INSTANCE : null), new C91662());
    }
}
