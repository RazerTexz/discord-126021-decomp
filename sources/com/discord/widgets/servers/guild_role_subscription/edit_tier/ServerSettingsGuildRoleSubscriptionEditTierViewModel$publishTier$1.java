...
public final class ServerSettingsGuildRoleSubscriptionEditTierViewModel$publishTier$1 extends o implements Function1<GuildRoleSubscriptionTierListing, Unit> {
    ...
    public ServerSettingsGuildRoleSubscriptionEditTierViewModel$publishTier$1(ServerSettingsGuildRoleSubscriptionEditTierViewModel serverSettingsGuildRoleSubscriptionEditTierViewModel, ServerSettingsGuildRoleSubscriptionEditTierViewModel$ViewState$Loaded serverSettingsGuildRoleSubscriptionEditTierViewModel$ViewState$Loaded) {
        super(1);
