...
public final class WidgetFriendsList$onViewBound$4 extends o implements Function1<User, Unit> {
    public final /* synthetic */ WidgetFriendsList this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetFriendsList$onViewBound$4(WidgetFriendsList widgetFriendsList) {
        super(1);
    ...
    public final void invoke2(User user) {
        ...
        ChannelSelector.Companion.getInstance().findAndSetDirectMessage(this.this$0.requireContext(), user.getId());
