...
public final class WidgetFriendsAddById$captchaLauncher$1 extends AbstractC12240o implements Function1<CaptchaHelper.CaptchaPayload, Unit> {
    ...
    public final void invoke2(CaptchaHelper.CaptchaPayload captchaPayload) {
        ...
        this.this$0.extractTargetAndSendFriendRequest(captchaPayload);
    }
}
