...
public final class WidgetFriendsListAdapter$ItemPendingUser$onConfigure$1 implements View$OnClickListener {
    ...
    public WidgetFriendsListAdapter$ItemPendingUser$onConfigure$1(WidgetFriendsListAdapter$ItemPendingUser widgetFriendsListAdapter$ItemPendingUser, FriendsListViewModel$Item friendsListViewModel$Item) {
