...
public final class WidgetFriendsListAdapter$ItemSuggestedFriend$onConfigure$2 extends o implements Function0<Unit> {
    ...
    public WidgetFriendsListAdapter$ItemSuggestedFriend$onConfigure$2(WidgetFriendsListAdapter$ItemSuggestedFriend widgetFriendsListAdapter$ItemSuggestedFriend, FriendsListViewModel$Item friendsListViewModel$Item) {
        super(0);
