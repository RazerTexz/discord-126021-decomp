...
public final class RoleIconView extends FrameLayout {
    ...
    /* JADX INFO: compiled from: RoleIconView.kt */
    public static final class C91251 extends AbstractC12240o implements Function3<Boolean, Integer, Context, String> {
    ...
    public RoleIconView(Context context, AttributeSet attributeSet) {
        ...
        C12238m.checkNotNullExpressionValue(roleIconViewBinding, "RoleIconViewBinding.infl…ater.from(context), this)");
    ...
    private final boolean hasUnicodeEmoji(GuildRole guildRole) {
        if (guildRole.getUnicodeEmoji() != null) {
            ...
            C12238m.checkNotNull(unicodeEmoji);
    ...
    private final void setIcon(GuildRole guildRole) {
        if (hasIcon(guildRole)) {
            ...
            C12238m.checkNotNullExpressionValue(simpleDraweeView, "binding.roleIconIv");
            ...
            C12238m.checkNotNullExpressionValue(simpleDraweeView2, "binding.roleIconIv");
    ...
    private final void showRoleIconToast(final Context context, GuildRole role) {
        ...
        if (hasIcon(role)) {
            emojiNodeFrom = new EmojiNode(role.getName(), new C91251(role), new EmojiNode.EmojiIdAndType.Unicode(""), DimenUtils.dpToPixels(24), DimenUtils.dpToPixels(24));
        } else {
