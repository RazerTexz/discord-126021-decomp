...
public final class WidgetBugReport$validationManager$2 extends AbstractC12240o implements Function0<ValidationManager> {
    ...
    public final ValidationManager invoke() {
        TextInputLayout textInputLayout = this.this$0.getBinding().f15739h;
        ...
        TextInputLayout textInputLayout2 = this.this$0.getBinding().f15741j;
        C12238m.checkNotNullExpressionValue(textInputLayout2, "binding.bugReportPriority");
