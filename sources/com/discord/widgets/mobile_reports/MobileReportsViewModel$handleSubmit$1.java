...
public final class MobileReportsViewModel$handleSubmit$1 extends o implements Function1<Unit, Unit> {
    ...
    public MobileReportsViewModel$handleSubmit$1(MobileReportsViewModel mobileReportsViewModel, MobileReportsViewModel$ViewState$Menu mobileReportsViewModel$ViewState$Menu) {
        super(1);
    ...
    public final void invoke2(Unit unit) {
        ...
        this.this$0.handleNext(new ReportNodeChild("", this.$currentViewState.getMenu().getSuccess_node_id()), null);
    }
}
