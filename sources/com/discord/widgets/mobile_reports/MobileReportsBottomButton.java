...
public final class MobileReportsBottomButton extends LinearLayout {
    ...
    public final void setup(final ReportNodeBottomButton bottomButton, MobileReportsViewModel.SubmitState submitState, final Function1<? super ReportNodeBottomButton, Unit> handleButtonPress) {
        ...
        C12238m.checkNotNullExpressionValue(linkifiedTextView, "binding.reportNodeBottomButtonDescription");
        ...
        C12238m.checkNotNullExpressionValue(materialButton, "binding.reportNodeBottomButtonCancel");
        ...
        C12238m.checkNotNullExpressionValue(loadingButton, "binding.reportNodeBottomButton");
        MaterialButton materialButton2 = this.binding.f15514c;
        C12238m.checkNotNullExpressionValue(materialButton2, "binding.reportNodeBottomButtonCancel");
        ...
        C12238m.checkNotNullExpressionValue(textView, "binding.reportNodeBottomButtonErrorText");
        ...
        C12238m.checkNotNullExpressionValue(loadingButton2, "binding.reportNodeBottomButton");
        ...
        if (bottomButton instanceof ReportNodeBottomButton.Done) {
            ...
            this.binding.f15513b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.mobile_reports.MobileReportsBottomButton.setup.2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Function1 function1 = handleButtonPress;
                    if (function1 != null) {
            ...
            this.binding.f15513b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.mobile_reports.MobileReportsBottomButton.setup.3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Function1 function1 = handleButtonPress;
                    if (function1 != null) {
            ...
            this.binding.f15514c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.mobile_reports.MobileReportsBottomButton.setup.4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    Function1 function1 = handleButtonPress;
                    if (function1 != null) {
            ...
            if (materialButton != null) {
                ...
                if (linkifiedTextView != null) {
                    ...
                    if (textView != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(viewMobileReportsBottomButtonBinding, "ViewMobileReportsBottomB…ater.from(context), this)");
