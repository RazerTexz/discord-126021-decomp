...
public final class GuildScheduledEventSettingsViewModel$setDescription$1 extends o implements Function1<GuildScheduledEventModel, GuildScheduledEventModel> {
    public final /* synthetic */ String $description;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildScheduledEventSettingsViewModel$setDescription$1(String str) {
        super(1);
