...
public final class WidgetGuildRoleSubscriptionTierBenefits$itemClickListener$1$onTrialIntervalClick$2 extends Lambda implements Function1<Integer, Unit> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function1<GuildRoleSubscriptionTierBenefitsViewModel.ViewState, Unit> {
        ...
        public final void invoke2(GuildRoleSubscriptionTierBenefitsViewModel.ViewState viewState) {
            ...
            WidgetGuildRoleSubscriptionTierBenefits$itemClickListener$1$onTrialIntervalClick$2.this.this$0.this$0.getViewModel().updateFreeTrialInterval(viewState.getTrialIntervalOptions().get(this.$index));
        }
    }
