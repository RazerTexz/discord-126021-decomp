...
public final class WidgetGuildRoleSubscriptionTierBenefits$itemClickListener$1$onTrialIntervalClick$2 extends o implements Function1<Integer, Unit> {
    ...
    public final void invoke(int i) {
        WidgetGuildRoleSubscriptionTierBenefits.access$getBenefitsViewModel$p(this.this$0.this$0).withViewState(new WidgetGuildRoleSubscriptionTierBenefits$itemClickListener$1$onTrialIntervalClick$2$1(this, i));
    }
}
