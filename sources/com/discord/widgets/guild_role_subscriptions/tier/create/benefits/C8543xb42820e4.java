...
public final class C8543xb42820e4 extends AbstractC12240o implements Function1<GuildRoleSubscriptionTierBenefitsViewModel.ViewState, List<? extends RadioSelectorItem>> {
    ...
    public final List<RadioSelectorItem> invoke(GuildRoleSubscriptionTierBenefitsViewModel.ViewState viewState) {
        ...
        ArrayList arrayList = new ArrayList(C12149o.collectionSizeOrDefault(activeTrialUserLimitOptions, 10));
        int i = 0;
        for (Object obj : activeTrialUserLimitOptions) {
            ...
            arrayList.add((RadioSelectorItem) this.this$0.this$0.getViewModel().withViewState(new C8544x62fd44f5(i, (Integer) obj, this)));
            i = i2;
        }
        return arrayList;
    }
