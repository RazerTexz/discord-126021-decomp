...
public final class GuildRoleSubscriptionUtilsKt {
    ...
    public static final CharSequence getFormattedLabel(SubscriptionTrialInterval subscriptionTrialInterval, Context context) {
        C12238m.checkNotNullParameter(subscriptionTrialInterval, "$this$getFormattedLabel");
        C12238m.checkNotNullParameter(context, "context");
        int iOrdinal = subscriptionTrialInterval.getInterval().ordinal();
        if (iOrdinal == 0) {
            return StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.duration_months_capitalize_months, subscriptionTrialInterval.getIntervalCount(), Integer.valueOf(subscriptionTrialInterval.getIntervalCount()));
        }
        if (iOrdinal == 1) {
            return StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.duration_years_capitalize_years, subscriptionTrialInterval.getIntervalCount(), Integer.valueOf(subscriptionTrialInterval.getIntervalCount()));
        }
        if (iOrdinal != 2) {
            throw new NoWhenBranchMatchedException();
        }
        if (subscriptionTrialInterval.getIntervalCount() <= 0 || subscriptionTrialInterval.getIntervalCount() % 7 != 0) {
            return StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.duration_days_capitalize_days, subscriptionTrialInterval.getIntervalCount(), Integer.valueOf(subscriptionTrialInterval.getIntervalCount()));
        }
        int intervalCount = subscriptionTrialInterval.getIntervalCount() / 7;
        return StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.duration_weeks_capitalize_weeks, intervalCount, Integer.valueOf(intervalCount));
    }
    ...
    public static final Boolean getFullServerGatingOverwrite(GuildRoleSubscriptionGroupListing guildRoleSubscriptionGroupListing, Map<Long, GuildRole> map) {
        Boolean boolValueOf;
        C12238m.checkNotNullParameter(guildRoleSubscriptionGroupListing, "$this$getFullServerGatingOverwrite");
    ...
    public static final int getPrice(GuildRoleSubscriptionTierListing guildRoleSubscriptionTierListing) {
        C12238m.checkNotNullParameter(guildRoleSubscriptionTierListing, "$this$getPrice");
        SubscriptionPlan subscriptionPlan = (SubscriptionPlan) C12163u.getOrNull(guildRoleSubscriptionTierListing.m7961i(), 0);
    ...
    public static final PayoutStatusMedia getStatusMedia(PayoutStatus payoutStatus) {
        C12238m.checkNotNullParameter(payoutStatus, "$this$getStatusMedia");
        switch (payoutStatus) {
            case UNKNOWN:
            case ERROR:
    ...
    public static final boolean hasUserActiveSubscriptionFor(GuildRoleSubscriptionGroupListing guildRoleSubscriptionGroupListing, List<ModelSubscription> list) {
        C12238m.checkNotNullParameter(guildRoleSubscriptionGroupListing, "$this$hasUserActiveSubscriptionFor");
        C12238m.checkNotNullParameter(list, "userSubscriptions");
        ...
        while (true) {
            ...
            ModelSubscription.SubscriptionItem subscriptionItem = (ModelSubscription.SubscriptionItem) C12163u.getOrNull(((ModelSubscription) it.next()).getItems(), 0);
        ...
        if (listM7948h != null) {
            ...
            while (it2.hasNext()) {
                SubscriptionPlan subscriptionPlan = (SubscriptionPlan) C12163u.getOrNull(((GuildRoleSubscriptionTierListing) it2.next()).m7961i(), 0);
