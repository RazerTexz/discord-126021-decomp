...
public final class PaymentSourceAdapter extends MGRecyclerAdapterSimple<Item> {
    ...
    public static final class PaymentSourceAddViewHolder extends MGRecyclerViewHolder<PaymentSourceAdapter, Item> {
        ...
        public PaymentSourceAddViewHolder(PaymentSourceAdapter paymentSourceAdapter) {
            ...
            C12238m.checkNotNullParameter(paymentSourceAdapter, "adapter");
        }
    ...
    public static final /* data */ class PaymentSourceHeader implements Item {
        ...
        public boolean equals(Object other) {
            if (this != other) {
                return (other instanceof PaymentSourceHeader) && C12238m.areEqual(this.headerType, ((PaymentSourceHeader) other).headerType);
            }
            return true;
        }
        ...
        public String toString() {
            StringBuilder sbM833U = C1643a.m833U("PaymentSourceHeader(headerType=");
    ...
    public static final /* data */ class PaymentSourceItem implements Item {
        ...
        public boolean equals(Object other) {
            ...
            return C12238m.areEqual(this.paymentSource, paymentSourceItem.paymentSource) && this.isPremium == paymentSourceItem.isPremium;
        }
        ...
        public String toString() {
            StringBuilder sbM833U = C1643a.m833U("PaymentSourceItem(paymentSource=");
            sbM833U.append(this.paymentSource);
            sbM833U.append(", isPremium=");
            return C1643a.m827O(sbM833U, this.isPremium, ")");
        }
    }
    ...
    public static final class PaymentSourceItemViewHolder extends MGRecyclerViewHolder<PaymentSourceAdapter, Item> {
        ...
        public PaymentSourceItemViewHolder(PaymentSourceAdapter paymentSourceAdapter) {
            ...
            if (materialButton != null) {
                ...
                if (paymentSourceView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(paymentMethodListItemBinding, "PaymentMethodListItemBinding.bind(itemView)");
        ...
        public void onConfigure(int position, Item data) {
            ...
            this.binding.f15205b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.settings.billing.PaymentSourceAdapter$PaymentSourceItemViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public PaymentSourceAdapter(RecyclerView recyclerView, Function0<Unit> function0, Function1<? super ModelPaymentSource, Unit> function1) {
        ...
        C12238m.checkNotNullParameter(function0, "onAddClick");
        C12238m.checkNotNullParameter(function1, "onEditPaymentSource");
    ...
    public MGRecyclerViewHolder<?, Item> onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        throw new IllegalArgumentException(C1643a.m871q("unknown type ", viewType));
    }
}
