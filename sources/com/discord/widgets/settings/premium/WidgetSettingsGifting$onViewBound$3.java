...
public final /* synthetic */ class WidgetSettingsGifting$onViewBound$3 extends k implements Function1<SettingsGiftingViewModel$OutboundPromoItem, Unit> {
    public WidgetSettingsGifting$onViewBound$3(SettingsGiftingViewModel settingsGiftingViewModel) {
    ...
    public final void invoke2(SettingsGiftingViewModel$OutboundPromoItem settingsGiftingViewModel$OutboundPromoItem) {
        ...
        ((SettingsGiftingViewModel) this.receiver).handlePromoMoreDetailsClicked(settingsGiftingViewModel$OutboundPromoItem);
    }
}
