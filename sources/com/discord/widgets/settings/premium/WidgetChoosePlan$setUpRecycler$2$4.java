...
public final class WidgetChoosePlan$setUpRecycler$2$4 extends o implements Function0<Unit> {
    ...
    public WidgetChoosePlan$setUpRecycler$2$4(WidgetChoosePlan$setUpRecycler$2 widgetChoosePlan$setUpRecycler$2, GooglePlaySku googlePlaySku, String str) {
        super(0);
    ...
    public final void invoke2() throws NoSuchAlgorithmException {
        Traits$Location traits$Location = new Traits$Location("Yearly Upsell Modal", "Yearly Upsell Modal", null, null, null, 28, null);
        ...
        WidgetChoosePlan.access$getViewModel$p(this.this$0.this$0).buy(this.$sku.getUpgrade(), this.$oldSkuName, traits$Location, "yearly_upsell");
    }
}
