...
public final class SettingsPremiumViewModel$Companion$observeStores$2<T, R> implements b<StoreSubscriptions$SubscriptionsState, Observable<? extends SettingsPremiumViewModel$SubscriptionAndInvoice>> {
    ...
    public final Observable<? extends SettingsPremiumViewModel$SubscriptionAndInvoice> call2(StoreSubscriptions$SubscriptionsState storeSubscriptions$SubscriptionsState) {
        ...
        return SettingsPremiumViewModel$Companion.access$getSubscriptionsAndInvoicePreview(settingsPremiumViewModel$Companion, restAPI, storeSubscriptions$SubscriptionsState, false);
    }
}
