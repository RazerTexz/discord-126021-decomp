...
public final class WidgetSettingsAccountContactsNameEdit$submitName$1 extends o implements Function1<ConnectedAccount, TrackNetworkMetadataReceiver> {
    public final /* synthetic */ String $name;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetSettingsAccountContactsNameEdit$submitName$1(String str) {
        super(1);
        this.$name = str;
    }
