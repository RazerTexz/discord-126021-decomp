...
public final class WidgetSettingsGuildBoostSubscriptionAdapter$GuildBoostListItem$showGuildBoostPopup$2 implements MenuItem$OnMenuItemClickListener {
    ...
    public WidgetSettingsGuildBoostSubscriptionAdapter$GuildBoostListItem$showGuildBoostPopup$2(WidgetSettingsGuildBoostSubscriptionAdapter$GuildBoostListItem widgetSettingsGuildBoostSubscriptionAdapter$GuildBoostListItem, WidgetSettingsGuildBoostSubscriptionAdapter$Item$GuildBoostItem widgetSettingsGuildBoostSubscriptionAdapter$Item$GuildBoostItem) {
