...
public final class WidgetSettingsPrivacy$configureContactSyncOptions$4 implements View$OnClickListener {
    public final /* synthetic */ WidgetSettingsPrivacy this$0;

    public WidgetSettingsPrivacy$configureContactSyncOptions$4(WidgetSettingsPrivacy widgetSettingsPrivacy) {
        this.this$0 = widgetSettingsPrivacy;
    }

    @Override // android.view.View$OnClickListener
    public final void onClick(View view) {
        CheckedSetting checkedSetting = WidgetSettingsPrivacy.access$getBinding$p(this.this$0).f2635b;
        ...
        CheckedSetting checkedSetting4 = WidgetSettingsPrivacy.access$getBinding$p(this.this$0).e;
        ...
        WidgetSettingsPrivacy.access$updateFriendDiscoveryFlags(this.this$0, zIsChecked, z2);
    }
}
