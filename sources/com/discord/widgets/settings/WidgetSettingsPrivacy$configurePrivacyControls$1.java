...
public final class WidgetSettingsPrivacy$configurePrivacyControls$1<T> implements Action1<Boolean> {
    ...
    public final void call2(Boolean bool) {
        CheckedSetting checkedSetting = WidgetSettingsPrivacy.access$getBinding$p(this.this$0).f2639z;
        ...
        if (!bool.booleanValue()) {
            WidgetSettingsPrivacy.access$confirmConsent(this.this$0, this.$context, new WidgetSettingsPrivacy$configurePrivacyControls$1$1(this, bool));
            return;
        }
        WidgetSettingsPrivacy widgetSettingsPrivacy = this.this$0;
        boolean zBooleanValue = bool.booleanValue();
        CheckedSetting checkedSetting2 = WidgetSettingsPrivacy.access$getBinding$p(this.this$0).f2639z;
