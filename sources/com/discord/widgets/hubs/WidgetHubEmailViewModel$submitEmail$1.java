...
public final class WidgetHubEmailViewModel$submitEmail$1 extends o implements Function1<EmailVerification, TrackNetworkMetadataReceiver> {
    public static final WidgetHubEmailViewModel$submitEmail$1 INSTANCE = new WidgetHubEmailViewModel$submitEmail$1();

    public WidgetHubEmailViewModel$submitEmail$1() {
        super(1);
    }
