...
public final class WidgetSearchSuggestionsAdapter extends MGRecyclerAdapterSimple<MGRecyclerDataPayload> {
    ...
    public static final class FilterViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public FilterViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            C12238m.checkNotNullParameter(widgetSearchSuggestionsAdapter, "searchSuggestionsAdapter");
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (imageView != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(widgetSearchSuggestionsItemSuggestionBinding, "WidgetSearchSuggestionsI…ionBinding.bind(itemView)");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            ...
            this.binding.f17444c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$FilterViewHolder$onConfigure$1
            ...
            C12238m.checkNotNullExpressionValue(imageView, "binding.suggestionExampleIcon");
            Context context = imageView.getContext();
            C12238m.checkNotNullExpressionValue(context, "binding.suggestionExampleIcon.context");
    ...
    public static final class HasViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public HasViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetSearchSuggestionsItemHasBinding, "WidgetSearchSuggestionsI…HasBinding.bind(itemView)");
                    this.binding = widgetSearchSuggestionsItemHasBinding;
                    C12238m.checkNotNullExpressionValue(relativeLayout, "binding.searchSuggestionItemHasContainer");
                    Context context = relativeLayout.getContext();
                    C12238m.checkNotNullExpressionValue(context, "binding.searchSuggestionItemHasContainer.context");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.searchSuggestionsItemHasText");
            textView.setText(hasSuggestion.getHasAnswerOption().getLocalizedInputText(this.searchStringProvider));
            this.binding.f17437c.setImageResource(INSTANCE.getIconRes(hasSuggestion.getHasAnswerOption()));
            this.binding.f17436b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$HasViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static final class HeaderViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public HeaderViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            C12238m.checkNotNullExpressionValue(widgetSearchSuggestionItemHeaderBinding, "WidgetSearchSuggestionIt…derBinding.bind(itemView)");
    ...
    public static final class HistoryHeaderViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
            ...
            if (imageView != null) {
                ...
                if (viewFindViewById != null) {
                    ...
                    if (textView != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(widgetSearchSuggestionItemHeaderHistoryBinding, "WidgetSearchSuggestionIt…oryBinding.bind(itemView)");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            C12238m.checkNotNullParameter(data, "data");
            super.onConfigure(position, data);
            this.binding.f17429b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$HistoryHeaderViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static final class InChannelViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public InChannelViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetSearchSuggestionsItemChannelBinding, "WidgetSearchSuggestionsI…nelBinding.bind(itemView)");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.searchSuggestionsItemChannelText");
            textView.setText(channelSuggestion.getChannelName());
            this.binding.f17433b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$InChannelViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static final class RecentQueryViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public RecentQueryViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            C12238m.checkNotNullParameter(widgetSearchSuggestionsAdapter, "widgetSearchSuggestionsAdapter");
            View view = this.itemView;
            RelativeLayout relativeLayout = (RelativeLayout) view;
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetSearchSuggestionsItemRecentQueryBinding, "WidgetSearchSuggestionsI…eryBinding.bind(itemView)");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.searchSuggestionsItemRecentQueryText");
            View view = this.itemView;
            ...
            this.binding.f17440b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$RecentQueryViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
    ...
    public static final class UserViewHolder extends MGRecyclerViewHolder<WidgetSearchSuggestionsAdapter, MGRecyclerDataPayload> {
        ...
        public UserViewHolder(WidgetSearchSuggestionsAdapter widgetSearchSuggestionsAdapter) {
            ...
            C12238m.checkNotNullExpressionValue(widgetSearchSuggestionsItemUserBinding, "WidgetSearchSuggestionsI…serBinding.bind(itemView)");
        ...
        public void onConfigure(int position, MGRecyclerDataPayload data) {
            ...
            if (nick == null || nick.length() == 0) {
                ...
                C12238m.checkNotNullExpressionValue(textView, "binding.userListItemName");
                textView.setText(string);
                TextView textView2 = userListItemView.binding.f786d;
                C12238m.checkNotNullExpressionValue(textView2, "binding.userListItemNameSecondary");
                textView2.setText("");
            } else {
                TextView textView3 = userListItemView.binding.f785c;
                C12238m.checkNotNullExpressionValue(textView3, "binding.userListItemName");
                textView3.setText(nick);
                TextView textView4 = userListItemView.binding.f786d;
                C12238m.checkNotNullExpressionValue(textView4, "binding.userListItemNameSecondary");
                textView4.setText(string);
            }
            SimpleDraweeView simpleDraweeView = userListItemView.binding.f784b;
            C12238m.checkNotNullExpressionValue(simpleDraweeView, "binding.userListItemAvatar");
            ...
            C12238m.checkNotNullExpressionValue(statusView, "binding.userListItemStatus");
            statusView.setVisibility(userUtils.isStatusVisible(user, (Presence) null, false) ? 0 : 8);
            this.binding.f17448b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.search.suggestions.WidgetSearchSuggestionsAdapter$UserViewHolder$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
