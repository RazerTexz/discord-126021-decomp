...
public final /* synthetic */ class WidgetCallFullscreen$setUpStageRecycler$5 extends k implements Function2<VideoCallParticipantView$StreamResolution, VideoCallParticipantView$StreamFps, Unit> {
    public WidgetCallFullscreen$setUpStageRecycler$5(WidgetCallFullscreenViewModel widgetCallFullscreenViewModel) {
    ...
    public final void invoke2(VideoCallParticipantView$StreamResolution videoCallParticipantView$StreamResolution, VideoCallParticipantView$StreamFps videoCallParticipantView$StreamFps) {
        ...
        ((WidgetCallFullscreenViewModel) this.receiver).onStreamQualityIndicatorClicked(videoCallParticipantView$StreamResolution, videoCallParticipantView$StreamFps);
    }
}
