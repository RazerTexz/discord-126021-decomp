...
public final /* synthetic */ class WidgetVoiceBottomSheet$binding$2 extends C12236k implements Function1<View, WidgetVoiceBottomSheetBinding> {
    ...
    public final WidgetVoiceBottomSheetBinding invoke(View view) {
        C12238m.checkNotNullParameter(view, "p1");
        int i = C5419R.id.empty;
        View viewFindViewById = view.findViewById(C5419R.id.empty);
        if (viewFindViewById != null) {
            C1052t0 c1052t0 = new C1052t0((LinearLayout) viewFindViewById);
            i = C5419R.id.header;
                                ...
                                if (imageView4 != null) {
                                    ...
                                    if (imageView5 != null) {
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (textView2 != null) {
                                                C1059u0 c1059u0 = new C1059u0((ConstraintLayout) viewFindViewById2, barrier, imageView, imageView2, imageView3, imageView4, imageView5, textView, textView2);
                                                            ...
                                                            if (anchoredVoiceControlsView != null) {
                                                                ...
                                                                if (materialButton2 != null) {
                                                                    ...
                                                                    if (recyclerView != null) {
                                                                        ...
                                                                        return new WidgetVoiceBottomSheetBinding(coordinatorLayout, c1052t0, c1059u0, constraintLayout, materialButton, relativeLayout, anchoredVoiceControlsView, materialButton2, recyclerView, coordinatorLayout);
                                                                    }
