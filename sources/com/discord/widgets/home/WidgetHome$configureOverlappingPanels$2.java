...
public final class WidgetHome$configureOverlappingPanels$2 implements OverlappingPanelsLayout$PanelStateListener {
    public final /* synthetic */ WidgetHome this$0;

    public WidgetHome$configureOverlappingPanels$2(WidgetHome widgetHome) {
    ...
    public void onPanelStateChange(PanelState panelState) {
        ...
        WidgetHome.access$getViewModel$p(this.this$0).onEndPanelStateChange(panelState);
    }
}
