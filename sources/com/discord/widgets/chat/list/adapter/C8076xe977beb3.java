...
/* JADX INFO: renamed from: com.discord.widgets.chat.list.adapter.WidgetChatListAdapterItemGuildScheduledEventInvite$Model$Companion$observe$1 */
/* JADX INFO: compiled from: WidgetChatListAdapterItemGuildScheduledEventInvite.kt */
/* JADX INFO: loaded from: classes2.dex */
public final class C8076xe977beb3 extends AbstractC12240o implements Function0<WidgetChatListAdapterItemGuildScheduledEventInvite.Model> {
    ...
    public C8076xe977beb3(GuildScheduledEventInviteEntry guildScheduledEventInviteEntry, StoreGuilds storeGuilds, StoreUser storeUser, StoreGuildScheduledEvents storeGuildScheduledEvents, StoreChannels storeChannels, StoreVoiceChannelSelected storeVoiceChannelSelected, StorePermissions storePermissions) {
        super(0);
    ...
    public final WidgetChatListAdapterItemGuildScheduledEventInvite.Model invoke() {
        ...
        if (channel2 != null) {
            ...
            channelM7629a = Channel.m7629a(channel2, null, 0, guild2 != null ? guild2.getId() : 0L, null, 0L, 0L, 0L, null, null, 0, null, 0, 0, null, 0L, 0L, null, false, 0L, null, 0, null, null, null, null, null, null, null, null, null, null, null, -5);
        } else {
            channelM7629a = null;
        }
        ...
        if (channelM7629a != null) {
            channel = this.$channelStore.getChannel(channelM7629a.getId());
        } else {
            channel = null;
        }
        ...
        if (guild3 != null) {
            ...
            if (guild4 != null) {
                C12238m.checkNotNullExpressionValue(guild4, "apiGuild");
                guild = new Guild(guild4);
            }
        }
        Long lValueOf = Long.valueOf(this.$voiceChannelSelectedStore.getSelectedVoiceChannelId());
        if (channelM7629a != null) {
            zCan = PermissionUtils.can(Permission.CONNECT, this.$permissionStore.getPermissionsByChannel().get(Long.valueOf(channelM7629a.getId())));
        } else {
            zCan = false;
        }
