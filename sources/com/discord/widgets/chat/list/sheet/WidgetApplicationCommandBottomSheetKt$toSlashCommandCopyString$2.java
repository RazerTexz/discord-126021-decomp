...
public final class WidgetApplicationCommandBottomSheetKt$toSlashCommandCopyString$2 extends o implements Function1<ApplicationCommandValue, CharSequence> {
    public final /* synthetic */ Map $commandValues;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetApplicationCommandBottomSheetKt$toSlashCommandCopyString$2(Map map) {
        super(1);
