...
public final class WidgetChatListModelMessages$Companion$get$1 extends AbstractC12240o implements Function15<WidgetChatListModelMessages.MessagesWithMetadata, Channel, Map<Long, ? extends Integer>, List<? extends Long>, Map<Long, ? extends GuildMember>, Long, Map<Long, ? extends GuildRole>, Long, Boolean, Boolean, Boolean, Long, Map<Long, ? extends ComponentChatListState.ComponentStoreState>, InviteEmbedModel, Boolean, WidgetChatListModelMessages> {
    ...
    public final WidgetChatListModelMessages invoke(WidgetChatListModelMessages.MessagesWithMetadata messagesWithMetadata, Channel channel, Map<Long, Integer> map, List<Long> list, Map<Long, GuildMember> map2, Long l, Map<Long, GuildRole> map3, Long l2, boolean z2, boolean z3, boolean z4, long j, Map<Long, ComponentChatListState.ComponentStoreState> map4, InviteEmbedModel inviteEmbedModel, boolean z5) {
        ...
        C12238m.checkNotNullParameter(messagesWithMetadata2, "messagesWithMetadata");
        C12238m.checkNotNullParameter(map5, "blockedRelationships");
        C12238m.checkNotNullParameter(list, "blockedExpanded");
        C12238m.checkNotNullParameter(map3, "guildRoles");
        C12238m.checkNotNullParameter(map4, "componentStoreState");
        ...
        for (Object obj : messagesWithMetadata.getMessages()) {
            ...
            if (type != null && type.intValue() == 21) {
                User author2 = ((Message) companion2.getThreadStarterMessageAndChannel(channel, widgetChatListModelMessages$Companion$get$1.$channel, message5, messagesWithMetadata2).getFirst()).getAuthor();
            ...
            if (zTryAddNewMessagesSeparator) {
                ...
                C12238m.checkNotNullExpressionValue(l, "newMessagesMarkerMessageId");
                items2 = items;
                widgetChatListModelMessages$Companion$get$1 = this;
                zTryAddNewMessagesSeparator = companion.tryAddNewMessagesSeparator(items2, l.longValue(), z7, message2.getId(), widgetChatListModelMessages$Companion$get$1.$channel);
            }
        ...
        C12162t.reverse(items5.getItems());
        List<ChatListEntry> items6 = items5.getItems();
        Message message6 = (Message) C12163u.firstOrNull((List) messagesWithMetadata.getMessages());
        long id3 = message6 != null ? message6.getId() : 0L;
        Message message7 = (Message) C12163u.lastOrNull((List) messagesWithMetadata.getMessages());
