...
public final class ChatInputViewModel$sendCommand$validated$3 extends o implements Function2<Integer, Boolean, Unit> {
    ...
    public ChatInputViewModel$sendCommand$validated$3(ChatInputViewModel chatInputViewModel, ChatInputViewModel$AttachmentContext chatInputViewModel$AttachmentContext, Function0 function0) {
        super(2);
