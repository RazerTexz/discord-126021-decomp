...
public final class WidgetEndStageBottomSheet extends AppBottomSheet {
    ...
    /* JADX INFO: renamed from: com.discord.widgets.stage.sheet.WidgetEndStageBottomSheet$onConfirmEnd$1, reason: invalid class name */
    /* JADX INFO: compiled from: WidgetEndStageBottomSheet.kt */
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getBinding().f2382b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.stage.sheet.WidgetEndStageBottomSheet.onViewCreated.1
        ...
        getBinding().c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.stage.sheet.WidgetEndStageBottomSheet.onViewCreated.2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                WidgetEndStageBottomSheet.this.dismiss();
