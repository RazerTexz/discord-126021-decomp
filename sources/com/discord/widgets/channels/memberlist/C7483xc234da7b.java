...
/* JADX INFO: renamed from: com.discord.widgets.channels.memberlist.GuildMemberListItemGeneratorKt$generateGuildMemberListItems$listItems$1 */
/* JADX INFO: compiled from: GuildMemberListItemGenerator.kt */
/* JADX INFO: loaded from: classes2.dex */
public final class C7483xc234da7b extends AbstractC12240o implements Function1<MemberListRow, ChannelMembersListAdapter.Item> {
    ...
    public C7483xc234da7b(StoreGuilds storeGuilds, StoreEmojiCustom storeEmojiCustom, Guild guild, Channel channel, Map map) {
        super(1);
    ...
    public final ChannelMembersListAdapter.Item invoke(MemberListRow memberListRow) {
        ...
        C12238m.checkNotNullParameter(memberListRow, "row");
        if (memberListRow instanceof MemberListRow.StatusHeader) {
            ...
            if (memberListRow instanceof MemberListRow.Member) {
                ...
                boolean zCalculateCanDisplayStatusEmoji = GuildMemberListItemGeneratorKt.calculateCanDisplayStatusEmoji(this.$storeGuilds, this.$storeCustomEmojis, member.getUserId(), this.$guild, this.$channel, member.getPresence(), this.$guildRoles);
