...
public final class WidgetGroupInviteFriends$Model$Companion$getForCreate$2$2<T, R> implements b<List<? extends WidgetGroupInviteFriends$Model$FriendItem>, Observable<? extends WidgetGroupInviteFriends$Model>> {
    public final /* synthetic */ WidgetGroupInviteFriends$Model$Companion$AddedUsersInput $usersFilter;

    public WidgetGroupInviteFriends$Model$Companion$getForCreate$2$2(WidgetGroupInviteFriends$Model$Companion$AddedUsersInput widgetGroupInviteFriends$Model$Companion$AddedUsersInput) {
    ...
    public final Observable<? extends WidgetGroupInviteFriends$Model> call2(List<WidgetGroupInviteFriends$Model$FriendItem> list) {
        ...
        return new k(new WidgetGroupInviteFriends$Model(null, filter, addedUsers, list, 0, UserUtils.INSTANCE.isStaff(StoreStream.Companion.getUsers().getMeSnapshot()) ? 25 : 10));
    }
}
