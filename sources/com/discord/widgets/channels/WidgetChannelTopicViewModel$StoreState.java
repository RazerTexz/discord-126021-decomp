...
public abstract class WidgetChannelTopicViewModel$StoreState {
    private final boolean isOnHomeTab;
    private final boolean isRightPanelOpened;

    private WidgetChannelTopicViewModel$StoreState(boolean z2, boolean z3) {
    ...
    public /* synthetic */ WidgetChannelTopicViewModel$StoreState(boolean z2, boolean z3, DefaultConstructorMarker defaultConstructorMarker) {
        this(z2, z3);
    }
}
