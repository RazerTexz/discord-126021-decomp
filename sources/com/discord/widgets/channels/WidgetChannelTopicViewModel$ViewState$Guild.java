...
public abstract class WidgetChannelTopicViewModel$ViewState$Guild extends WidgetChannelTopicViewModel$ViewState {
    ...
    public /* synthetic */ WidgetChannelTopicViewModel$ViewState$Guild(GuildChannelIconType guildChannelIconType, boolean z2, boolean z3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private WidgetChannelTopicViewModel$ViewState$Guild(GuildChannelIconType guildChannelIconType, boolean z2, boolean z3) {
        super(z2, z3, null);
