...
public final class C7413x4d8eedc1 extends AbstractC12240o implements Function3<Channel, Boolean, Boolean, WidgetChannelListModel.Companion.TextLikeChannelData> {
    ...
    public static final class AnonymousClass1 extends AbstractC12240o implements Function0<Boolean> {
        ...
        public final boolean invoke2() {
            ...
            return C7413x4d8eedc1.this.$hiddenChannelsIds$inlined.contains(Long.valueOf(this.$textChannel.getParentId())) || (!z2 && !C7413x4d8eedc1.this.$isThreadUnread$3$inlined.invoke2(this.$textChannel) && (zContains || C12238m.areEqual(this.$isParentMuted, Boolean.TRUE)));
        }
    }
    ...
    public final WidgetChannelListModel.Companion.TextLikeChannelData invoke(Channel channel, boolean z2, Boolean bool) {
        boolean z3;
        Object next;
        C12238m.checkNotNullParameter(channel, "textChannel");
        long id2 = channel.getId();
        ...
        if (listM7655v != null) {
            ...
            do {
                ...
                next = it.next();
            } while (!(((PermissionOverwrite) next).m8131e() == this.$selectedGuildId$inlined));
