...
public final class WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$1 extends o implements Function1<View, Unit> {
    ...
    public WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$1(WidgetChannelsListAdapter$ItemChannelCategory widgetChannelsListAdapter$ItemChannelCategory, ChannelListItem channelListItem) {
        super(1);
