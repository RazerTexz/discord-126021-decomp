...
public final class WidgetChannelsListAdapter extends MGRecyclerAdapterSimple<ChannelListItem> {
    ...
    public static abstract class Item extends MGRecyclerViewHolder<WidgetChannelsListAdapter, ChannelListItem> {
        ...
        public Item(@LayoutRes int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            C12238m.checkNotNullParameter(widgetChannelsListAdapter, "adapter");
        }

        public final void setBackground(View view, boolean z2, Channel channel) {
            int themedDrawableRes$default;
            C12238m.checkNotNullParameter(view, "$this$setBackground");
    ...
    public static final class ItemChannelAddServer extends Item {
        ...
        public ItemChannelAddServer(int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            C12238m.checkNotNullExpressionValue(widgetChannelsListItemDirectoryBindingM8406a, "WidgetChannelsListItemDi…oryBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (data instanceof ChannelListItemAddServer) {
                ...
                this.binding.f16037a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelAddServer$onConfigure$$inlined$apply$lambda$1
    ...
    public static final class ItemChannelCategory extends Item {
            ...
            if (imageView != null) {
                ...
                if (imageView2 != null) {
                    ...
                    if (textView != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(widgetChannelsListItemCategoryBinding, "WidgetChannelsListItemCa…oryBinding.bind(itemView)");
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            this.binding.f16007a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsItemCategoryName");
            textView.setText(ChannelUtils.m7679c(channelListItemCategory.getChannel()));
            TextView textView2 = this.binding.f16010d;
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsItemCategoryName");
            TextView textView3 = this.binding.f16010d;
            C12238m.checkNotNullExpressionValue(textView3, "binding.channelsItemCategoryName");
            Object[] objArr = new Object[2];
            objArr[0] = ChannelUtils.m7679c(channelListItemCategory.getChannel());
            TextView textView4 = this.binding.f16010d;
            C12238m.checkNotNullExpressionValue(textView4, "binding.channelsItemCategoryName");
            objArr[1] = C1107b.m212d(textView4, channelListItemCategory.isCollapsed() ? C5419R.string.collapsed : C5419R.string.expanded, new Object[0], (4 & 4) != 0 ? C1107b.c.f1492j : null);
            textView2.setContentDescription(C1107b.m212d(textView3, C5419R.string.category_a11y_label_with_expanded_state, objArr, (4 & 4) != 0 ? C1107b.c.f1492j : null));
            Companion companion = INSTANCE;
            TextView textView5 = this.binding.f16010d;
            C12238m.checkNotNullExpressionValue(textView5, "binding.channelsItemCategoryName");
            Context context = textView5.getContext();
            C12238m.checkNotNullExpressionValue(context, "binding.channelsItemCategoryName.context");
            int channelColor = companion.getChannelColor(channelListItemCategory, context);
            this.binding.f16010d.setTextColor(channelColor);
            ViewCompat.setAccessibilityDelegate(this.binding.f16010d, new AccessibilityDelegateCompat() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$3
            ...
            this.binding.f16009c.setImageResource(companion.getArrowDrawable(channelListItemCategory));
            ImageView imageView = this.binding.f16009c;
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelsItemCategoryArrow");
            ...
            C12238m.checkNotNullExpressionValue(imageView2, "binding.channelsItemCategoryAdd");
            imageView2.setVisibility(channelListItemCategory.getCanManageChannels() ? 0 : 8);
            ImageView imageView3 = this.binding.f16008b;
            C12238m.checkNotNullExpressionValue(imageView3, "binding.channelsItemCategoryAdd");
            imageView3.setImageTintList(ColorStateList.valueOf(channelColor));
            this.binding.f16008b.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    WidgetCreateChannel.INSTANCE.show(C1643a.m885x(this.this$0.itemView, "itemView", "itemView.context"), channelListItemCategory.getChannel().getGuildId(), 0, Long.valueOf(channelListItemCategory.getChannel().getId()));
                }
            });
        }
    }
    ...
    public static final class ItemChannelDirectory extends Item {
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (zM7700x) {
                ...
                C12238m.checkNotNullExpressionValue(textView, "binding.directoryChannelName");
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.directoryChannelUnreadCount");
            C1107b.m209a(textView2, channelListItemDirectory.getUnreadCount() > 0 ? String.valueOf(channelListItemDirectory.getUnreadCount()) : null);
    ...
    public static final class ItemChannelPrivate extends Item {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    C12238m.checkNotNullExpressionValue(widgetChannelsListItemChannelPrivateBinding, "WidgetChannelsListItemCh…ateBinding.bind(itemView)");
        ...
        private final CharSequence getContentDescription(ChannelListItemPrivate channelListItemPrivate, CharSequence channelName) {
            if (ChannelUtils.m7692p(channelListItemPrivate.getChannel()) && channelListItemPrivate.getMentionCount() > 0) {
                ...
                return C1107b.m212d(view, C5419R.string.group_message_a11y_label_with_unreads, new Object[]{channelName}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (ChannelUtils.m7692p(channelListItemPrivate.getChannel())) {
                View view2 = this.itemView;
                C12238m.checkNotNullExpressionValue(view2, "itemView");
                return C1107b.m212d(view2, C5419R.string.group_message_a11y_label, new Object[]{channelName}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemPrivate.getMentionCount() > 0) {
                View view3 = this.itemView;
                C12238m.checkNotNullExpressionValue(view3, "itemView");
                return C1107b.m212d(view3, C5419R.string.direct_message_a11y_label_with_unreads, new Object[]{channelName}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            View view4 = this.itemView;
            C12238m.checkNotNullExpressionValue(view4, "itemView");
            return C1107b.m212d(view4, C5419R.string.direct_message_a11y_label, new Object[]{channelName}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
        }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            if (ChannelUtils.m7689m(channel)) {
                ...
                C12238m.checkNotNullExpressionValue(textView, "binding.channelsListItemPrivateName");
                Context context = textView.getContext();
                C12238m.checkNotNullExpressionValue(context, "binding.channelsListItemPrivateName.context");
            ...
            this.binding.f16017a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelPrivate$onConfigure$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsListItemPrivateName");
            ...
            C12238m.checkNotNullExpressionValue(textView3, "binding.channelsListItemPrivateTag");
            textView3.setVisibility(ChannelUtils.m7670E(channel) ? 0 : 8);
            SimpleDraweeView simpleDraweeView = this.binding.f16019c;
            C12238m.checkNotNullExpressionValue(simpleDraweeView, "it");
            ...
            C12238m.checkNotNullExpressionValue(statusView, "binding.channelListItemPrivateStatus");
            ...
            if (!ChannelUtils.m7670E(channel)) {
                if (ChannelUtils.m7702z(channel)) {
                    ...
                    C12238m.checkNotNullExpressionValue(simpleDraweeSpanTextView, "binding.channelsListItemPrivateDesc");
                    SimpleDraweeSpanTextView simpleDraweeSpanTextView2 = this.binding.f16020d;
                    C12238m.checkNotNullExpressionValue(simpleDraweeSpanTextView2, "binding.channelsListItemPrivateDesc");
                    Context context2 = simpleDraweeSpanTextView2.getContext();
                    C12238m.checkNotNullExpressionValue(context2, "binding.channelsListItemPrivateDesc.context");
                    ...
                    C12238m.checkNotNullExpressionValue(simpleDraweeSpanTextView3, "binding.channelsListItemPrivateDesc");
                ...
                C12238m.checkNotNullExpressionValue(textView4, "binding.channelsListItemPrivateMentions");
                textView4.setText(String.valueOf(Math.min(99, iComponent4)));
                TextView textView5 = this.binding.f16021e;
                C12238m.checkNotNullExpressionValue(textView5, "binding.channelsListItemPrivateMentions");
                if (iComponent4 > 0) {
                    z2 = true;
                } else {
                    z2 = false;
                ...
                C12238m.checkNotNullExpressionValue(relativeLayout3, r12);
            ...
            C12238m.checkNotNullExpressionValue(simpleDraweeSpanTextView4, "binding.channelsListItemPrivateDesc");
            SimpleDraweeSpanTextView simpleDraweeSpanTextView5 = this.binding.f16020d;
            C12238m.checkNotNullExpressionValue(simpleDraweeSpanTextView5, "binding.channelsListItemPrivateDesc");
            ViewExtensions.setTextAndVisibilityBy(simpleDraweeSpanTextView4, C1107b.m212d(simpleDraweeSpanTextView5, C5419R.string.system_dm_activity_text, new Object[0], (4 & 4) != 0 ? C1107b.c.f1492j : null));
            TextView textView6 = this.binding.f16021e;
            C12238m.checkNotNullExpressionValue(textView6, "binding.channelsListItemPrivateMentions");
            textView6.setText(String.valueOf(Math.min(99, iComponent4)));
            TextView textView7 = this.binding.f16021e;
            C12238m.checkNotNullExpressionValue(textView7, "binding.channelsListItemPrivateMentions");
            if (iComponent4 > 0) {
                z2 = true;
            } else {
                z2 = false;
            ...
            RelativeLayout relativeLayout5 = this.binding.f16017a;
            C12238m.checkNotNullExpressionValue(relativeLayout5, r12);
            relativeLayout5.setSelected(selected);
            RelativeLayout relativeLayout6 = this.binding.f16017a;
            C12238m.checkNotNullExpressionValue(relativeLayout6, "binding.root");
    ...
    public static final class ItemChannelStageVoice extends Item {
                ...
                if (imageView2 != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            C12238m.checkNotNullExpressionValue(widgetChannelsListItemChannelStageVoiceBinding, "WidgetChannelsListItemCh…iceBinding.bind(itemView)");
        ...
        private final CharSequence getContentDescription(ChannelListVocalItem data, int userLimit) {
            if (userLimit > 0) {
                ...
                C12238m.checkNotNullExpressionValue(relativeLayout, "binding.root");
                return C1107b.m212d(relativeLayout, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_limit, new Object[]{ChannelUtils.m7679c(data.getChannel()), Integer.valueOf(data.getNumUsersConnected()), Integer.valueOf(userLimit)}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (data.getNumUsersConnected() <= 0) {
                RelativeLayout relativeLayout2 = this.binding.f16024a;
                C12238m.checkNotNullExpressionValue(relativeLayout2, "binding.root");
                return C1107b.m212d(relativeLayout2, C5419R.string.guild_sidebar_voice_channel_a11y_label, new Object[]{ChannelUtils.m7679c(data.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            ...
            return C1107b.m212d(relativeLayout3, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_users, new Object[]{ChannelUtils.m7679c(data.getChannel()), StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.guild_sidebar_voice_channel_a11y_label_with_users_userCount, data.getNumUsersConnected(), Integer.valueOf(data.getNumUsersConnected()))}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
        }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            this.binding.f16024a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelStageVoice$onConfigure$1
                @Override // android.view.View.OnClickListener
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.stageChannelItemVoiceChannelTopic");
            ...
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelsItemStag…GuildRoleSubscriptionIcon");
            ...
            if (zCan) {
                i = isLocked ? C5419R.drawable.ic_channel_stage_locked : C5419R.drawable.ic_channel_stage_24dp;
            } else {
                i = C5419R.drawable.ic_channel_lock_16dp;
            }
            ...
            C12238m.checkNotNullExpressionValue(relativeLayout5, "binding.root");
    ...
    public static final class ItemChannelText extends Item {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (imageView3 != null) {
                                ...
                                C12238m.checkNotNullExpressionValue(widgetChannelsListItemChannelBinding, "WidgetChannelsListItemCh…nelBinding.bind(itemView)");
        ...
        private final int getAnnouncementsIcon(ChannelListItemTextChannel channelListItemTextChannel) {
            if (channelListItemTextChannel.getChannel().getNsfw()) {
                return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_channel_announcements_thread_nsfw : C5419R.drawable.ic_channel_announcements_nsfw;
            }
            if (channelListItemTextChannel.isLocked()) {
                return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_channel_announcements_thread_locked : C5419R.drawable.ic_channel_announcements_locked;
            }
            return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_channel_announcements_thread : C5419R.drawable.ic_channel_announcements;
        }
        ...
        private final CharSequence getContentDescription(ChannelListItemTextChannel channelListItemTextChannel, boolean z2) {
            if (z2 && channelListItemTextChannel.getMentionCount() > 0) {
                View view = this.itemView;
                C12238m.checkNotNullExpressionValue(view, "itemView");
                return C1107b.m212d(view, C5419R.string.guild_sidebar_announcement_channel_a11y_label_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(C1643a.m885x(this.itemView, "itemView", "itemView.context"), C5419R.plurals.guild_sidebar_announcement_channel_a11y_label_with_mentions_mentionCount, channelListItemTextChannel.getMentionCount(), Integer.valueOf(channelListItemTextChannel.getMentionCount())), ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (z2 && channelListItemTextChannel.getIsUnread()) {
                View view2 = this.itemView;
                C12238m.checkNotNullExpressionValue(view2, "itemView");
                return C1107b.m212d(view2, C5419R.string.guild_sidebar_announcement_channel_a11y_label_with_unreads, new Object[]{ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (z2) {
                View view3 = this.itemView;
                C12238m.checkNotNullExpressionValue(view3, "itemView");
                return C1107b.m212d(view3, C5419R.string.guild_sidebar_announcement_channel_a11y_label, new Object[]{ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemTextChannel.getMentionCount() > 0) {
                View view4 = this.itemView;
                C12238m.checkNotNullExpressionValue(view4, "itemView");
                return C1107b.m212d(view4, C5419R.string.guild_sidebar_default_channel_a11y_label_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(C1643a.m885x(this.itemView, "itemView", "itemView.context"), C5419R.plurals.guild_sidebar_default_channel_a11y_label_with_mentions_mentionCount, channelListItemTextChannel.getMentionCount(), Integer.valueOf(channelListItemTextChannel.getMentionCount())), ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemTextChannel.getIsUnread()) {
                View view5 = this.itemView;
                C12238m.checkNotNullExpressionValue(view5, "itemView");
                return C1107b.m212d(view5, C5419R.string.guild_sidebar_default_channel_a11y_label_with_unreads, new Object[]{ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            View view6 = this.itemView;
            C12238m.checkNotNullExpressionValue(view6, "itemView");
            return C1107b.m212d(view6, C5419R.string.guild_sidebar_default_channel_a11y_label, new Object[]{ChannelUtils.m7679c(channelListItemTextChannel.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
        }
        ...
        private final int getForumIcon(ChannelListItemTextChannel channelListItemTextChannel) {
            ...
            return channelListItemTextChannel.isLocked() ? C5419R.drawable.ic_channel_forum_locked : C5419R.drawable.ic_channel_forum;
        }
        ...
        private final int getHashIcon(ChannelListItemTextChannel channelListItemTextChannel) {
            if (channelListItemTextChannel.getChannel().getNsfw()) {
                return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_thread_nsfw : C5419R.drawable.ic_channel_text_nsfw;
            }
            if (channelListItemTextChannel.isLocked()) {
                return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_thread_locked : C5419R.drawable.ic_channel_text_locked;
            }
            return channelListItemTextChannel.getHasActiveThreads() ? C5419R.drawable.ic_thread : C5419R.drawable.ic_channel_text;
        }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            this.binding.f16011a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelText$onConfigure$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsItemChannelName");
            ...
            C12238m.checkNotNullExpressionValue(imageView2, "binding.channelsItemChannelHash");
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsItemChannelMentions");
            textView2.setVisibility(channelListItemTextChannel.getMentionCount() > 0 ? 0 : 8);
            TextView textView3 = this.binding.f16014d;
            C12238m.checkNotNullExpressionValue(textView3, "binding.channelsItemChannelMentions");
            ...
            C12238m.checkNotNullExpressionValue(imageView3, "binding.channelsItemChannelUnread");
            ...
            C12238m.checkNotNullExpressionValue(textView4, "binding.channelsItemChannelName");
            ...
            C12238m.checkNotNullExpressionValue(imageView4, "binding.channelsItemChan…GuildRoleSubscriptionIcon");
    ...
    public static final class ItemChannelThread extends Item {
                    ...
                    if (textView2 != null) {
                        ...
                        if (imageView != null) {
                            ...
                            if (imageView2 != null) {
                                ...
                                C12238m.checkNotNullExpressionValue(widgetChannelsListItemThreadBinding, "WidgetChannelsListItemThreadBinding.bind(itemView)");
        ...
        private final CharSequence getContentDescription(ChannelListItemThread channelListItemThread) {
            if (channelListItemThread.getMentionCount() > 0) {
                View view = this.itemView;
                C12238m.checkNotNullExpressionValue(view, "itemView");
                return C1107b.m212d(view, C5419R.string.guild_sidebar_default_channel_a11y_label_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(C1643a.m885x(this.itemView, "itemView", "itemView.context"), C5419R.plurals.guild_sidebar_default_channel_a11y_label_with_mentions_mentionCount, channelListItemThread.getMentionCount(), Integer.valueOf(channelListItemThread.getMentionCount())), channelListItemThread.getChannel().getName()}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemThread.getIsUnread()) {
                View view2 = this.itemView;
                C12238m.checkNotNullExpressionValue(view2, "itemView");
                return C1107b.m212d(view2, C5419R.string.guild_sidebar_default_channel_a11y_label_with_unreads, new Object[]{channelListItemThread.getChannel().getName()}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            View view3 = this.itemView;
            C12238m.checkNotNullExpressionValue(view3, "itemView");
            return C1107b.m212d(view3, C5419R.string.guild_sidebar_default_channel_a11y_label, new Object[]{channelListItemThread.getChannel().getName()}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
        }

        private final int getSpineResourceId(WidgetChannelListModel.ThreadSpineType spineType) {
            if (C12238m.areEqual(spineType, WidgetChannelListModel.ThreadSpineType.Single.INSTANCE)) {
                return C5419R.drawable.ic_spine_short_cap;
            }
            if (C12238m.areEqual(spineType, WidgetChannelListModel.ThreadSpineType.Start.INSTANCE)) {
                return C5419R.drawable.ic_spine_long_cap;
            }
            return C12238m.areEqual(spineType, WidgetChannelListModel.ThreadSpineType.End.INSTANCE) ? C5419R.drawable.ic_spine_short_no_cap : C5419R.drawable.ic_spine_long_no_cap;
        }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            this.binding.f16068a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelThread$onConfigure$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            C12238m.checkNotNullExpressionValue(constraintLayout2, "binding.channelsItemThreadContent");
            ...
            C12238m.checkNotNullExpressionValue(constraintLayout3, "binding.channelsItemThreadContent");
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsItemThreadName");
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsItemThreadMentions");
            textView2.setVisibility(channelListItemThread.getMentionCount() > 0 ? 0 : 8);
            TextView textView3 = this.binding.f16070c;
            C12238m.checkNotNullExpressionValue(textView3, "binding.channelsItemThreadMentions");
            ...
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelsItemThreadUnread");
            ...
            C12238m.checkNotNullExpressionValue(textView4, "binding.channelsItemThreadName");
            FontUtils fontUtils = FontUtils.INSTANCE;
    ...
    public static final class ItemChannelVoice extends Item {
                                ...
                                if (imageView3 != null) {
                                    ...
                                    if (voiceUserLimitView != null) {
                                        ...
                                        if (linearLayout != null) {
                                            ...
                                            C12238m.checkNotNullExpressionValue(widgetChannelsListItemChannelVoiceBinding, "WidgetChannelsListItemCh…iceBinding.bind(itemView)");
        ...
        private final CharSequence getContentDescription(ChannelListItemVoiceChannel channelListItemVoiceChannel, ChannelListItemVoiceChannel channelListItemVoiceChannel2, int i) {
            if (i > 0 && channelListItemVoiceChannel.getMentionCount() > 0) {
                ...
                C12238m.checkNotNullExpressionValue(context, "binding.root.context");
                return C1107b.m212d(constraintLayout, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_limit_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(context, C5419R.plurals.guild_sidebar_default_channel_a11y_label_with_mentions_mentionCount, channelListItemVoiceChannel.getMentionCount(), Integer.valueOf(channelListItemVoiceChannel.getMentionCount())), ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel()), Integer.valueOf(channelListItemVoiceChannel2.getNumUsersConnected()), Integer.valueOf(i)}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (i > 0) {
                ...
                return C1107b.m212d(constraintLayout3, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_limit, new Object[]{ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel()), Integer.valueOf(channelListItemVoiceChannel2.getNumUsersConnected()), Integer.valueOf(i)}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemVoiceChannel2.getNumUsersConnected() > 0 && channelListItemVoiceChannel.getMentionCount() > 0) {
                ...
                C12238m.checkNotNullExpressionValue(context3, "binding.root.context");
                return C1107b.m212d(constraintLayout4, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_users_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(context2, C5419R.plurals.guild_sidebar_default_channel_a11y_label_with_mentions_mentionCount, mentionCount, objArr), ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel()), StringResourceUtilsKt.getI18nPluralString(context3, C5419R.plurals.guild_sidebar_voice_channel_a11y_label_with_users_userCount, channelListItemVoiceChannel2.getNumUsersConnected(), Integer.valueOf(channelListItemVoiceChannel2.getNumUsersConnected()))}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemVoiceChannel2.getNumUsersConnected() > 0) {
                ConstraintLayout constraintLayout7 = this.binding.f16029a;
                C12238m.checkNotNullExpressionValue(constraintLayout7, "binding.root");
                ConstraintLayout constraintLayout8 = this.binding.f16029a;
                C12238m.checkNotNullExpressionValue(constraintLayout8, "binding.root");
                Context context4 = constraintLayout8.getContext();
                C12238m.checkNotNullExpressionValue(context4, "binding.root.context");
                return C1107b.m212d(constraintLayout7, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_users, new Object[]{ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel()), StringResourceUtilsKt.getI18nPluralString(context4, C5419R.plurals.guild_sidebar_voice_channel_a11y_label_with_users_userCount, channelListItemVoiceChannel2.getNumUsersConnected(), Integer.valueOf(channelListItemVoiceChannel2.getNumUsersConnected()))}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            if (channelListItemVoiceChannel.getMentionCount() <= 0) {
                ConstraintLayout constraintLayout9 = this.binding.f16029a;
                C12238m.checkNotNullExpressionValue(constraintLayout9, "binding.root");
                return C1107b.m212d(constraintLayout9, C5419R.string.guild_sidebar_voice_channel_a11y_label, new Object[]{ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
            }
            ConstraintLayout constraintLayout10 = this.binding.f16029a;
            C12238m.checkNotNullExpressionValue(constraintLayout10, "binding.root");
            ConstraintLayout constraintLayout11 = this.binding.f16029a;
            C12238m.checkNotNullExpressionValue(constraintLayout11, "binding.root");
            Context context5 = constraintLayout11.getContext();
            C12238m.checkNotNullExpressionValue(context5, "binding.root.context");
            return C1107b.m212d(constraintLayout10, C5419R.string.guild_sidebar_voice_channel_a11y_label_with_mentions, new Object[]{StringResourceUtilsKt.getI18nPluralString(context5, C5419R.plurals.guild_sidebar_default_channel_a11y_label_with_mentions_mentionCount, channelListItemVoiceChannel.getMentionCount(), Integer.valueOf(channelListItemVoiceChannel.getMentionCount())), ChannelUtils.m7679c(channelListItemVoiceChannel2.getChannel())}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
        }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            this.binding.f16029a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemChannelVoice$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    if (isGuildRoleSubscriptionLockedChannel) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsItemVoiceChannelName");
            textView.setText(ChannelUtils.m7679c(channelComponent1));
            this.binding.f16034f.setTextColor(voiceChannelColor);
            TextView textView2 = this.binding.f16032d;
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsItemVoiceChannelEventTopic");
            ...
            C12238m.checkNotNullExpressionValue(textView4, "binding.channelsItemChannelMentions");
            textView4.setText(String.valueOf(Math.min(99, iComponent5)));
            ImageView imageView = this.binding.f16031c;
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelsItemChannelUnread");
            imageView.setVisibility(zComponent6 && !textSelected ? 0 : 8);
            ImageView imageView2 = this.binding.f16033e;
            C12238m.checkNotNullExpressionValue(imageView2, "binding.channelsItemVoic…GuildRoleSubscriptionIcon");
            ...
            if (!zCan) {
                ...
                i = C5419R.drawable.ic_voice_nsfw;
            } else {
                i = isLocked ? C5419R.drawable.ic_channel_voice_locked : C5419R.drawable.ic_channel_voice;
            }
            if (guildScheduledEvent != null) {
                View view2 = this.itemView;
                C12238m.checkNotNullExpressionValue(view2, "itemView");
                voiceChannelColor = ColorCompat.getColor(view2.getContext(), C5419R.color.status_green_600);
            }
            this.binding.f16035g.setImageResource(i);
            ImageView imageView3 = this.binding.f16035g;
            C12238m.checkNotNullExpressionValue(imageView3, "binding.channelsItemVoiceChannelSpeaker");
            ...
            if (iMin > 0) {
                ...
                C12238m.checkNotNullExpressionValue(voiceUserLimitView, "binding.channelsItemVoiceChannelUserLimit");
                ...
                C12238m.checkNotNullExpressionValue(voiceUserLimitView2, "binding.channelsItemVoiceChannelUserLimit");
    ...
    public static final class ItemGuildJoinRequest extends Item {
        ...
        public ItemGuildJoinRequest(int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            if (materialButton != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetChannelsListItemGuildJoinRequestBinding, "WidgetChannelsListItemGu…estBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (data instanceof ChannelListItemGuildJoinRequest) {
                ...
                this.binding.f16043c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemGuildJoinRequest$onConfigure$1

                    /* JADX INFO: renamed from: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemGuildJoinRequest$onConfigure$1$1 */
                    /* JADX INFO: compiled from: WidgetChannelsListAdapter.kt */
                    public static final class C74461 extends AbstractC12240o implements Function0<Unit> {
                    ...
                    public final void onClick(View view) {
                        ...
                        C12238m.checkNotNullExpressionValue(context2, "context");
                        memberVerificationUtils.maybeShowVerificationGate(context2, WidgetChannelsListAdapter.ItemGuildJoinRequest.access$getAdapter$p(this.this$0).fragmentManager, WidgetChannelsListAdapter.ItemGuildJoinRequest.access$getAdapter$p(this.this$0).getSelectedGuildId(), "Channel Notice", (48 & 16) != 0 ? null : null, (48 & 32) != 0 ? MemberVerificationUtils.C67681.INSTANCE : null, C74461.INSTANCE);
                    }
                });
                if (!member.getPending()) {
                    ConstraintLayout constraintLayout2 = this.binding.f16042b;
                    C12238m.checkNotNullExpressionValue(constraintLayout2, "binding.channelsListItemGuildJoinRequest");
                ...
                if (iOrdinal == 0) {
                    ...
                    C12238m.checkNotNullExpressionValue(constraintLayout3, "binding.channelsListItemGuildJoinRequest");
                ...
                if (iOrdinal == 1) {
                    ...
                    C12238m.checkNotNullExpressionValue(constraintLayout4, "binding.channelsListItemGuildJoinRequest");
                    constraintLayout4.setVisibility(0);
                    return;
                }
                if (iOrdinal != 2) {
                    ConstraintLayout constraintLayout5 = this.binding.f16042b;
                    C12238m.checkNotNullExpressionValue(constraintLayout5, "binding.channelsListItemGuildJoinRequest");
                    ...
                    C12238m.checkNotNullExpressionValue(constraintLayout6, "binding.channelsListItemGuildJoinRequest");
    ...
    public static final class ItemGuildRoleSubscriptionsOverview extends Item {
        ...
        public ItemGuildRoleSubscriptionsOverview(int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetChannelsListItemGuildRoleSubsBinding, "WidgetChannelsListItemGu…ubsBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            this.binding.f16045a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemGuildRoleSubscriptionsOverview$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static final class ItemGuildScheduledEvents extends Item {
            ...
            if (textView != null) {
                ...
                if (imageView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        C12238m.checkNotNullExpressionValue(widgetChannelsListItemGuildScheduledEventsBinding, "WidgetChannelsListItemGu…ntsBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsListItemGuildScheduledEventCount");
            ...
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsListItemGuildScheduledEventCount");
            ...
            this.binding.f16047a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemGuildScheduledEvents$onConfigure$1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
    ...
    public static final class ItemHeader extends Item {
        ...
        public ItemHeader(int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            if (textView != null) {
                ...
                if (imageView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetChannelsListItemHeaderBinding, "WidgetChannelsListItemHeaderBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (!ableToManageChannel) {
                ...
                C12238m.checkNotNullExpressionValue(imageView, "binding.channelsListNew");
                ...
                C12238m.checkNotNullExpressionValue(imageView2, "binding.channelsListNew");
                imageView2.setVisibility(4);
                this.binding.f16051c.setOnClickListener(null);
            } else if (textResId == C5419R.string.text_channels) {
                ImageView imageView3 = this.binding.f16051c;
                C12238m.checkNotNullExpressionValue(imageView3, "binding.channelsListNew");
                imageView3.setVisibility(0);
                this.binding.f16051c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemHeader$onConfigure$1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        WidgetCreateChannel.Companion.show$default(WidgetCreateChannel.INSTANCE, C1643a.m885x(view, "v", "v.context"), selectedGuildId, 0, null, 8, null);
                    }
                });
            } else if (textResId == C5419R.string.voice_channels) {
                ImageView imageView4 = this.binding.f16051c;
                C12238m.checkNotNullExpressionValue(imageView4, "binding.channelsListNew");
                imageView4.setVisibility(0);
                this.binding.f16051c.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemHeader$onConfigure$2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        WidgetCreateChannel.Companion.show$default(WidgetCreateChannel.INSTANCE, C1643a.m885x(view, "v", "v.context"), selectedGuildId, 2, null, 8, null);
                    }
                });
            }
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            if (data instanceof ChannelListItemInvite) {
                this.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemInvite$onConfigure$1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        WidgetGuildInviteShare.INSTANCE.launch(C1643a.m885x(view, "it", "it.context"), WidgetChannelsListAdapter.ItemInvite.access$getAdapter$p(this.this$0).fragmentManager, ((ChannelListItemInvite) data).getGuildId(), (16 & 8) != 0 ? null : null, (16 & 16) != 0 ? false : false, (16 & 32) != 0 ? null : null, (16 & 64) != 0 ? null : null, "Directory");
                    }
                });
                View view = this.itemView;
                C12238m.checkNotNullExpressionValue(view, "itemView");
    ...
    public static final class ItemMFA extends MGRecyclerViewHolder<WidgetChannelsListAdapter, ChannelListItem> {
        ...
        public ItemMFA(@LayoutRes int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            C12238m.checkNotNullExpressionValue(widgetChannelsListItemMfaBinding, "WidgetChannelsListItemMfaBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            C12238m.checkNotNullExpressionValue(linkifiedTextView, "binding.channelsListItemMfaText");
            C1107b.m221m(linkifiedTextView, C5419R.string.two_fa_guild_mfa_warning, new Object[0], WidgetChannelsListAdapter$ItemMFA$onConfigure$1.INSTANCE);
        }
    }
    ...
    public static final class ItemStageActiveEvent extends Item {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (userSummaryView != null) {
                                            ...
                                            if (materialTextView != null) {
                                                ...
                                                C12238m.checkNotNullExpressionValue(widgetChannelsListItemActiveEventBinding, "WidgetChannelsListItemAc…entBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (z2) {
                i = C5419R.drawable.ic_channel_stage_16dp;
            } else {
                i = (channel == null || channel.getType() != 2) ? C5419R.drawable.ic_location_16dp : C5419R.drawable.ic_channel_voice_16dp;
            }
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.eventTopic");
            textView.setText(data2.getTopic());
            TextView textView2 = this.binding.f15998c;
            C12238m.checkNotNullExpressionValue(textView2, "binding.eventChannel");
            if (channel != null) {
            ...
            C12238m.checkNotNullExpressionValue(textView3, "binding.stageEventListeners");
            textView3.setVisibility(z2 ? 0 : 8);
            TextView textView4 = this.binding.f16002g;
            C12238m.checkNotNullExpressionValue(textView4, "binding.stageEventListeners");
            C1107b.m221m(textView4, C5419R.string.listening_count, new Object[]{Integer.valueOf(audienceSize)}, (4 & 4) != 0 ? C1107b.g.f1495j : null);
            ImageView imageView = this.binding.f15997b;
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelSeparator");
            ...
            if (!data2.getSpeakers().isEmpty()) {
                if (data2.getSpeakers().size() != 1) {
                    ...
                    C12238m.checkNotNullExpressionValue(context2, "context");
                    username = C1107b.m212d(materialTextView, C5419R.string.user_summary_with_others, new Object[]{data2.getSpeakers().get(0).getUser().getUsername(), StringResourceUtilsKt.getI18nPluralString(context2, C5419R.plurals.user_summary_with_others_count, data2.getSpeakers().size() - 1, Integer.valueOf(data2.getSpeakers().size() - 1))}, (4 & 4) != 0 ? C1107b.c.f1492j : null);
                } else {
                    username = data2.getSpeakers().get(0).getUser().getUsername();
                }
                materialTextView.setText(username);
            }
            MaterialButton materialButton = this.binding.f15999d;
            if (data2.getLocationInfo() instanceof GuildScheduledEventLocationInfo.ExternalLocation) {
                i2 = C5419R.string.see_detail;
            } else {
                i2 = !z2 ? C5419R.string.join : C5419R.string.stage_channel_join_button;
            }
    ...
    public static final class ItemStageChannelAudienceCount extends Item {
        ...
        public ItemStageChannelAudienceCount(int i, WidgetChannelsListAdapter widgetChannelsListAdapter) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    C12238m.checkNotNullExpressionValue(widgetChannelsListItemAudienceCountBinding, "WidgetChannelsListItemAu…untBinding.bind(itemView)");
        ...
        public void onConfigure(int position, ChannelListItem data) {
            ...
            if (channelListItemStageAudienceCount.getAudienceSize() != 0) {
                C1107b.m221m(textView, C5419R.string.stage_channel_audience_count, new Object[]{Integer.valueOf(channelListItemStageAudienceCount.getAudienceSize())}, (4 & 4) != 0 ? C1107b.g.f1495j : null);
            } else {
    ...
    public static final class ItemVoiceUser extends Item {
                            ...
                            if (imageView3 != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (linearLayout != null) {
                                        ...
                                        C12238m.checkNotNullExpressionValue(widgetChannelsListItemVoiceUserBinding, "WidgetChannelsListItemVo…serBinding.bind(itemView)");
        ...
        public void onConfigure(int position, final ChannelListItem data) {
            ...
            C12238m.checkNotNullExpressionValue(simpleDraweeView, "binding.channelsItemVoiceUserAvatar");
            ...
            this.binding.f16074a.setOnClickListener(new View.OnClickListener() { // from class: com.discord.widgets.channels.list.WidgetChannelsListAdapter$ItemVoiceUser$onConfigure$2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            C12238m.checkNotNullExpressionValue(textView, "binding.channelsItemVoiceUserName");
            ...
            C12238m.checkNotNullExpressionValue(imageView, "binding.channelsItemVoiceUserCamera");
            imageView.setVisibility(voiceState.getSelfVideo() ? 0 : 8);
            ImageView imageView2 = this.binding.f16079f;
            C12238m.checkNotNullExpressionValue(imageView2, "binding.channelsItemVoiceUserMicrophone");
            imageView2.setVisibility(C1460d.m481V0(voiceState) ? 0 : 8);
            ImageView imageView3 = this.binding.f16077d;
            C12238m.checkNotNullExpressionValue(imageView3, "binding.channelsItemVoiceUserHeadphones");
            imageView3.setVisibility(voiceState.getSelfDeaf() || voiceState.getDeaf() ? 0 : 8);
            TextView textView2 = this.binding.f16078e;
            C12238m.checkNotNullExpressionValue(textView2, "binding.channelsItemVoiceUserLive");
