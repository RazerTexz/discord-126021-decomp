...
public final class WidgetChannelsListItemChannelActions$configureUI$$inlined$apply$lambda$7 extends o implements Function1<View, Unit> {
    ...
    public WidgetChannelsListItemChannelActions$configureUI$$inlined$apply$lambda$7(WidgetChannelsListItemChannelActions widgetChannelsListItemChannelActions, WidgetChannelsListItemChannelActions$Model widgetChannelsListItemChannelActions$Model) {
        super(1);
    ...
    public final void invoke2(View view) {
        ...
        StoreStream.Companion.getMessageAck().ack(this.$this_configureUI$inlined.getChannel().getId(), false, true);
    }
}
