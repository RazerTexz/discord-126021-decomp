...
public final class WidgetGroupInviteFriends$Model$Companion$getForAdd$1$2$2<T, R> implements b<WidgetGroupInviteFriends$Model$ModelAppUserRelationship, List<? extends WidgetGroupInviteFriends$Model$FriendItem>> {
    public final /* synthetic */ WidgetGroupInviteFriends$Model$Companion$AddedUsersInput $usersFilter;

    public WidgetGroupInviteFriends$Model$Companion$getForAdd$1$2$2(WidgetGroupInviteFriends$Model$Companion$AddedUsersInput widgetGroupInviteFriends$Model$Companion$AddedUsersInput) {
