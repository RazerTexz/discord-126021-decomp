...
public final class WidgetCreateChannel$onViewBoundOrOnResume$6 implements View$OnClickListener {
    ...
    public WidgetCreateChannel$onViewBoundOrOnResume$6(WidgetCreateChannel widgetCreateChannel, RadioManager radioManager) {
    ...
    public final void onClick(View view) {
        ...
        RadioButton radioButton = WidgetCreateChannel.access$getBinding$p(this.this$0).e;
