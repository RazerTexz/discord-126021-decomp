...
public final class WidgetThreadDraftArchiveSheet$configureUI$1 implements View$OnClickListener {
    ...
    public WidgetThreadDraftArchiveSheet$configureUI$1(WidgetThreadDraftArchiveSheet widgetThreadDraftArchiveSheet, StoreThreadDraft$ThreadDraftState storeThreadDraft$ThreadDraftState) {
    ...
    public final void onClick(View view) {
        WidgetThreadDraftArchiveSheet.access$setAutoArchiveDuration(this.this$0, this.$draftState, 60);
    }
}
