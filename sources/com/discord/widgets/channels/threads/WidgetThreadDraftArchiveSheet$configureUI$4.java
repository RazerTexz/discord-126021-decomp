...
public final class WidgetThreadDraftArchiveSheet$configureUI$4 implements View$OnClickListener {
    ...
    public WidgetThreadDraftArchiveSheet$configureUI$4(WidgetThreadDraftArchiveSheet widgetThreadDraftArchiveSheet, StoreThreadDraft$ThreadDraftState storeThreadDraft$ThreadDraftState) {
    ...
    public final void onClick(View view) {
        WidgetThreadDraftArchiveSheet.access$setAutoArchiveDuration(this.this$0, this.$draftState, ThreadUtils$ThreadArchiveDurations.SEVEN_DAYS_IN_MINUTES);
    }
}
