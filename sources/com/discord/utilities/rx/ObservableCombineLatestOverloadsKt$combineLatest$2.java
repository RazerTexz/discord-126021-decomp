...
public final class ObservableCombineLatestOverloadsKt$combineLatest$2<T1, T2, T3, R, T10, T11, T4, T5, T6, T7, T8, T9> implements Func3<Holder<T1, T2, T3, T4, T5, T6, T7, T8, T9>, T10, T11, R> {
    public final /* synthetic */ Function11 $combineFunction;

    public ObservableCombineLatestOverloadsKt$combineLatest$2(Function11 function11) {
