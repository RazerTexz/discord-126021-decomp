...
public final class FrameGridLayout$onLayout$1 extends o implements Function2<View, FrameGridLayout$PositionSpec, Unit> {
    public final /* synthetic */ FrameGridLayout this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FrameGridLayout$onLayout$1(FrameGridLayout frameGridLayout) {
        super(2);
    ...
    public final void invoke2(View view, FrameGridLayout$PositionSpec frameGridLayout$PositionSpec) {
        ...
        FrameGridLayout.access$layout(this.this$0, view, frameGridLayout$PositionSpec);
    }
}
