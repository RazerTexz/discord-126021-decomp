...
public final class EmojiNode$Companion$from$3 extends AbstractC12240o implements Function3<Boolean, Integer, Context, String> {
    ...
    public final String invoke(boolean z2, int i, Context context) {
        ...
        C12238m.checkNotNullExpressionValue(imageUri, "ModelEmojiCustom.getImag…isAnimationEnabled, size)");
        return imageUri;
    }
}
