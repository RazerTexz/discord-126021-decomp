...
public final class ChangelogSpans$createHeaderPaddingSpansProvider$1 extends o implements Function0<List<? extends VerticalPaddingSpan>> {
    public final /* synthetic */ int $headerBottomPx;
    public final /* synthetic */ int $headerTopPx;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangelogSpans$createHeaderPaddingSpansProvider$1(int i, int i2) {
        super(0);
        this.$headerTopPx = i;
