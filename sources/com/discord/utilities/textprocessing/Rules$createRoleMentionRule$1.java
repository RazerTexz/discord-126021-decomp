...
public final class Rules$createRoleMentionRule$1<S, T> extends Rule<T, RoleMentionNode<T>, S> {
    public final /* synthetic */ Rules this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Rules$createRoleMentionRule$1(Rules rules, Pattern pattern) {
        super(pattern);
        this.this$0 = rules;
    }
