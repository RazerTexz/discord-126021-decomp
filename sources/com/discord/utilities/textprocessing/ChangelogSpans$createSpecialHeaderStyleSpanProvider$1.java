...
public final class ChangelogSpans$createSpecialHeaderStyleSpanProvider$1 extends o implements Function1<Integer, CharacterStyle> {
    public final /* synthetic */ Context $context;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChangelogSpans$createSpecialHeaderStyleSpanProvider$1(Context context) {
        super(1);
