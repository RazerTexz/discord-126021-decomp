...
public final /* data */ class AppSound {
    ...
    static {
        ...
        SOUND_MUTE = new AppSound(C5419R.raw.mute, z2, i, i2, i3, defaultConstructorMarker);
        boolean z3 = false;
        int i4 = 4;
        int i5 = 13;
        int i6 = 2;
        DefaultConstructorMarker defaultConstructorMarker2 = null;
        SOUND_UNMUTE = new AppSound(C5419R.raw.unmute, z3, i4, i5, i6, defaultConstructorMarker2);
        SOUND_STREAM_ENDED = new AppSound(C5419R.raw.stream_ended, z2, i, i2, i3, defaultConstructorMarker);
        SOUND_STREAM_STARTED = new AppSound(C5419R.raw.stream_started, z3, i4, i5, i6, defaultConstructorMarker2);
        SOUND_STREAM_USER_JOINED = new AppSound(C5419R.raw.stream_user_joined, z2, i, i2, i3, defaultConstructorMarker);
        SOUND_STREAM_USER_LEFT = new AppSound(C5419R.raw.stream_user_left, z3, i4, i5, i6, defaultConstructorMarker2);
    }
    ...
    public String toString() {
        StringBuilder sbM833U = C1643a.m833U("AppSound(resId=");
        ...
        return C1643a.m814B(sbM833U, this.usage, ")");
    }
