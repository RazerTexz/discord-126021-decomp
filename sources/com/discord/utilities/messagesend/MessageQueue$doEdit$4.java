...
public final class MessageQueue$doEdit$4 extends o implements Function1<Subscription, Unit> {
    ...
    public MessageQueue$doEdit$4(MessageQueue messageQueue, MessageRequest$Edit messageRequest$Edit, MessageQueue$DrainListener messageQueue$DrainListener) {
        super(1);
        this.this$0 = messageQueue;
        this.$editRequest = messageRequest$Edit;
    ...
    public final void invoke2(Subscription subscription) {
        ...
        MessageQueue.access$setInFlightRequest$p(this.this$0, new MessageQueue$InflightRequest(this.$editRequest, subscription, this.$drainListener));
    }
}
