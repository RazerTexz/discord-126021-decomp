...
public final class SendUtils$getSendCommandPayload$attachmentCorrectedMessage$1 extends AbstractC12240o implements Function1<ApplicationCommandValue, ApplicationCommandValue> {
    ...
    public final ApplicationCommandValue invoke(ApplicationCommandValue applicationCommandValue) {
        C12238m.checkNotNullParameter(applicationCommandValue, "value");
        ...
        for (Attachment attachment : this.$fileAttachments) {
            if (C12238m.areEqual(attachment.getUri().toString(), applicationCommandValue.getValue())) {
