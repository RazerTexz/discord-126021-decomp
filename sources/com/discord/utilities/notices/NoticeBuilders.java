...
public final class NoticeBuilders {
    ...
    private final DialogData deleteConnectionModalBuilder(Context context, StoreNotices.Dialog notice) {
        ...
        return new DialogData(C1107b.m210b(context, C5419R.string.disconnect_account_title, objArr, C68251.INSTANCE), C1107b.m216h(context, C5419R.string.disconnect_account_body, new Object[0], null, 4), C1107b.m216h(context, C5419R.string.service_connections_disconnect, new Object[0], null, 4), C1107b.m216h(context, C5419R.string.cancel, new Object[0], null, 4), C12134g0.mapOf(C12116o.m10073to(Integer.valueOf(C5419R.id.notice_ok), new C68262(notice))), null, 32, null);
    }

    private final DialogData requestRatingModalBuilder(Context context, StoreNotices.Dialog notice) {
        return new DialogData(C1107b.m216h(context, C5419R.string.rating_request_title, new Object[0], null, 4), C1107b.m216h(context, C5419R.string.rating_request_body_android, new Object[0], null, 4), C1107b.m216h(context, C5419R.string.okay, new Object[0], null, 4), C1107b.m216h(context, C5419R.string.no_thanks, new Object[0], null, 4), C12136h0.mapOf(C12116o.m10073to(0, C68271.INSTANCE), C12116o.m10073to(Integer.valueOf(C5419R.id.notice_ok), C68282.INSTANCE), C12116o.m10073to(Integer.valueOf(C5419R.id.notice_cancel), C68293.INSTANCE)), Integer.valueOf(C5419R.layout.view_review_request_modal_image));
    }
