...
public final class RetryWithDelay$restRetry$2<T, R> implements b<Observable<? extends Throwable>, Observable<?>> {
    public final /* synthetic */ long $delayMillis;
    public final /* synthetic */ Integer $maxHalfLives;
    public final /* synthetic */ Integer $maxRetries;

    public RetryWithDelay$restRetry$2(long j, Integer num, Integer num2) {
        this.$delayMillis = j;
    ...
    public final Observable<?> call2(Observable<? extends Throwable> observable) {
        ...
        return RetryWithDelay.access$retryWithDelay(retryWithDelay, observable, this.$delayMillis, this.$maxHalfLives, this.$maxRetries, RetryWithDelay$restRetry$2$1.INSTANCE);
    }
}
