...
public final class GatewaySocket$handleReconnect$1 extends o implements Function1<WebSocket, Unit> {
    ...
    public final void invoke2(WebSocket webSocket) {
        if (webSocket != null) {
            webSocket.disconnect(SendUtils.MAX_MESSAGE_CHARACTER_COUNT_PREMIUM, this.$reason);
        }
    }
}
