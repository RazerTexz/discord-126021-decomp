...
public final class IncomingParser implements Model {
    ...
    */
    public void assignField(final Model.JsonReader reader) throws IOException {
        ...
        if (strNextName != null) {
            ...
            if (iHashCode != 100) {
                ...
                if (opcode == null) {
                    C12238m.throwUninitializedPropertyAccessException("opcode");
                }
                    ...
                    switch (str.hashCode()) {
                        ...
                        case -2026522382:
                            if (str.equals("SESSIONS_REPLACE")) {
                                this.data = reader.nextList(new Model.JsonReader.ItemFactory<ModelSession>() { // from class: com.discord.gateway.io.IncomingParser.assignField.2
                                    /* JADX WARN: Can't rename method to resolve collision */
                                    @Override // com.discord.models.domain.Model.JsonReader.ItemFactory
                                    public final ModelSession get() {
                                        return (ModelSession) reader.parse(new ModelSession());
                                    }
                                });
                            }
                            break;
                        ...
                        case 77848963:
                            if (str.equals("READY")) {
                                ...
                                StringBuilder sbM833U = C1643a.m833U("Ready payload deserialized in ");
                        ...
                        case 1689894925:
                            if (str.equals("PRESENCES_REPLACE")) {
                                this.data = reader.nextList(new Model.JsonReader.ItemFactory<Presence>() { // from class: com.discord.gateway.io.IncomingParser.assignField.1
                                    /* JADX WARN: Can't rename method to resolve collision */
                                    @Override // com.discord.models.domain.Model.JsonReader.ItemFactory
                                    public final Presence get() {
                                        return (Presence) InboundGatewayGsonParser.fromJson(reader, Presence.class);
                                    }
                                });
                            }
                            break;
