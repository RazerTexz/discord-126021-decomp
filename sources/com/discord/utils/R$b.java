...
public final class R$b {
    ...
    public static final int[] AppBarLayout = {R$attr.background, R$attr.touchscreenBlocksFocus, R$attr.keyboardNavigationCluster, 2130969293, 2130969318, 2130969766, 2130969767, 2130970162};
    ...
    public static final int[] BackgroundStyle = {R$attr.selectableItemBackground, 2130970089};
    public static final int[] Badge = {2130968671, 2130968682, 2130968684, 2130969437, 2130969839, 2130969886, 2130970421};
    public static final int[] BaseProgressIndicator = {R$attr.indeterminate, 2130969424, 2130969627, 2130969853, 2130970104, 2130970106, 2130970363, 2130970366, 2130970368};
    ...
    public static final int[] BottomSheetBehavior_Layout = {R$attr.elevation, 2130968680, 2130968695, 2130968696, 2130968697, 2130968698, 2130968699, 2130968701, 2130968702, 2130968703, 2130969403, 2130970096, 2130970099};
    public static final int[] ButtonBarLayout = {2130968634};
    public static final int[] Capability = {2130970017, 2130970101};
    public static final int[] CardView = {R$attr.minWidth, R$attr.minHeight, 2130968825, 2130968826, 2130968827, 2130968829, 2130968830, 2130968831, 2130969105, 2130969106, 2130969108, 2130969109, 2130969111};
    public static final int[] CheckBoxPreference = {R$attr.summaryOn, R$attr.summaryOff, R$attr.disableDependentsState, 2130969243, 2130970185, 2130970186};
    public static final int[] Chip = {R$attr.textAppearance, R$attr.textSize, R$attr.textColor, R$attr.ellipsize, R$attr.maxWidth, R$attr.text, R$attr.checkable, 2130968842, 2130968843, 2130968846, 2130968847, 2130968851, 2130968852, 2130968853, 2130968855, 2130968856, 2130968857, 2130968858, 2130968859, 2130968860, 2130968861, 2130968866, 2130968867, 2130968868, 2130968870, 2130968879, 2130968880, 2130968881, 2130968882, 2130968883, 2130968884, 2130968885, 2130969307, 2130969425, 2130969569, 2130969574, 2130970038, 2130970096, 2130970099, 2130970111, 2130970264, 2130970268};
    ...
    public static final int[] DialogPreference = {R$attr.dialogTitle, R$attr.dialogMessage, R$attr.dialogIcon, R$attr.positiveButtonText, R$attr.negativeButtonText, R$attr.dialogLayout, 2130969236, 2130969237, 2130969238, 2130969242, 2130969878, 2130969954};
    ...
    public static final int[] FloatingActionButton = {R$attr.enabled, 2130968680, 2130968681, 2130968728, 2130969293, 2130969307, 2130969334, 2130969335, 2130969425, 2130969438, 2130969841, 2130969969, 2130970038, 2130970096, 2130970099, 2130970111, 2130970399};
    ...
    public static final int[] ForegroundLinearLayout = {R$attr.foreground, R$attr.foregroundGravity, 2130969398};
    ...
    public static final int[] KeyAttribute = {R$attr.alpha, R$attr.transformPivotX, R$attr.transformPivotY, R$attr.translationX, R$attr.translationY, R$attr.scaleX, R$attr.scaleY, R$attr.rotation, R$attr.rotationX, R$attr.rotationY, R$attr.translationZ, R$attr.elevation, 2130969177, 2130969401, 2130969866, 2130969868, 2130970372, 2130970374};
    public static final int[] KeyCycle = {R$attr.alpha, R$attr.translationX, R$attr.translationY, R$attr.scaleX, R$attr.scaleY, R$attr.rotation, R$attr.rotationX, R$attr.rotationY, R$attr.translationZ, R$attr.elevation, 2130969177, 2130969401, 2130969866, 2130969868, 2130970372, 2130970374, 2130970433, 2130970434, 2130970435, 2130970436};
    ...
    public static final int[] KeyTimeCycle = {R$attr.alpha, R$attr.translationX, R$attr.translationY, R$attr.scaleX, R$attr.scaleY, R$attr.rotation, R$attr.rotationX, R$attr.rotationY, R$attr.translationZ, R$attr.elevation, 2130969177, 2130969401, 2130969866, 2130969868, 2130970372, 2130970374, 2130970432, 2130970433, 2130970434, 2130970435};
    ...
    public static final int[] ListPreference = {R$attr.entries, R$attr.entryValues, 2130969308, 2130969309, 2130970401};
    ...
    public static final int[] MaterialButton = {R$attr.background, R$attr.insetLeft, R$attr.insetRight, R$attr.insetTop, R$attr.insetBottom, R$attr.checkable, 2130968680, 2130968681, 2130969123, 2130969293, 2130969568, 2130969570, 2130969571, 2130969572, 2130969575, 2130969576, 2130970038, 2130970096, 2130970099, 2130970169, 2130970170};
    public static final int[] MaterialButtonToggleGroup = {2130968840, 2130970091, 2130970130};
    public static final int[] MaterialCalendar = {R$attr.windowFullscreen, 2130969218, 2130969219, 2130969220, 2130969221, 2130969881, 2130970021, 2130970448, 2130970449, 2130970450};
    public static final int[] MaterialCalendarItem = {R$attr.insetLeft, R$attr.insetRight, R$attr.insetTop, R$attr.insetBottom, 2130969642, 2130969651, 2130969652, 2130969659, 2130969660, 2130969664};
    public static final int[] MaterialCardView = {R$attr.checkable, 2130968828, 2130968842, 2130968844, 2130968845, 2130968846, 2130970038, 2130970096, 2130970099, 2130970158, 2130970169, 2130970170};
    ...
    public static final int[] MaterialTextAppearance = {R$attr.letterSpacing, R$attr.lineHeight, 2130969769};
    public static final int[] MaterialTextView = {R$attr.textAppearance, R$attr.lineHeight, 2130969769};
    ...
    public static final int[] MultiSelectListPreference = {R$attr.entries, R$attr.entryValues, 2130969308, 2130969309};
    public static final int[] NavigationView = {R$attr.background, R$attr.fitsSystemWindows, R$attr.maxWidth, 2130969293, 2130969418, 2130969641, 2130969643, 2130969645, 2130969646, 2130969647, 2130969648, 2130969651, 2130969652, 2130969653, 2130969654, 2130969655, 2130969656, 2130969657, 2130969661, 2130969664, 2130969850, 2130970096, 2130970099};
    ...
    public static final int[] Preference = {R$attr.icon, R$attr.persistent, R$attr.enabled, R$attr.layout, R$attr.title, R$attr.selectable, R$attr.key, R$attr.summary, R$attr.order, R$attr.widgetLayout, R$attr.dependency, R$attr.defaultValue, R$attr.shouldDisableView, R$attr.fragment, R$attr.singleLineTitle, R$attr.iconSpaceReserved, 2130968630, 2130968632, 2130969228, 2130969232, 2130969296, 2130969297, 2130969400, 2130969568, 2130969573, 2130969640, 2130969667, 2130969677, 2130969894, 2130969927, 2130970088, 2130970102, 2130970129, 2130970184, 2130970336, 2130970437};
    public static final int[] PreferenceFragment = {R$attr.layout, R$attr.divider, R$attr.dividerHeight, 2130968631};
    public static final int[] PreferenceFragmentCompat = {R$attr.layout, R$attr.divider, R$attr.dividerHeight, 2130968631};
    public static final int[] PreferenceGroup = {R$attr.orderingFromXml, 2130969634, 2130969895};
    public static final int[] PreferenceImageView = {R$attr.maxWidth, R$attr.maxHeight, 2130969840, 2130969846};
    ...
    public static final int[] PropertySet = {R$attr.visibility, R$attr.alpha, 2130969718, 2130969866, 2130970424};
    ...
    public static final int[] RecyclerView = {R$attr.orientation, R$attr.clipToPadding, R$attr.descendantFocusability, 2130969339, 2130969340, 2130969341, 2130969342, 2130969343, 2130969680, 2130970037, 2130970140, 2130970147};
    ...
    public static final int[] SeekBarPreference = {R$attr.layout, R$attr.max, 2130968618, 2130969851, 2130970084, 2130970113, 2130970398};
    ...
    public static final int[] Slider = {R$attr.enabled, R$attr.value, R$attr.stepSize, R$attr.valueFrom, R$attr.valueTo, 2130969416, 2130969417, 2130969671, 2130969672, 2130970318, 2130970319, 2130970320, 2130970321, 2130970322, 2130970326, 2130970327, 2130970328, 2130970332, 2130970363, 2130970364, 2130970365, 2130970367};
    public static final int[] Snackbar = {2130970136, 2130970137, 2130970138};
    public static final int[] SnackbarLayout = {R$attr.maxWidth, 2130968608, 2130968640, 2130968677, 2130968680, 2130968681, 2130969293, 2130969837};
    public static final int[] Spinner = {R$attr.entries, R$attr.popupBackground, R$attr.prompt, R$attr.dropDownWidth, 2130969952};
    public static final int[] State = {R$attr.id, 2130969095};
    ...
    public static final int[] SwitchPreference = {R$attr.summaryOn, R$attr.summaryOff, R$attr.disableDependentsState, R$attr.switchTextOn, R$attr.switchTextOff, 2130969243, 2130970185, 2130970186, 2130970202, 2130970203};
    public static final int[] SwitchPreferenceCompat = {R$attr.summaryOn, R$attr.summaryOff, R$attr.disableDependentsState, R$attr.switchTextOn, R$attr.switchTextOff, 2130969243, 2130970185, 2130970186, 2130970202, 2130970203};
    ...
    public static final int[] Tooltip = {R$attr.textAppearance, R$attr.padding, R$attr.layout_margin, R$attr.minWidth, R$attr.minHeight, R$attr.text, 2130968680};
    public static final int[] Transform = {R$attr.transformPivotX, R$attr.transformPivotY, R$attr.translationX, R$attr.translationY, R$attr.scaleX, R$attr.scaleY, R$attr.rotation, R$attr.rotationX, R$attr.rotationY, R$attr.translationZ, R$attr.elevation};
    public static final int[] Transition = {R$attr.id, 2130968666, 2130969091, 2130969092, 2130969287, 2130969679, 2130969864, 2130969919, 2130970148, 2130970371, 2130970373};
