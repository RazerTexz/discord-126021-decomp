...
public final class StoreChat$setInteractionState$1 extends o implements Function0<Unit> {
    ...
    public StoreChat$setInteractionState$1(StoreChat storeChat, StoreChat$InteractionState storeChat$InteractionState) {
        super(0);
        this.this$0 = storeChat;
        this.$interactionState = storeChat$InteractionState;
    }
