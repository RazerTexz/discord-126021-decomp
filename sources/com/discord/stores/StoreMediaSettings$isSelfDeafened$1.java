...
public final class StoreMediaSettings$isSelfDeafened$1<T, R> implements b<StoreMediaSettings$VoiceConfiguration, Boolean> {
    public static final StoreMediaSettings$isSelfDeafened$1 INSTANCE = new StoreMediaSettings$isSelfDeafened$1();
    ...
    public final Boolean call2(StoreMediaSettings$VoiceConfiguration storeMediaSettings$VoiceConfiguration) {
        return Boolean.valueOf(storeMediaSettings$VoiceConfiguration.isSelfDeafened());
    }
}
