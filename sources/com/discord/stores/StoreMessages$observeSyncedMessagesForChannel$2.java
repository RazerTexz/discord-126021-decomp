...
public final class StoreMessages$observeSyncedMessagesForChannel$2<T1, T2, R> implements Func2<List<? extends Message>, List<? extends Message>, Boolean> {
    public static final StoreMessages$observeSyncedMessagesForChannel$2 INSTANCE = new StoreMessages$observeSyncedMessagesForChannel$2();
