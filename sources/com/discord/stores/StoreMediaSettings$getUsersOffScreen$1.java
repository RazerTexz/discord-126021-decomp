...
public final class StoreMediaSettings$getUsersOffScreen$1<T, R> implements b<StoreMediaSettings$VoiceConfiguration, Map<Long, ? extends Boolean>> {
    public static final StoreMediaSettings$getUsersOffScreen$1 INSTANCE = new StoreMediaSettings$getUsersOffScreen$1();
    ...
    public final Map<Long, Boolean> call2(StoreMediaSettings$VoiceConfiguration storeMediaSettings$VoiceConfiguration) {
        return storeMediaSettings$VoiceConfiguration.getOffScreenUsers();
    }
}
