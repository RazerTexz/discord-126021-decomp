...
public final class StoreGuildRoleSubscriptions$fetchGuildRoleSubscriptionGroup$2 extends o implements Function1<Pair<? extends GuildRoleSubscriptionGroupListing, ? extends List<? extends GuildRoleSubscriptionTierFreeTrial>>, Unit> {
    public final /* synthetic */ long $guildId;
    public final /* synthetic */ StoreGuildRoleSubscriptions this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreGuildRoleSubscriptions$fetchGuildRoleSubscriptionGroup$2(StoreGuildRoleSubscriptions storeGuildRoleSubscriptions, long j) {
        super(1);
    ...
    public final void invoke2(Pair<GuildRoleSubscriptionGroupListing, ? extends List<GuildRoleSubscriptionTierFreeTrial>> pair) {
        StoreGuildRoleSubscriptions.access$getDispatcher$p(this.this$0).schedule(new StoreGuildRoleSubscriptions$fetchGuildRoleSubscriptionGroup$2$1(this, pair.component1(), pair.component2()));
    }
}
