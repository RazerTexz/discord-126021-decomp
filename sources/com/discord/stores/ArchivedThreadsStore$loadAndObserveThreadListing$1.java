...
public final class ArchivedThreadsStore$loadAndObserveThreadListing$1 extends o implements Function0<ArchivedThreadsStore$ThreadListingState> {
    ...
    public ArchivedThreadsStore$loadAndObserveThreadListing$1(ArchivedThreadsStore archivedThreadsStore, long j, ArchivedThreadsStore$ThreadListingType archivedThreadsStore$ThreadListingType) {
        super(0);
    ...
    public final ArchivedThreadsStore$ThreadListingState invoke() {
        ArchivedThreadsStore$ThreadListingState archivedThreadsStore$ThreadListingState = (ArchivedThreadsStore$ThreadListingState) ArchivedThreadsStore.access$getListingsSnapshot$p(this.this$0).get(new Pair(Long.valueOf(this.$channelId), this.$threadListingType));
