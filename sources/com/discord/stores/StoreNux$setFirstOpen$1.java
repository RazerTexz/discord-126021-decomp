...
public final class StoreNux$setFirstOpen$1 extends o implements Function1<StoreNux$NuxState, StoreNux$NuxState> {
    public final /* synthetic */ boolean $value;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreNux$setFirstOpen$1(boolean z2) {
        super(1);
        this.$value = z2;
    }
    ...
    public final StoreNux$NuxState invoke2(StoreNux$NuxState storeNux$NuxState) {
        ...
        return StoreNux$NuxState.copy$default(storeNux$NuxState, false, false, false, this.$value, false, null, 55, null);
    }
}
