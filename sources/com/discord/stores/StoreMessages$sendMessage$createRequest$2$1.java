...
public final class StoreMessages$sendMessage$createRequest$2$1 extends o implements Function2<MessageResult, Boolean, Unit> {
    public final /* synthetic */ Emitter $emitter;
    public final /* synthetic */ StoreMessages$sendMessage$createRequest$2 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreMessages$sendMessage$createRequest$2$1(StoreMessages$sendMessage$createRequest$2 storeMessages$sendMessage$createRequest$2, Emitter emitter) {
        super(2);
    ...
    public final void invoke(MessageResult messageResult, boolean z2) {
        ...
        if (z2) {
            StoreMessages.access$getDispatcher$p(this.this$0.this$0).schedule(new StoreMessages$sendMessage$createRequest$2$1$1(this));
        }
    }
}
