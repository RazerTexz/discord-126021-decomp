...
public final class StoreAudioManagerV2$init$1$1 extends o implements Function1<List<? extends DiscordAudioManager$AudioDevice>, Unit> {
    public final /* synthetic */ StoreAudioManagerV2$init$1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreAudioManagerV2$init$1$1(StoreAudioManagerV2$init$1 storeAudioManagerV2$init$1) {
        super(1);
    ...
    public final void invoke2(List<DiscordAudioManager$AudioDevice> list) {
        ...
        StoreAudioManagerV2.access$getDispatcher$p(this.this$0.this$0).schedule(new StoreAudioManagerV2$init$1$1$1(this, list));
    }
}
