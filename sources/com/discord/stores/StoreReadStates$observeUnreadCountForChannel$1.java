...
public final class StoreReadStates$observeUnreadCountForChannel$1<T, R> implements b<Map<Long, ? extends StoreMessageAck$Ack>, StoreMessageAck$Ack> {
    public final /* synthetic */ long $channelId;

    public StoreReadStates$observeUnreadCountForChannel$1(long j) {
        this.$channelId = j;
    }
