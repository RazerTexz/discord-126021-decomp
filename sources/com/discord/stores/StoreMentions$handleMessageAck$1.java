...
public final class StoreMentions$handleMessageAck$1 extends o implements Function1<ModelReadState, Boolean> {
    public final /* synthetic */ ModelReadState $readState;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreMentions$handleMessageAck$1(ModelReadState modelReadState) {
        super(1);
