...
public final class StoreMessagesLoader$tryLoadMessages$4$1 extends o implements Function1<StoreMessagesLoader$ChannelLoadedState, StoreMessagesLoader$ChannelLoadedState> {
    public static final StoreMessagesLoader$tryLoadMessages$4$1 INSTANCE = new StoreMessagesLoader$tryLoadMessages$4$1();

    public StoreMessagesLoader$tryLoadMessages$4$1() {
        super(1);
    }
