...
public final class StoreAnalytics$ackMessage$1 extends o implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        if (channelFindChannelByIdInternal$app_productionGoogleRelease != null) {
            AnalyticsTracker.INSTANCE.ackMessage(channelFindChannelByIdInternal$app_productionGoogleRelease, new StoreAnalytics$ackMessage$1$1(h0.plus(StoreAnalytics.access$getGuildAnalyticsPropertiesInternal(this.this$0, channelFindChannelByIdInternal$app_productionGoogleRelease.getGuildId()), StoreAnalytics.getChannelSnapshotAnalyticsProperties$default(this.this$0, channelFindChannelByIdInternal$app_productionGoogleRelease, false, 2, (Object) null))));
        }
    }
}
