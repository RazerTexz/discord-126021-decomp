...
public final class StoreGatewayConnection$streamDelete$1 extends o implements Function1<GatewaySocket, Unit> {
    public final /* synthetic */ String $streamKey;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreGatewayConnection$streamDelete$1(String str) {
        super(1);
        this.$streamKey = str;
    }
