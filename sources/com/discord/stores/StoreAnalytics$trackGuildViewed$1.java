...
public final class StoreAnalytics$trackGuildViewed$1 extends o implements Function0<Map<String, ? extends Object>> {
    public final /* synthetic */ Map $properties;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreAnalytics$trackGuildViewed$1(Map map) {
        super(0);
        this.$properties = map;
    }
