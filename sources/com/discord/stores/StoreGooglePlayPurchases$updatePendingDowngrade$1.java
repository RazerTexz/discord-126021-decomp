...
public final class StoreGooglePlayPurchases$updatePendingDowngrade$1 extends o implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        StoreGooglePlayPurchases.access$setStoreState$p(storeGooglePlayPurchases, new StoreGooglePlayPurchases$State$Loaded(StoreGooglePlayPurchases.access$getSubscriptionPurchases$p(storeGooglePlayPurchases), StoreGooglePlayPurchases.access$getIapPurchases$p(this.this$0), this.$newPendingDowngrade));
