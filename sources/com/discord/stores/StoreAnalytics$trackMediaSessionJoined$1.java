...
public final class StoreAnalytics$trackMediaSessionJoined$1 extends o implements Function0<Unit> {
    ...
    public final void invoke2() {
        AnalyticsTracker.INSTANCE.mediaSessionJoined(this.$properties, StoreAnalytics.access$getStores$p(this.this$0).getChannels().findChannelByIdInternal$app_productionGoogleRelease(StoreAnalytics.access$getStores$p(this.this$0).getVoiceChannelSelected().getLastSelectedVoiceChannelId()));
    }
}
