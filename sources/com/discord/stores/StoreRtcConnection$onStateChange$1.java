...
public final class StoreRtcConnection$onStateChange$1 extends o implements Function1<StoreRtcConnection$Listener, Unit> {
    public static final StoreRtcConnection$onStateChange$1 INSTANCE = new StoreRtcConnection$onStateChange$1();

    public StoreRtcConnection$onStateChange$1() {
        super(1);
    }
    ...
    public final void invoke2(StoreRtcConnection$Listener storeRtcConnection$Listener) {
        ...
        storeRtcConnection$Listener.onConnected();
    }
}
