...
public final class StoreMessages$sendMessage$createRequest$1$3 extends o implements Function1<List<? extends SendUtils$FileUpload>, Unit> {
    public final /* synthetic */ StoreMessages$sendMessage$createRequest$1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreMessages$sendMessage$createRequest$1$3(StoreMessages$sendMessage$createRequest$1 storeMessages$sendMessage$createRequest$1) {
        super(1);
    ...
    public final void invoke2(List<SendUtils$FileUpload> list) {
        ...
        StoreMessages.access$getDispatcher$p(this.this$0.this$0).schedule(new StoreMessages$sendMessage$createRequest$1$3$1(this, list));
    }
}
