...
public final class StoreGifPicker$fetchTrendingCategoryGifs$1<T, R> implements b<List<? extends GifDto>, List<? extends ModelGif>> {
    public static final StoreGifPicker$fetchTrendingCategoryGifs$1 INSTANCE = new StoreGifPicker$fetchTrendingCategoryGifs$1();
