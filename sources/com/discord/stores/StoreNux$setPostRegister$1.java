...
public final class StoreNux$setPostRegister$1 extends o implements Function1<StoreNux$NuxState, StoreNux$NuxState> {
    public final /* synthetic */ boolean $value;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreNux$setPostRegister$1(boolean z2) {
        super(1);
        this.$value = z2;
    }
    ...
    public final StoreNux$NuxState invoke2(StoreNux$NuxState storeNux$NuxState) {
        ...
        return StoreNux$NuxState.copy$default(storeNux$NuxState, this.$value, false, false, false, false, null, 62, null);
    }
}
