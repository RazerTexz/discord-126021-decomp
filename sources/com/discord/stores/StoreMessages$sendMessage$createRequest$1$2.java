...
public final class StoreMessages$sendMessage$createRequest$1$2 extends o implements Function1<SendUtils$SendPayload$Preprocessing, Unit> {
    public final /* synthetic */ StoreMessages$sendMessage$createRequest$1 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StoreMessages$sendMessage$createRequest$1$2(StoreMessages$sendMessage$createRequest$1 storeMessages$sendMessage$createRequest$1) {
        super(1);
    ...
    public final void invoke2(SendUtils$SendPayload$Preprocessing sendUtils$SendPayload$Preprocessing) {
        ...
        StoreMessages.access$getDispatcher$p(this.this$0.this$0).schedule(new StoreMessages$sendMessage$createRequest$1$2$1(this, sendUtils$SendPayload$Preprocessing.getNumFiles(), sendUtils$SendPayload$Preprocessing.getName(), sendUtils$SendPayload$Preprocessing.getMimeType()));
    }
}
