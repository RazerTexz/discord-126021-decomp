...
public final class StoreMediaEngine$init$echoCancellationCallback$1$onEchoCancellationUpdated$1 extends o implements Function0<Unit> {
    ...
    public StoreMediaEngine$init$echoCancellationCallback$1$onEchoCancellationUpdated$1(MediaEngine$EchoCancellationInfo mediaEngine$EchoCancellationInfo) {
        super(0);
        this.$info = mediaEngine$EchoCancellationInfo;
    }
