...
public final class StoreRequestedStageChannels$fetchStageChannels$1$2 extends o implements Function1<List<? extends RecommendedStageInstance>, Unit> {
    ...
    public StoreRequestedStageChannels$fetchStageChannels$1$2(StoreRequestedStageChannels$fetchStageChannels$1 storeRequestedStageChannels$fetchStageChannels$1, Set set) {
        super(1);
    ...
    public final void invoke2(List<RecommendedStageInstance> list) {
        ...
        StoreRequestedStageChannels.access$getDispatcher$p(this.this$0.this$0).schedule(new StoreRequestedStageChannels$fetchStageChannels$1$2$1(this, list));
    }
}
