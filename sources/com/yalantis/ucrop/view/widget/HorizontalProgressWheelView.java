...
import com.yalantis.ucrop.R$a;
import com.yalantis.ucrop.R$b;

/* JADX INFO: loaded from: classes3.dex */
public class HorizontalProgressWheelView extends View {
    public final Rect j;
    public HorizontalProgressWheelView$a k;
    public float l;
    public Paint m;
    public Paint n;
    public int o;
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            ...
            Rect rect2 = this.j;
            canvas.drawLine(f3, fCenterY, f2 + rect2.left + ((this.o + this.q) * i4), (this.p / 4.0f) + rect2.centerY(), this.m);
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            HorizontalProgressWheelView$a horizontalProgressWheelView$a = this.k;
            ...
            if (x2 != 0.0f) {
                if (!this.r) {
                    this.r = true;
                    HorizontalProgressWheelView$a horizontalProgressWheelView$a2 = this.k;
                    if (horizontalProgressWheelView$a2 != null) {
                        horizontalProgressWheelView$a2.c();
                    }
                }
                this.f3186s -= x2;
                postInvalidate();
                this.l = motionEvent.getX();
                HorizontalProgressWheelView$a horizontalProgressWheelView$a3 = this.k;
                if (horizontalProgressWheelView$a3 != null) {
                    horizontalProgressWheelView$a3.b(-x2, this.f3186s);
                }
            }
        }
        return true;
    ...
    public void setScrollingListener(HorizontalProgressWheelView$a horizontalProgressWheelView$a) {
        this.k = horizontalProgressWheelView$a;
    }
}
