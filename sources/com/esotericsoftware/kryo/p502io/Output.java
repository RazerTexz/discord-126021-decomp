...
public class Output extends OutputStream {
    ...
    public boolean require(int i) throws KryoException {
        ...
        if (i > this.maxCapacity) {
            StringBuilder sbM833U = C1643a.m833U("Buffer overflow. Max capacity: ");
        ...
        while (true) {
            ...
            if (i2 == i3) {
                StringBuilder sbM833U2 = C1643a.m833U("Buffer overflow. Available: ");
    ...
    public void setBuffer(byte[] bArr, int i) {
        ...
        if (bArr.length > i && i != -1) {
            StringBuilder sbM833U = C1643a.m833U("buffer has length: ");
        ...
        if (i < -1) {
            throw new IllegalArgumentException(C1643a.m871q("maxBufferSize cannot be < -1: ", i));
        }
        this.buffer = bArr;
        if (i == -1) {
    ...
    public Output(int i, int i2) {
        if (i > i2 && i2 != -1) {
            throw new IllegalArgumentException(C1643a.m875s("bufferSize: ", i, " cannot be greater than maxBufferSize: ", i2));
        }
        if (i2 >= -1) {
            this.capacity = i;
        ...
        throw new IllegalArgumentException(C1643a.m871q("maxBufferSize cannot be < -1: ", i2));
    }
