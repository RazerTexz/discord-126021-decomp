...
public abstract class EclipseSingularsRecipes$EclipseSingularizer {
    ...
    public abstract List<EclipseNode> generateFields(EclipseSingularsRecipes$SingularData eclipseSingularsRecipes$SingularData, EclipseNode eclipseNode);

    public abstract void generateMethods(CheckerFrameworkVersion checkerFrameworkVersion, EclipseSingularsRecipes$SingularData eclipseSingularsRecipes$SingularData, boolean z2, EclipseNode eclipseNode, boolean z3, EclipseSingularsRecipes$TypeReferenceMaker eclipseSingularsRecipes$TypeReferenceMaker, EclipseSingularsRecipes$StatementMaker eclipseSingularsRecipes$StatementMaker, AccessLevel accessLevel);

    public abstract void appendBuildCode(EclipseSingularsRecipes$SingularData eclipseSingularsRecipes$SingularData, EclipseNode eclipseNode, List<Statement> list, char[] cArr, String str);
    ...
    public List<char[]> listFieldsToBeGenerated(EclipseSingularsRecipes$SingularData data, EclipseNode builderType) {
        return Collections.singletonList(EclipseSingularsRecipes$SingularData.access$0(data));
    }

    public List<char[]> listMethodsToBeGenerated(EclipseSingularsRecipes$SingularData data, EclipseNode builderType) {
        char[] p = EclipseSingularsRecipes$SingularData.access$0(data);
        char[] s2 = EclipseSingularsRecipes$SingularData.access$1(data);
        return Arrays.equals(p, s2) ? Collections.singletonList(p) : Arrays.asList(p, s2);
    }

    public void generateMethods(HandleBuilder$BuilderJob job, EclipseSingularsRecipes$SingularData data, boolean deprecate) {
        EclipseSingularsRecipes$TypeReferenceMaker returnTypeMaker = new EclipseSingularsRecipes$EclipseSingularizer$1(this, job);
        EclipseSingularsRecipes$StatementMaker returnStatementMaker = new EclipseSingularsRecipes$EclipseSingularizer$2(this, job);
    ...
    public boolean requiresCleaning() {
        try {
            return !getClass().getMethod("appendCleaningCode", EclipseSingularsRecipes$SingularData.class, EclipseNode.class, List.class).getDeclaringClass().equals(EclipseSingularsRecipes$EclipseSingularizer.class);
    ...
    protected Annotation[] generateSelfReturnAnnotations(boolean deprecate, CheckerFrameworkVersion cfv, ASTNode source) {
        ...
        if (markerAnnotationGenerateDeprecatedAnnotation == null) {
            return new Annotation[]{markerAnnotationGenerateNamedAnnotation};
        }
        return markerAnnotationGenerateNamedAnnotation == null ? new Annotation[]{markerAnnotationGenerateDeprecatedAnnotation} : new Annotation[]{markerAnnotationGenerateDeprecatedAnnotation, markerAnnotationGenerateNamedAnnotation};
    }
    ...
    protected void nullBehaviorize(EclipseNode typeNode, EclipseSingularsRecipes$SingularData data, List<Statement> statements, Argument arg) {
