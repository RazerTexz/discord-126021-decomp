...
public class EclipseASTVisitor$Printer implements EclipseASTVisitor {
    ...
    public EclipseASTVisitor$Printer(boolean printContent, PrintStream out, boolean printPositions) {
