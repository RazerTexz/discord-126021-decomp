...
public class JavacJavaUtilMapSingularizer extends JavacJavaUtilSingularizer {
    ...
    protected JCTree$JCStatement generateClearStatements(JavacTreeMaker maker, JavacSingularsRecipes$SingularData data, JavacNode builderType) {
        ...
        JCTree$JCExpressionStatement jCTree$JCExpressionStatementExec = maker.Exec(maker.Apply(jceBlank, thisDotKeyFieldDotClear, jceBlank));
        JCTree$JCExpressionStatement jCTree$JCExpressionStatementExec2 = maker.Exec(maker.Apply(jceBlank, thisDotValueFieldDotClear, jceBlank));
        JCTree$JCBinary jCTree$JCBinaryBinary = maker.Binary(Javac.CTC_NOT_EQUAL, thisDotKeyField, maker.Literal(Javac.CTC_BOT, null));
        JCTree$JCBlock clearCalls = maker.Block(0L, com.sun.tools.javac.util.List.of(jCTree$JCExpressionStatementExec, jCTree$JCExpressionStatementExec2));
        return maker.If(jCTree$JCBinaryBinary, clearCalls, null);
    }
