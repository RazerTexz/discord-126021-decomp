    ...
    public final void q() {
        ...
        if (pairF0 != null) {
            ...
            try {
                ...
                while (true) {
                    if (AnimatableValueParser.J1(inputStreamE4, 1, false) == 255) {
                        int iJ4 = 255;
                        while (iJ4 == 255) {
                            iJ4 = AnimatableValueParser.J1(inputStreamE4, 1, false);
                        }
                        if (iJ4 == 225) {
                            z2 = true;
                            break;
                ...
                if (!z2 || (iJ3 = AnimatableValueParser.J1(inputStreamE4, 2, false) - 2) <= 6) {
                    i = 0;
                } else {
                    int iJ5 = AnimatableValueParser.J1(inputStreamE4, 4, false);
                    int iJ6 = AnimatableValueParser.J1(inputStreamE4, 2, false);
                    i = (iJ3 - 4) - 2;
                ...
                if (i != 0) {
                    if (i > 8) {
                        int iJ7 = AnimatableValueParser.J1(inputStreamE4, 4, false);
                        int i10 = i - 4;
                        ...
                        if (i2 != 0 && i3 <= i2) {
                            ...
                            i4 = i2 - i3;
                            if (i4 < 14) {
                                iJ2 = AnimatableValueParser.J1(inputStreamE4, 2, z3);
                                i5 = i4 - 2;
                                while (true) {
                                    int i11 = iJ2 - 1;
                                    if (iJ2 <= 0 && i5 >= 12) {
                                ...
                                if (i6 >= 10 && AnimatableValueParser.J1(inputStreamE4, 2, z3) == 3 && AnimatableValueParser.J1(inputStreamE4, 4, z3) == 1) {
