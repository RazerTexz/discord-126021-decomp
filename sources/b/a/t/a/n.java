...
public final class n<RC, S> extends Rule<RC, Node<RC>, S> {
    ...
    public n(o$a$a o_a_a, f fVar, Pattern pattern) {
        super(pattern);
        this.a = fVar;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        o$a o_a = new o$a(strGroup, strGroup2, this.a);
        d0.z.d.m.checkNotNullParameter(o_a, "node");
        return new ParseSpec<>(o_a, s2);
    }
}
