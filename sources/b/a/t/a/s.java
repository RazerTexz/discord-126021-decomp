...
public final class s<RC, S> extends Rule<RC, Node<RC>, S> {
    ...
    public s(r$b$a r_b_a, f fVar, Pattern pattern) {
        super(pattern);
        this.a = fVar;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        r$b r_b = new r$b(strGroup, strGroup2, this.a);
        d0.z.d.m.checkNotNullParameter(r_b, "node");
        return new ParseSpec<>(r_b, s2);
    }
}
