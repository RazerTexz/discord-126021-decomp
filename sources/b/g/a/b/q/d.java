...
public class d extends b {
    ...
    public d(b.g.a.b.p.c cVar, int i, i iVar, Writer writer, char c) {
        ...
        if (c != '\"') {
            if (c == '\"') {
                ...
                a$a a_a = a$a.a;
                int[] iArrCopyOf = a_a.f665b[c];
                if (iArrCopyOf == null) {
                    iArrCopyOf = Arrays.copyOf(b.g.a.b.p.a.f, 128);
                    if (iArrCopyOf[c] == 0) {
                        iArrCopyOf[c] = -1;
                    }
                    a_a.f665b[c] = iArrCopyOf;
                }
                iArr = iArrCopyOf;
            }
            this.t = iArr;
    ...
    public final int C0(char[] cArr, int i, int i2, char c, int i3) throws IOException {
        ...
        if (i <= 5 || i >= i2) {
            ...
            if (c <= 255) {
                ...
                cArrZ1[6] = cArr2[c >> 4];
                cArrZ1[7] = cArr2[c & 15];
                this.f673y.write(cArrZ1, 2, 6);
                return i;
            }
            int i6 = (c >> '\b') & 255;
            int i7 = c & 255;
            char[] cArr3 = f672x;
            cArrZ1[10] = cArr3[i6 >> 4];
            cArrZ1[11] = cArr3[i6 & 15];
            cArrZ1[12] = cArr3[i7 >> 4];
            cArrZ1[13] = cArr3[i7 & 15];
            this.f673y.write(cArrZ1, 8, 6);
            return i;
        }
        int i8 = i - 6;
        int i9 = i8 + 1;
    ...
    public final int G0(b.g.a.b.a aVar, InputStream inputStream, byte[] bArr, int i) throws IOException {
        ...
        while (i > 2) {
            if (i5 > i4) {
                iE1 = E0(inputStream, bArr, i5, iE1, i);
                if (iE1 < 3) {
                    i5 = 0;
                    break;
                }
        ...
        if (i <= 0 || (iE0 = E0(inputStream, bArr, i5, iE1, i)) <= 0) {
            return i;
        }
        if (this.C > i2) {
            B0();
                ...
                while (this.C < i9) {
                    do {
                        ...
                        if (c3 >= length2 || iArr[c3] == 0) {
                            ...
                            int i12 = i10 - i11;
                            if (i12 > 0) {
                                this.f673y.write(cArr3, i11, i12);
                            }
                            char[] cArr4 = this.A;
                            int i13 = this.C;
                            this.C = i13 + 1;
        ...
        while (true) {
            ...
            if (i20 != 0) {
                ...
                while (i25 < i18) {
                    ...
                    int i26 = i25 - iC1;
                    if (i26 > 0) {
                        this.f673y.write(cArr, iC1, i26);
                        if (i25 >= i18) {
                            break;
                        }
                    }
                    int i27 = i25 + 1;
                    iC1 = C0(this.A, i27, i18, c, iArr4[c]);
                    i25 = i27;
                }
            }
            if (i19 >= length3) {
