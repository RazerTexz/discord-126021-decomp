...
public final class SubripDecoder extends SimpleSubtitleDecoder2 {
    ...
    public Subtitle j(byte[] bArr, int i, boolean z2) {
                    ...
                    try {
                        ...
                        if (strG2 == null) {
                            ...
                            if (matcher.matches()) {
                                ...
                                this.p.setLength(i4);
                                this.q.clear();
                                for (String strG3 = parsableByteArray.g(); !TextUtils.isEmpty(strG3); strG3 = parsableByteArray.g()) {
                                    if (this.p.length() > 0) {
                                        this.p.append("<br>");
                                    }
                                ...
                                for (int i9 = 0; i9 < this.q.size(); i9++) {
                                    ...
                                    if (str2.matches("\\{\\\\an[1-9]\\}")) {
                                        ...
                                        if (str == null) {
                                            ...
                                            cue = new Cue(spannedFromHtml, null, null, null, k(i3), 0, i3, k(i2), i2, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, ViewCompat.MEASURED_STATE_MASK, Integer.MIN_VALUE, 0.0f, null);
                                        }
                                        arrayList.add(cue);
                                        arrayList.add(Cue.j);
        ...
        return new SubripSubtitle((Cue[]) arrayList.toArray(new Cue[0]), Arrays.copyOf(jArrCopyOf, i5));
    }
}
