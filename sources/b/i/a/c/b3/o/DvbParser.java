...
public final class DvbParser {
            ...
            if (iG8 != 240) {
                ...
                switch (iG8) {
                            ...
                            while (true) {
                                ...
                                if (iG == 0) {
                                    if (parsableBitArray.f()) {
                                        iG3 = parsableBitArray.g(3) + 3;
                                        iG4 = parsableBitArray.g(2);
                                    } else if (parsableBitArray.f()) {
                                        iG = 0;
                                        z3 = z2;
                                        i5 = 1;
                                    } else {
                                        iG2 = parsableBitArray.g(2);
                                        if (iG2 != 0) {
                                            z2 = true;
                                        } else if (iG2 != 1) {
                                            z3 = z2;
                                            ...
                                            iG3 = parsableBitArray.g(4) + 12;
                                            iG4 = parsableBitArray.g(2);
                                        } else if (iG2 != 3) {
                                            iG3 = parsableBitArray.g(8) + 29;
                                            iG4 = parsableBitArray.g(2);
                                        }
                                        z3 = z2;
                                        iG = 0;
                    ...
                    case 17:
                        ...
                        boolean z6 = false;
                        while (true) {
                            int iG9 = parsableBitArray.g(i10);
                            if (iG9 != 0) {
                                z4 = z6;
                                iG5 = iG9;
                                i6 = 1;
                                ...
                                if (parsableBitArray.f()) {
                                    int iG10 = parsableBitArray.g(i11);
                                    if (iG10 == 0) {
                                        iG9 = 0;
                                        z4 = z6;
                                        iG5 = iG9;
                                        ...
                                        iG6 = parsableBitArray.g(i10) + 9;
                                        iG5 = parsableBitArray.g(i10);
                                    } else if (iG10 != 3) {
                                        z4 = z6;
                                        iG5 = 0;
                                        i6 = 0;
                                    } else {
                                        iG6 = parsableBitArray.g(i9) + 25;
                                        iG5 = parsableBitArray.g(i10);
                                    }
                                } else {
                                    iG6 = parsableBitArray.g(i11) + i10;
                                    iG5 = parsableBitArray.g(i10);
                                }
                                z4 = z6;
                                i6 = iG6;
    ...
    public static a f(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i3 > 0) {
            ...
            double d3 = iG - 128;
            double d4 = iG4 - 128;
            iArr[iG6] = d((byte) (255 - (iG2 & 255)), Util2.h((int) ((1.402d * d3) + d2), 0, 255), Util2.h((int) ((d2 - (0.34414d * d4)) - (d3 * 0.71414d)), 0, 255), Util2.h((int) ((d4 * 1.772d) + d2), 0, 255));
            iArr2 = iArr2;
            iG5 = iG5;
            i2 = 8;
            i4 = 4;
