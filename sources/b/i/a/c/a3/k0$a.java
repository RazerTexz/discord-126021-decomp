...
public class k0$a implements k0 {
    ...
    public k0$a(int[] iArr, Random random) {
        this.f826b = iArr;
        this.a = random;
    ...
    public k0 a(int i, int i2) {
        ...
        while (true) {
            ...
            if (i4 >= iArr2.length) {
                return new k0$a(iArr, new Random(this.a.nextLong()));
            }
    ...
    public k0 f(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 >= iArr4.length + i2) {
                return new k0$a(iArr3, new Random(this.a.nextLong()));
            }
            if (i6 >= i2 || i7 != iArr[i6]) {
                int i8 = i7 + 1;
                iArr3[i3] = iArr4[i7];
    ...
    @Override // b.i.a.c.a3.k0
    public k0 h() {
        return new k0$a(0, new Random(this.a.nextLong()));
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public k0$a(int i, Random random) {
        int[] iArr = new int[i];
        int i2 = 0;
        while (i2 < i) {
            int i3 = i2 + 1;
