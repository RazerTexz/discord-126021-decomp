...
public final class w4 implements Runnable {
    ...
    public final void run() {
        ...
        if (b.i.a.f.h.l.t8.b() && u4Var2.h.o(p.H0)) {
            ...
            d4 d4VarO3 = u4Var2.o();
            d4VarO3.b();
            int i = d4VarO3.w().getInt("consent_source", 100);
            int i2 = 40;
            if (u4Var2.h.o(p.I0)) {
                c cVar = u4Var2.h;
        ...
        if (u4Var2.m()) {
            ...
            if (TextUtils.isEmpty(n3VarZ2.k)) {
                ...
                if (!TextUtils.isEmpty(n3VarZ3.l)) {
                    ...
                    d4 d4VarO4 = u4Var2.o();
                    d4VarO4.b();
                    string = d4VarO4.w().getString("gmp_app_id", null);
                    n3 n3VarZ5 = u4Var2.z();
                    n3VarZ5.t();
                    str2 = n3VarZ5.l;
                    d4VarO = u4Var2.o();
                    d4VarO.b();
                    if (t9.d0(str, string, str2, d4VarO.w().getString("admob_app_id", null))) {
                        u4Var2.g().l.a("Rechecking which service to use due to a GMP App Id change");
                        d4VarO2 = u4Var2.o();
                        d4VarO2.b();
                        boolX = d4VarO2.x();
                        SharedPreferences$Editor sharedPreferences$EditorEdit = d4VarO2.w().edit();
                    ...
                    d4VarO5.b();
                    SharedPreferences$Editor sharedPreferences$EditorEdit2 = d4VarO5.w().edit();
                    sharedPreferences$EditorEdit2.putString("gmp_app_id", str4);
                    ...
                    d4VarO6.b();
                    SharedPreferences$Editor sharedPreferences$EditorEdit3 = d4VarO6.w().edit();
                    sharedPreferences$EditorEdit3.putString("admob_app_id", str5);
                ...
                d4 d4VarO7 = u4Var2.o();
                d4VarO7.b();
                string = d4VarO7.w().getString("gmp_app_id", null);
                n3 n3VarZ9 = u4Var2.z();
                n3VarZ9.t();
                str2 = n3VarZ9.l;
                d4VarO = u4Var2.o();
                ...
                if (t9.d0(str, string, str2, d4VarO.w().getString("admob_app_id", null))) {
                    ...
                    d4VarO2.b();
                    boolX = d4VarO2.x();
                    SharedPreferences$Editor sharedPreferences$EditorEdit4 = d4VarO2.w().edit();
                    sharedPreferences$EditorEdit4.clear();
                    sharedPreferences$EditorEdit4.apply();
                    if (boolX != null) {
                        d4VarO2.s(boolX);
                    }
                    u4.p(u4Var2.t);
                ...
                d4 d4VarO8 = u4Var2.o();
                n3 n3VarZ10 = u4Var2.z();
                n3VarZ10.t();
                String str6 = n3VarZ10.k;
                d4VarO8.b();
                SharedPreferences$Editor sharedPreferences$EditorEdit5 = d4VarO8.w().edit();
                sharedPreferences$EditorEdit5.putString("gmp_app_id", str6);
                sharedPreferences$EditorEdit5.apply();
                d4 d4VarO9 = u4Var2.o();
                n3 n3VarZ11 = u4Var2.z();
                n3VarZ11.t();
                String str7 = n3VarZ11.l;
                d4VarO9.b();
                SharedPreferences$Editor sharedPreferences$EditorEdit6 = d4VarO9.w().edit();
                sharedPreferences$EditorEdit6.putString("admob_app_id", str7);
                sharedPreferences$EditorEdit6.apply();
            }
            ...
            n3 n3VarZ12 = u4Var2.z();
            n3VarZ12.t();
            if (TextUtils.isEmpty(n3VarZ12.k)) {
                n3 n3VarZ13 = u4Var2.z();
                n3VarZ13.t();
                if (!TextUtils.isEmpty(n3VarZ13.l)) {
                    zD = u4Var2.d();
                ...
                zD = u4Var2.d();
                if (!u4Var2.o().d.contains("deferred_analytics_collection")) {
                    u4Var2.o().v(!zD);
                }
                if (zD) {
                    u4Var2.s().N();
                ...
                if (b.i.a.f.h.l.ea.b()) {
                    q7 q7VarX2 = u4Var2.x();
                    Bundle bundleA2 = u4Var2.o().D.a();
                    q7VarX2.b();
                    q7VarX2.t();
                    q7VarX2.z(new a8(q7VarX2, bundleA2, q7VarX2.I(false)));
                }
            }
        } else if (u4Var2.d()) {
