...
public class a extends b.i.a.f.e.k.d<e> implements b.i.a.f.l.f {
    ...
    public a(Context context, Looper looper, boolean z2, b.i.a.f.e.k.c cVar, Bundle bundle, c$a c_a, c$b c_b) {
        super(context, looper, 44, cVar, c_a, c_b);
        this.A = z2;
        this.B = cVar;
        this.C = bundle;
        this.D = cVar.h;
