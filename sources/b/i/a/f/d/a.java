...
public abstract class a extends BroadcastReceiver {
    ...
    public final void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
        ...
        this.a.execute(new Runnable(this, intent, context, zIsOrderedBroadcast, pendingResultGoAsync) { // from class: b.i.a.f.d.e
            public final a j;
...

            {
                ...
                this.k = intent;
                this.l = context;
                this.m = zIsOrderedBroadcast;
                this.n = pendingResultGoAsync;
            }
            ...
            public final void run() {
                ...
                try {
                    ...
                    int iA = intent3 != null ? aVar.a(context2, intent3) : aVar.b(context2, intent2);
                    if (z2) {
