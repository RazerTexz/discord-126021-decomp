...
public final class k0<A, ResultT> extends p<A, ResultT> {
    ...
    public k0(p$a p_a, Feature[] featureArr, boolean z2) {
    ...
    public final void c(a$b a_b, TaskCompletionSource taskCompletionSource) throws RemoteException {
        Objects.requireNonNull(this.c.a);
        ((b.i.a.f.h.b.e) ((b.i.a.f.h.b.i) a_b).w()).Y(new b.i.a.f.h.b.k(taskCompletionSource));
    }
}
