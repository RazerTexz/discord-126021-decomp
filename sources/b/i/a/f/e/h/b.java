...
public class b<O extends a$d> {
    ...
    public b(@NonNull Context context, a<O> aVar, O o, n nVar) {
        this(context, aVar, o, new b$a(nVar, null, Looper.getMainLooper()));
    ...
    public b.i.a.f.e.k.c$a a() {
        ...
        if (c_a.f1381b == null) {
            c_a.f1381b = new ArraySet<>();
        }
        c_a.f1381b.addAll(setEmptySet);
        c_a.d = this.a.getClass().getName();
        c_a.c = this.a.getPackageName();
        return c_a;
    }

    public Task<Boolean> b(@NonNull k$a<?> k_a) {
        b.c.a.a0.d.z(k_a, "Listener key cannot be null.");
        b.i.a.f.e.h.j.g gVar = this.i;
        Objects.requireNonNull(gVar);
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        p0 p0Var = new p0(k_a, taskCompletionSource);
    ...
    @MainThread
    public b(@NonNull Activity activity, a<O> aVar, O o, b$a b_a) {
        b.c.a.a0.d.z(activity, "Null activity is not permitted.");
        b.c.a.a0.d.z(aVar, "Api must not be null.");
        b.c.a.a0.d.z(b_a, "Settings must not be null; use Settings.DEFAULT_SETTINGS instead.");
    ...
    public b(@NonNull Context context, a<O> aVar, O o, b$a b_a) {
