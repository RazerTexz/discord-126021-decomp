...
public final class n4<T extends p4<T>> {
    ...
    public final void j(Map.Entry<T, Object> entry) {
        ...
        if (key.d()) {
            ...
            this.f1461b.put(key, objC);
            return;
        }
        if (key.c() != w7.MESSAGE) {
            this.f1461b.put(key, d(value));
            return;
        }
        Object objC2 = c(key);
        if (objC2 == null) {
            ...
            this.f1461b.put(key, objC2 instanceof f6 ? key.c0((f6) objC2, (f6) value) : ((u4.b) key.X(((c6) objC2).f(), (c6) value)).p());
        }
    }
