                ...
                if (strR == null) {
                    if (strR.length() <= e0.m.a.intValue()) {
                        if (j0Var.f) {
                            String strD2 = z.d();
                            String strF3 = z.f();
                            strL = outline.l(strR.length() + outline.b(strF3, outline.b(strD2, 1)), strD2, strF3, "?", strR);
                        } else {
                            String strE2 = z.e();
                            String strF4 = z.f();
                            strL = outline.l(strR.length() + outline.b(strF4, outline.b(strE2, 1)), strE2, strF4, "?", strR);
                        }
                        url2 = new URL(strL);
                        if (url2 == null) {
                            H("Failed to build collect GET endpoint url");
