    ...
    public final void run() {
        ...
        if (p0VarU.m == 0) {
            ...
            if (j != 0) {
                ...
                SharedPreferences$Editor sharedPreferences$EditorEdit = p0VarU.l.edit();
                sharedPreferences$EditorEdit.putLong("first_run", jCurrentTimeMillis);
                if (!sharedPreferences$EditorEdit.commit()) {
