        ...
        while (true) {
            ...
            while (i16 < i13) {
                ...
                while (i18 < i5) {
                    ...
                    int i21 = i15 - i18;
                    zArr[(i13 * 2) + i12 + i17 + i18] = bVar.f(iArr[i20], iArr[i21]);
                    int i22 = i15 - i16;
                    zArr[(i13 * 4) + i12 + i17 + i18] = bVar.f(iArr[i21], iArr[i22]);
                    zArr[(i13 * 6) + i12 + i17 + i18] = bVar.f(iArr[i22], iArr[i19]);
                    i18++;
                    z2 = z2;
                    i2 = i2;
                    i5 = 2;
