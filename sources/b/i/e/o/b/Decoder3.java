        ...
        while (true) {
            ...
            if (i72 != 2) {
                ...
                if (iH == 2) {
                    ...
                    int i74 = 0;
                    while (true) {
                        if (bitSource.a() != 8 && (iB = bitSource.b(8)) != 254) {
                    ...
                    int i79 = 0;
                    boolean z13 = false;
                    for (int i80 = 254; bitSource.a() != i60 && (iB2 = bitSource.b(i60)) != i80; i80 = 254) {
                    ...
                    while (bitSource.a() > 16) {
                        ...
                        while (true) {
                            if (i86 < 4) {
                                int iB4 = bitSource.b(6);
                                if (iB4 == 31) {
                                    int i87 = 8 - bitSource.c;
                                    if (i87 != i60) {
                                        bitSource.b(i87);
                                    }
                                } else {
                    ...
                    int i88 = bitSource.f1830b + 1;
                    int i89 = i88 + 1;
                    int iB5 = DecodedBitStreamParser.b(bitSource.b(i60), i88);
                    if (iB5 == 0) {
                        iB5 = bitSource.a() / i60;
                    } else if (iB5 >= 250) {
                        iB5 = ((iB5 - 249) * 250) + DecodedBitStreamParser.b(bitSource.b(i60), i89);
                        i89++;
                    }
                    if (iB5 < 0) {
                        throw FormatException.a();
                    ...
                    while (i90 < iB5) {
                        ...
                        bArr4[i90] = (byte) DecodedBitStreamParser.b(bitSource.b(i60), i89);
                        i90++;
                        i89++;
                    }
                    arrayList.add(bArr4);
            ...
            while (true) {
                ...
                if (iB6 > 128) {
                            ...
                            switch (iB6) {
                                case 230:
                                    ...
                                    if (i72 != i || bitSource.a() <= 0) {
                                        ...
                                        return new DecoderResult(bArr2, string2, arrayList, null);
                                    }
                                    i60 = 8;
                                    break;
                                    break;
                                case 231:
                                    ...
                                    return new DecoderResult(bArr2, string3, arrayList, null);
                                case 232:
                                    sb.append((char) 29);
                                    if (bitSource.a() <= 0) {
                                    }
                    ...
                    return new DecoderResult(bArr2, string4, arrayList, null);
                }
                if (z15) {
                    iB6 += 128;
                }
            ...
            return new DecoderResult(bArr2, string5, arrayList, null);
        }
    }
}
