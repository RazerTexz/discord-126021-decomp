...
public class FinderPatternFinder {
    ...
    public static final class b implements Serializable, Comparator<FinderPattern2> {
        ...
        public int compare(FinderPattern2 finderPattern2, FinderPattern2 finderPattern3) {
            FinderPattern2 finderPattern4 = finderPattern2;
            FinderPattern2 finderPattern5 = finderPattern3;
            int iCompare = Integer.compare(finderPattern5.d, finderPattern4.d);
            return iCompare == 0 ? Float.compare(Math.abs(finderPattern4.c - this.average), Math.abs(finderPattern5.c - this.average)) : iCompare;
        }
    }
    ...
    public static final class c implements Serializable, Comparator<FinderPattern2> {
        ...
        @Override // java.util.Comparator
        public int compare(FinderPattern2 finderPattern2, FinderPattern2 finderPattern3) {
            return Float.compare(Math.abs(finderPattern3.c - this.average), Math.abs(finderPattern2.c - this.average));
        }
    }
    ...
    public final boolean e(int[] iArr, int i, int i2) {
        ...
        if (!z3) {
            FinderPattern2 finderPattern3 = new FinderPattern2(fA2, fA, f3);
            this.f1895b.add(finderPattern3);
            ResultPointCallback resultPointCallback = this.e;
            if (resultPointCallback != null) {
                resultPointCallback.a(finderPattern3);
            }
        }
        return true;
    }
