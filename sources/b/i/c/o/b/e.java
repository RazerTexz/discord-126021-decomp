...
public final class e extends b.i.c.o.a {
    ...
    public final Task<PendingDynamicLinkData> a(@NonNull Intent intent) {
        ...
        Parcelable$Creator<DynamicLinkData> parcelable$Creator = DynamicLinkData.CREATOR;
        byte[] byteArrayExtra = intent.getByteArrayExtra("com.google.firebase.dynamiclinks.DYNAMIC_LINK_DATA");
        if (byteArrayExtra == null) {
            dynamicLinkDataCreateFromParcel = null;
        } else {
            Objects.requireNonNull(parcelable$Creator, "null reference");
            Parcel parcelObtain = Parcel.obtain();
            parcelObtain.unmarshall(byteArrayExtra, 0, byteArrayExtra.length);
            parcelObtain.setDataPosition(0);
            dynamicLinkDataCreateFromParcel = parcelable$Creator.createFromParcel(parcelObtain);
