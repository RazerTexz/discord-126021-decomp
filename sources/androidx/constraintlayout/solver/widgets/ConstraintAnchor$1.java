...
public /* synthetic */ class ConstraintAnchor$1 {
    ...
    static {
        ...
        try {
            iArr[ConstraintAnchor$Type.CENTER.ordinal()] = 1;
        } catch (NoSuchFieldError unused) {
        }
        try {
            $SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type[ConstraintAnchor$Type.LEFT.ordinal()] = 2;
        ...
        try {
            $SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type[ConstraintAnchor$Type.TOP.ordinal()] = 4;
        ...
        try {
            $SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type[ConstraintAnchor$Type.BASELINE.ordinal()] = 6;
