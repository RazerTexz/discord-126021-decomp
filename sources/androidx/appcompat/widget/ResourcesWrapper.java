...
public class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawable(int i, Resources$Theme resources$Theme) throws Resources$NotFoundException {
        return this.mResources.getDrawable(i, resources$Theme);
    }

    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i, int i2, Resources$Theme resources$Theme) {
        return this.mResources.getDrawableForDensity(i, i2, resources$Theme);
    }
