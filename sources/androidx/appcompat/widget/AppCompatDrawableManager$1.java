...
public class AppCompatDrawableManager$1 implements ResourceManagerInternal$ResourceManagerHooks {
    ...
    private void setPorterDuffColorFilter(Drawable drawable, int i, PorterDuff$Mode porterDuff$Mode) {
        if (DrawableUtils.canSafelyMutateDrawable(drawable)) {
            drawable = drawable.mutate();
        }
        if (porterDuff$Mode == null) {
            porterDuff$Mode = AppCompatDrawableManager.access$000();
        }
        drawable.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(i, porterDuff$Mode));
    }
    ...
    public boolean tintDrawable(@NonNull Context context, int i, @NonNull Drawable drawable) {
        if (i == R$drawable.abc_seekbar_track_material) {
            ...
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(R$id.progress), ThemeUtils.getThemeAttrColor(context, R$attr.colorControlActivated), AppCompatDrawableManager.access$000());
            return true;
        }
        ...
        setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(R$id.background), ThemeUtils.getDisabledThemeAttrColor(context, R$attr.colorControlNormal), AppCompatDrawableManager.access$000());
    ...
    public boolean tintDrawableUsingColorFilter(@NonNull Context context, int i, @NonNull Drawable drawable) {
        int iRound;
        boolean z2;
        PorterDuff$Mode porterDuff$ModeAccess$000 = AppCompatDrawableManager.access$000();
        ...
        if (zArrayContains) {
            ...
            if (!arrayContains(this.COLORFILTER_COLOR_BACKGROUND_MULTIPLY, i)) {
                ...
                drawable.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(ThemeUtils.getThemeAttrColor(context, i2), porterDuff$ModeAccess$000));
                if (iRound != -1) {
                    drawable.setAlpha(iRound);
                }
                return true;
            }
            porterDuff$ModeAccess$000 = PorterDuff$Mode.MULTIPLY;
        }
        iRound = -1;
        z2 = true;
        if (z2) {
