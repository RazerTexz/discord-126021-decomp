...
public class ActionBarDrawerToggle implements DrawerLayout$DrawerListener {
    ...
    public void setToolbarNavigationClickListener(View$OnClickListener view$OnClickListener) {
    ...
    public ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, @StringRes int i, @StringRes int i2) {
        ...
        if (toolbar != null) {
            ...
            this.mActivityImpl = new ActionBarDrawerToggle$FrameworkActionBarDelegate(activity);
        }
