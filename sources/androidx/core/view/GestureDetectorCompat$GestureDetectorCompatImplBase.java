...
public class GestureDetectorCompat$GestureDetectorCompatImplBase implements GestureDetectorCompat$GestureDetectorCompatImpl {
    ...
    public GestureDetectorCompat$GestureDetectorCompatImplBase(Context context, GestureDetector$OnGestureListener gestureDetector$OnGestureListener, Handler handler) {
        if (handler != null) {
        ...
        this.mListener = gestureDetector$OnGestureListener;
        if (gestureDetector$OnGestureListener instanceof GestureDetector$OnDoubleTapListener) {
            setOnDoubleTapListener((GestureDetector$OnDoubleTapListener) gestureDetector$OnGestureListener);
        }
        init(context);
    }
        ...
        if (i == 1) {
            ...
            if (this.mIsDoubleTapping) {
                ...
                if (this.mInLongPress) {
                    ...
                    if (this.mDeferConfirmSingleTap && (gestureDetector$OnDoubleTapListener = this.mDoubleTapListener) != null) {
                        gestureDetector$OnDoubleTapListener.onSingleTapConfirmed(motionEvent);
                    }
    ...
    public void setOnDoubleTapListener(GestureDetector$OnDoubleTapListener gestureDetector$OnDoubleTapListener) {
        this.mDoubleTapListener = gestureDetector$OnDoubleTapListener;
    }
}
