...
public class FontRequestWorker$3 implements Callable<FontRequestWorker$TypefaceResult> {
    public final /* synthetic */ Context val$context;
    public final /* synthetic */ String val$id;
    public final /* synthetic */ FontRequest val$request;
    public final /* synthetic */ int val$style;

    public FontRequestWorker$3(String str, Context context, FontRequest fontRequest, int i) {
        this.val$id = str;
