        ...
        try {
            try {
                ...
                try {
                    ...
                    for (Map$Entry<String, Object> map$Entry : data.mValues.entrySet()) {
                        objectOutputStream2.writeUTF(map$Entry.getKey());
                        objectOutputStream2.writeObject(map$Entry.getValue());
                    }
                    try {
