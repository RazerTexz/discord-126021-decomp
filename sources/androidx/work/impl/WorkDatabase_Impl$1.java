...
public class WorkDatabase_Impl$1 extends RoomOpenHelper$Delegate {
    public final /* synthetic */ WorkDatabase_Impl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WorkDatabase_Impl$1(WorkDatabase_Impl workDatabase_Impl, int i) {
        super(i);
    ...
    public void dropAllTables(SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        if (WorkDatabase_Impl.access$000(this.this$0) != null) {
            int size = WorkDatabase_Impl.access$100(this.this$0).size();
            for (int i = 0; i < size; i++) {
                ((RoomDatabase$Callback) WorkDatabase_Impl.access$200(this.this$0).get(i)).onDestructiveMigration(supportSQLiteDatabase);
            }
        }
    }
    ...
    public void onCreate(SupportSQLiteDatabase supportSQLiteDatabase) {
        if (WorkDatabase_Impl.access$300(this.this$0) != null) {
            int size = WorkDatabase_Impl.access$400(this.this$0).size();
            for (int i = 0; i < size; i++) {
                ((RoomDatabase$Callback) WorkDatabase_Impl.access$500(this.this$0).get(i)).onCreate(supportSQLiteDatabase);
            }
        }
    }
    ...
    public void onOpen(SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        WorkDatabase_Impl.access$700(this.this$0, supportSQLiteDatabase);
        if (WorkDatabase_Impl.access$800(this.this$0) != null) {
            int size = WorkDatabase_Impl.access$900(this.this$0).size();
            for (int i = 0; i < size; i++) {
                ((RoomDatabase$Callback) WorkDatabase_Impl.access$1000(this.this$0).get(i)).onOpen(supportSQLiteDatabase);
            }
        }
    }
