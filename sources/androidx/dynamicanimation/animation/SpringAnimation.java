...
public final class SpringAnimation extends DynamicAnimation<SpringAnimation> {
    ...
    public boolean updateValueAndVelocity(long j) {
        ...
        if (this.mPendingPosition != Float.MAX_VALUE) {
            long j2 = j / 2;
            DynamicAnimation$MassState dynamicAnimation$MassStateUpdateValues = this.mSpring.updateValues(this.mValue, this.mVelocity, j2);
            this.mSpring.setFinalPosition(this.mPendingPosition);
            this.mPendingPosition = Float.MAX_VALUE;
            DynamicAnimation$MassState dynamicAnimation$MassStateUpdateValues2 = this.mSpring.updateValues(dynamicAnimation$MassStateUpdateValues.mValue, dynamicAnimation$MassStateUpdateValues.mVelocity, j2);
            this.mValue = dynamicAnimation$MassStateUpdateValues2.mValue;
            this.mVelocity = dynamicAnimation$MassStateUpdateValues2.mVelocity;
        } else {
            DynamicAnimation$MassState dynamicAnimation$MassStateUpdateValues3 = this.mSpring.updateValues(this.mValue, this.mVelocity, j);
