...
public class PreferenceFragment$DividerDecoration extends RecyclerView$ItemDecoration {
    private boolean mAllowDividerAfterLastItem = true;
    private Drawable mDivider;
    private int mDividerHeight;
    public final /* synthetic */ PreferenceFragment this$0;

    public PreferenceFragment$DividerDecoration(PreferenceFragment preferenceFragment) {
